...
async fn test_key_gen_compatible_with_js() {
    ...
    let salt = b"01234567";
    let expect_key =
        hex::decode("8bd31ea8bc0a7143450a689625f28bb17d452bff17416cc8a4b010f1f114014e").unwrap();
...
async fn test_aes_cbc_encrypt_compatible_with_js() {
    ...
    let key =
        hex::decode("d8ae99571b83ecef3974b8596d17fd1c46d4798e2afdd32f32345bfa8224f3dc").unwrap();
    let expect_cipher_txt =
        hex::decode("fe515f9acd6711ccfc8287110296d14a739f9d6f663a923d72b281485f9cc699").unwrap();
