...
pub const ECIES_MAGIC_DATA_LENGTH: usize = 8;
pub const ECIES_SALT_LENGTH: usize = 8;
pub const ECIES_KEY_LENGTH: usize = 32;
pub const ECIES_IV_LENGTH: usize = 16;
pub const ECIES_EPHEMERAL_PK_LENGTH: usize = 65;
pub const ECIES_MAC_LENGTH: usize = 32;
pub const ECIES_META_LENGTH: usize = ECIES_IV_LENGTH + ECIES_EPHEMERAL_PK_LENGTH + ECIES_MAC_LENGTH;
