...
use mystiko_protocol::key::{
    ...
    full_public_key, separate_public_keys, separate_secret_keys, verification_public_key,
    verification_secret_key,
};
use mystiko_protocol::types::{
    FullPk, FullSk, ENC_PK_SIZE, ENC_SK_SIZE, VERIFY_PK_SIZE, VERIFY_SK_SIZE,
};
...
fn test_full_public_key() {
    ...
    let expected_pk: FullPk = [
        196, 97, 135, 198, 156, 38, 197, 58, 149, 152, 118, 34, 141, 10, 140, 241, 2, 85, 56, 20,
        62, 178, 69, 65, 241, 177, 226, 216, 83, 0, 47, 36, 2, 31, 18, 42, 100, 132, 197, 170, 102,
        9, 124, 54, 10, 251, 40, 149, 143, 149, 219, 252, 227, 224, 246, 56, 126, 63, 157, 219,
        121, 145, 90, 58, 162,
    ];
