    ...
    for status in all_status {
        match status {
            ...
            | DepositStatus::Failed => {
                ...
                for i in 0..count {
                    let data = build_dedup_commitment_data(5, "0x4fd0ade06b9654437f46EA59e6edEe056F9d5EF7", i + 1);
...
fn build_dedup_commitment_data(chain_id: u64, address: &str, count: usize) -> ChainData<FullData> {
