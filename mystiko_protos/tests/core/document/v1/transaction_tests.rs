...
fn test_wrappers() {
    let transaction = Transaction::builder()
        ...
        .input_commitments(vec![biguint_to_bytes(&BigUint::from(5678_u32)), biguint_to_bytes(&BigUint::from(7890_u32))])
        .output_commitments(vec![biguint_to_bytes(&BigUint::from(10001_u32)), biguint_to_bytes(&BigUint::from(10002_u32))])
        .nullifiers(vec![biguint_to_bytes(&BigUint::from(9999_u32)), biguint_to_bytes(&BigUint::from(9998_u32))])
    ...
    assert_eq!(transaction.input_commitments_as_bigint(), vec![BigUint::from(5678_u32), BigUint::from(7890_u32)]);
    assert_eq!(transaction.output_commitments_as_bigint().unwrap(), vec![BigUint::from(10001_u32), BigUint::from(10002_u32)]);
    assert_eq!(transaction.nullifiers_as_bigint().unwrap(), vec![BigUint::from(9999_u32), BigUint::from(9998_u32)]);
    ...
    assert_eq!(transaction.rollup_fee_amount_as_bigint(), Some(BigUint::from(1000002_u32)));
    assert_eq!(transaction.gas_relayer_fee_amount_as_bigint(), Some(BigUint::from(1000003_u32)));
    assert_eq!(transaction.random_auditing_public_key_as_bigint(), Some(BigUint::from(1000004_u32)));
