...
fn test_wrappers() {
    ...
    assert_eq!(commitment.rollup_fee_amount_as_biguint(), Some(BigUint::from(5678_u32)));
    assert_eq!(commitment.leaf_index_as_biguint(), Some(BigUint::from(10001_u32)));
    assert_eq!(commitment.amount_as_biguint(), Some(BigUint::from(1000000_u32)));
    assert_eq!(commitment.nullifier_as_biguint(), Some(BigUint::from(9999_u32)));
