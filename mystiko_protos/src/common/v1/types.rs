...
impl From<&mystiko_types::CircuitType> for CircuitType {
    fn from(value: &mystiko_types::CircuitType) -> Self {
        match value {
            ...
            mystiko_types::CircuitType::Rollup128 => CircuitType::Rollup128,
            mystiko_types::CircuitType::Rollup256 => CircuitType::Rollup256,
            mystiko_types::CircuitType::Rollup512 => CircuitType::Rollup512,
            mystiko_types::CircuitType::Rollup1024 => CircuitType::Rollup1024,
...
impl From<CircuitType> for mystiko_types::CircuitType {
    fn from(value: CircuitType) -> Self {
        match value {
            ...
            CircuitType::Rollup128 => mystiko_types::CircuitType::Rollup128,
            CircuitType::Rollup256 => mystiko_types::CircuitType::Rollup256,
            CircuitType::Rollup512 => mystiko_types::CircuitType::Rollup512,
            CircuitType::Rollup1024 => mystiko_types::CircuitType::Rollup1024,
