...
impl serde::Serialize for ResetRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.api.scanner.v1.ResetRequest", len)?;
        if let Some(v) = self.options.as_ref() {
            struct_ser.serialize_field("options", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ResetRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.api.scanner.v1.ResetRequest")
            }
        ...
        deserializer.deserialize_struct("mystiko.api.scanner.v1.ResetRequest", FIELDS, GeneratedVisitor)
    }
}
