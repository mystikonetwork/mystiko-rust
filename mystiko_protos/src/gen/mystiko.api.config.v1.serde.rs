...
impl serde::Serialize for SupportedAssetSymbolsRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.api.config.v1.SupportedAssetSymbolsRequest", len)?;
        if self.chain_id != 0 {
            struct_ser.serialize_field("chainId", ToString::to_string(&self.chain_id).as_str())?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for SupportedAssetSymbolsRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SupportedAssetSymbolsRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.api.config.v1.SupportedAssetSymbolsRequest")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<SupportedAssetSymbolsRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut chain_id__ = None;
                ...
                Ok(SupportedAssetSymbolsRequest {
                    chain_id: chain_id__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("mystiko.api.config.v1.SupportedAssetSymbolsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SupportedAssetSymbolsResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.api.config.v1.SupportedAssetSymbolsResponse", len)?;
        if !self.symbols.is_empty() {
...
impl<'de> serde::Deserialize<'de> for SupportedAssetSymbolsResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SupportedAssetSymbolsResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.api.config.v1.SupportedAssetSymbolsResponse")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<SupportedAssetSymbolsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(SupportedAssetSymbolsResponse {
                    symbols: symbols__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("mystiko.api.config.v1.SupportedAssetSymbolsResponse", FIELDS, GeneratedVisitor)
    }
}
