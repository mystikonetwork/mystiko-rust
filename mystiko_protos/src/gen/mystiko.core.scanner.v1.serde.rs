// @generated
impl serde::Serialize for AccountBalanceResult {
    #[allow(deprecated)]
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.core.scanner.v1.AccountBalanceResult", len)?;
        if !self.shielded_addresses.is_empty() {
...
impl<'de> serde::Deserialize<'de> for AccountBalanceResult {
    #[allow(deprecated)]
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = AccountBalanceResult;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.core.scanner.v1.AccountBalanceResult")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<AccountBalanceResult, V::Error>
                where
        ...
        deserializer.deserialize_struct("mystiko.core.scanner.v1.AccountBalanceResult", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ScannerSyncResult {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.core.scanner.v1.ScannerSyncResult", len)?;
        if !self.results.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ScannerSyncResult {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ScannerSyncResult;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.core.scanner.v1.ScannerSyncResult")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<ScannerSyncResult, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(ScannerSyncResult {
                    results: results__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("mystiko.core.scanner.v1.ScannerSyncResult", FIELDS, GeneratedVisitor)
    }
}
