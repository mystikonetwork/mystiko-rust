...
impl serde::Serialize for FindAssetSymbolsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindAssetSymbolsRequest", len)?;
        if self.chain_id != 0 {
...
impl<'de> serde::Deserialize<'de> for FindAssetSymbolsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindAssetSymbolsRequest")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindAssetSymbolsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindAssetSymbolsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindAssetSymbolsResponse", len)?;
        if !self.asset_symbol.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FindAssetSymbolsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindAssetSymbolsResponse")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindAssetSymbolsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindBridgeRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindBridgeRequest", len)?;
        if self.bridge_type != 0 {
...
impl<'de> serde::Deserialize<'de> for FindBridgeRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindBridgeRequest")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindBridgeRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindBridgeResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindBridgeResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for FindBridgeResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindBridgeResponse")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindBridgeResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindBridgesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindBridgesRequest", len)?;
        if self.chain_id != 0 {
            struct_ser.serialize_field("chainId", ToString::to_string(&self.chain_id).as_str())?;
        }
        if self.peer_chain_id != 0 {
...
impl<'de> serde::Deserialize<'de> for FindBridgesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindBridgesRequest")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindBridgesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindBridgesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindBridgesResponse", len)?;
        if !self.bridge_type.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FindBridgesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindBridgesResponse")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindBridgesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindChainRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindChainRequest", len)?;
        if self.chain_id != 0 {
            struct_ser.serialize_field("chainId", ToString::to_string(&self.chain_id).as_str())?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for FindChainRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindChainRequest")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindChainRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindChainResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindChainResponse", len)?;
        if let Some(v) = self.config.as_ref() {
            struct_ser.serialize_field("config", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for FindChainResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindChainResponse")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindChainResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindCircuitRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindCircuitRequest", len)?;
        if !self.circuit_name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FindCircuitRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindCircuitRequest")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindCircuitRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindCircuitResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindCircuitResponse", len)?;
        if let Some(v) = self.config.as_ref() {
            struct_ser.serialize_field("config", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for FindCircuitResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindCircuitResponse")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindCircuitResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindContractByAddressRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindContractByAddressRequest", len)?;
        if self.chain_id != 0 {
            struct_ser.serialize_field("chainId", ToString::to_string(&self.chain_id).as_str())?;
        }
        if !self.address.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FindContractByAddressRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindContractByAddressRequest")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindContractByAddressRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindContractByAddressResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindContractByAddressResponse", len)?;
        if let Some(v) = self.config.as_ref() {
            struct_ser.serialize_field("config", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for FindContractByAddressResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindContractByAddressResponse")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindContractByAddressResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindDefaultCircuitRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindDefaultCircuitRequest", len)?;
        if self.circuit_type != 0 {
...
impl<'de> serde::Deserialize<'de> for FindDefaultCircuitRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindDefaultCircuitRequest")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindDefaultCircuitRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindDefaultCircuitResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindDefaultCircuitResponse", len)?;
        if let Some(v) = self.config.as_ref() {
            struct_ser.serialize_field("config", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for FindDefaultCircuitResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindDefaultCircuitResponse")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindDefaultCircuitResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindDepositContractByAddressRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindDepositContractByAddressRequest", len)?;
        if self.chain_id != 0 {
            struct_ser.serialize_field("chainId", ToString::to_string(&self.chain_id).as_str())?;
        }
        if !self.address.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FindDepositContractByAddressRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindDepositContractByAddressRequest")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindDepositContractByAddressRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindDepositContractByAddressResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindDepositContractByAddressResponse", len)?;
        if let Some(v) = self.config.as_ref() {
            struct_ser.serialize_field("config", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for FindDepositContractByAddressResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindDepositContractByAddressResponse")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindDepositContractByAddressResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindDepositContractRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindDepositContractRequest", len)?;
        if self.chain_id != 0 {
            struct_ser.serialize_field("chainId", ToString::to_string(&self.chain_id).as_str())?;
        }
        if self.peer_chain_id != 0 {
...
impl<'de> serde::Deserialize<'de> for FindDepositContractRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindDepositContractRequest")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindDepositContractRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindDepositContractResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindDepositContractResponse", len)?;
        if let Some(v) = self.config.as_ref() {
            struct_ser.serialize_field("config", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for FindDepositContractResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindDepositContractResponse")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindDepositContractResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindPeerChainsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindPeerChainsRequest", len)?;
        if self.chain_id != 0 {
            struct_ser.serialize_field("chainId", ToString::to_string(&self.chain_id).as_str())?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for FindPeerChainsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindPeerChainsRequest")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindPeerChainsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindPeerChainsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindPeerChainsResponse", len)?;
        if !self.configs.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FindPeerChainsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindPeerChainsResponse")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindPeerChainsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindPoolContractByAddressRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindPoolContractByAddressRequest", len)?;
        if self.chain_id != 0 {
            struct_ser.serialize_field("chainId", ToString::to_string(&self.chain_id).as_str())?;
        }
        if !self.address.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FindPoolContractByAddressRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindPoolContractByAddressRequest")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindPoolContractByAddressRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindPoolContractByAddressResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindPoolContractByAddressResponse", len)?;
        if let Some(v) = self.config.as_ref() {
            struct_ser.serialize_field("config", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for FindPoolContractByAddressResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindPoolContractByAddressResponse")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindPoolContractByAddressResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindPoolContractRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindPoolContractRequest", len)?;
        if self.chain_id != 0 {
            struct_ser.serialize_field("chainId", ToString::to_string(&self.chain_id).as_str())?;
        }
        if !self.asset_symbol.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FindPoolContractRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindPoolContractRequest")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindPoolContractRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindPoolContractResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindPoolContractResponse", len)?;
        if let Some(v) = self.config.as_ref() {
            struct_ser.serialize_field("config", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for FindPoolContractResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindPoolContractResponse")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindPoolContractResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindPoolContractsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindPoolContractsRequest", len)?;
        if self.chain_id != 0 {
            struct_ser.serialize_field("chainId", ToString::to_string(&self.chain_id).as_str())?;
        }
        if !self.asset_symbol.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FindPoolContractsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindPoolContractsRequest")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindPoolContractsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FindPoolContractsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.FindPoolContractsResponse", len)?;
        if !self.config.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FindPoolContractsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.FindPoolContractsResponse")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.FindPoolContractsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetConfigRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("mystiko.config.api.v1.GetConfigRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetConfigRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.GetConfigRequest")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.GetConfigRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetConfigResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.GetConfigResponse", len)?;
        if let Some(v) = self.config.as_ref() {
            struct_ser.serialize_field("config", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetConfigResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.GetConfigResponse")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.GetConfigResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetTransactionUrlRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.GetTransactionUrlRequest", len)?;
        if self.chain_id != 0 {
            struct_ser.serialize_field("chainId", ToString::to_string(&self.chain_id).as_str())?;
        }
        if !self.tx_hash.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetTransactionUrlRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.GetTransactionUrlRequest")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.GetTransactionUrlRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetTransactionUrlResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("mystiko.config.api.v1.GetTransactionUrlResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for GetTransactionUrlResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct mystiko.config.api.v1.GetTransactionUrlResponse")
            }
        ...
        deserializer.deserialize_struct("mystiko.config.api.v1.GetTransactionUrlResponse", FIELDS, GeneratedVisitor)
    }
}
