...
pub static TRANSACTION_SCHEMA: DocumentSchema = DocumentSchema {
    ...
    migrations: &["CREATE TABLE `transactions` (\
            ...
            `input_commitments` VARCHAR(255) NOT NULL,\
            `output_commitments` VARCHAR(255),\
            `serial_numbers` TEXT,\
...
pub struct Transaction {
    ...
    pub signature_public_key_hashes: Option<String>,
    pub amount: String,
    ...
    pub encrypted_auditor_notes: Option<String>,
...
impl DocumentData for Transaction {
    ...
    fn field_value_string(&self, field: &str) -> Option<String> {
        match field {
            ...
            "input_commitments" => Some(self.input_commitments.clone()),
            ...
            "signature_public_key_hashes" => self.signature_public_key_hashes.clone(),
            ...
            "encrypted_auditor_notes" => self.encrypted_auditor_notes.clone(),
    ...
    fn deserialize<F: DocumentRawData>(raw: &F) -> Result<Self, Error> {
        Ok(Transaction {
            ...
            input_commitments: raw.field_string_value("input_commitments")?.unwrap(),
            output_commitments: raw.field_string_value("output_commitments")?,
            serial_numbers: raw.field_string_value("serial_numbers")?,
            signature_public_key: raw.field_string_value("signature_public_key")?,
            signature_public_key_hashes: raw.field_string_value("signature_public_key_hashes")?,
            ...
            encrypted_auditor_notes: raw.field_string_value("encrypted_auditor_notes")?,
