...
impl<F: StatementFormatter, R: DocumentRawData, S: Storage<R>> NullifierCollection<F, R, S> {
    ...
    pub async fn find_all(&self) -> Result<Vec<Document<Nullifier>>> {
        self.collection
            .find::<Nullifier, QueryFilter>(None)
            .await
            .map_err(DatabaseError::StorageError)
    }
    ...
    pub async fn count_all(&self) -> Result<u64> {
        self.collection
            .count::<Nullifier, QueryFilter>(None)
            .await
            .map_err(DatabaseError::StorageError)
    }
    ...
    pub async fn delete_all(&self) -> Result<()> {
        self.collection
            .delete_by_filter::<Nullifier, QueryFilter>(None)
            .await
            .map_err(DatabaseError::StorageError)
    }
    ...
    pub async fn delete_by_filter<Q: Into<QueryFilter>>(&self, filter: Q) -> Result<()> {
        self.collection
            .delete_by_filter::<Nullifier, Q>(Some(filter))
            .await
            .map_err(DatabaseError::StorageError)
    }
    ...
    pub async fn collection_exists(&self) -> Result<bool> {
        self.collection
            .collection_exists(Nullifier::schema())
            .await
            .map_err(DatabaseError::StorageError)
    }
}
