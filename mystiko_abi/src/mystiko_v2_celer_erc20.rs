...
pub mod mystiko_v2_celer_erc20 {
    ...
    impl ethers::contract::EthLogDecode for MystikoV2CelerERC20Events {
            ...
            Self: Sized,
        {
            ...
            if let Ok(decoded) = DepositAmountLimitsFilter::decode_log(log) {
                return Ok(MystikoV2CelerERC20Events::DepositAmountLimitsFilter(
                    decoded,
                ));
            }
    ...
    impl ::std::fmt::Display for MystikoV2CelerERC20Events {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                MystikoV2CelerERC20Events::DepositAmountLimitsFilter(element) => element.fmt(f),
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2CelerERC20Calls {
        fn decode(
            ...
            {
                return Ok(MystikoV2CelerERC20Calls::UpdateDepositAmountLimits(decoded));
            }
            if let Ok(decoded) =
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2CelerERC20Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                MystikoV2CelerERC20Calls::UpdateDepositAmountLimits(element) => element.encode(),
    ...
    impl ::std::fmt::Display for MystikoV2CelerERC20Calls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                MystikoV2CelerERC20Calls::UpdateDepositAmountLimits(element) => element.fmt(f),
    ...
    impl ::std::convert::From<UpdateDepositAmountLimitsCall> for MystikoV2CelerERC20Calls {
        fn from(var: UpdateDepositAmountLimitsCall) -> Self {
            MystikoV2CelerERC20Calls::UpdateDepositAmountLimits(var)
        }
    }
