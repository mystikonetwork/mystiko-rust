...
pub mod mystiko_v2t_bridge_erc20 {
    ...
    impl ::std::fmt::Display for MystikoV2TBridgeERC20Events {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                MystikoV2TBridgeERC20Events::DepositAmountLimitsFilter(element) => element.fmt(f),
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2TBridgeERC20Calls {
        fn decode(
            ...
            {
                return Ok(MystikoV2TBridgeERC20Calls::UpdateDepositAmountLimits(
                    decoded,
                ));
            }
            if let Ok(decoded) =
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2TBridgeERC20Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                MystikoV2TBridgeERC20Calls::UpdateDepositAmountLimits(element) => element.encode(),
    ...
    impl ::std::fmt::Display for MystikoV2TBridgeERC20Calls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                MystikoV2TBridgeERC20Calls::UpdateDepositAmountLimits(element) => element.fmt(f),
    ...
    impl ::std::convert::From<UpdateDepositAmountLimitsCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: UpdateDepositAmountLimitsCall) -> Self {
            MystikoV2TBridgeERC20Calls::UpdateDepositAmountLimits(var)
        }
    }
