...
pub mod mystiko_v2_bridge {
    ...
    impl<M: ::ethers_providers::Middleware> MystikoV2Bridge<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, MystikoV2BridgeEvents>
        {
            self.0
