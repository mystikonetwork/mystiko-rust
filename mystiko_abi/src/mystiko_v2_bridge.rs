...
pub mod mystiko_v2_bridge {
    ...
    impl ::std::fmt::Display for MystikoV2BridgeEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                MystikoV2BridgeEvents::DepositAmountLimitsFilter(element) => element.fmt(f),
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2BridgeCalls {
        fn decode(
            ...
            {
                return Ok(MystikoV2BridgeCalls::UpdateDepositAmountLimits(decoded));
            }
            if let Ok(decoded) =
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2BridgeCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                MystikoV2BridgeCalls::UpdateDepositAmountLimits(element) => element.encode(),
    ...
    impl ::std::fmt::Display for MystikoV2BridgeCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                MystikoV2BridgeCalls::UpdateDepositAmountLimits(element) => element.fmt(f),
    ...
    impl ::std::convert::From<UpdateDepositAmountLimitsCall> for MystikoV2BridgeCalls {
        fn from(var: UpdateDepositAmountLimitsCall) -> Self {
            MystikoV2BridgeCalls::UpdateDepositAmountLimits(var)
        }
    }
