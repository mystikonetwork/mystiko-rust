...
"../json/MystikoV2Bridge.json",
    ...
    pub static MYSTIKOV2BRIDGE_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(
        __abi,
    );
    ...
    impl ::core::convert::From<AssociatedPoolNotSet> for MystikoV2BridgeErrors {
    ...
    impl ::core::convert::From<CertificateInvalid> for MystikoV2BridgeErrors {
    ...
    impl ::core::convert::From<NotSupport> for MystikoV2BridgeErrors {
        fn from(value: NotSupport) -> Self {
            Self::NotSupport(value)
        }
    }
    impl ::core::convert::From<PeerContractAlreadySet> for MystikoV2BridgeErrors {
    ...
    impl ::core::convert::From<AssetAddressCall> for MystikoV2BridgeCalls {
    ...
    impl ::core::convert::From<CertDepositCall> for MystikoV2BridgeCalls {
        fn from(value: CertDepositCall) -> Self {
            Self::CertDeposit(value)
        }
    }
    impl ::core::convert::From<DefaultMaxAmountCall> for MystikoV2BridgeCalls {
        fn from(value: DefaultMaxAmountCall) -> Self {
            Self::DefaultMaxAmount(value)
        }
    }
    impl ::core::convert::From<DefaultMinAmountCall> for MystikoV2BridgeCalls {
        fn from(value: DefaultMinAmountCall) -> Self {
            Self::DefaultMinAmount(value)
        }
    }
    impl ::core::convert::From<DefaultMinBridgeFeeCall> for MystikoV2BridgeCalls {
        fn from(value: DefaultMinBridgeFeeCall) -> Self {
            Self::DefaultMinBridgeFee(value)
        }
    }
    impl ::core::convert::From<DefaultPeerMinExecutorFeeCall> for MystikoV2BridgeCalls {
        fn from(value: DefaultPeerMinExecutorFeeCall) -> Self {
            Self::DefaultPeerMinExecutorFee(value)
        }
    }
    impl ::core::convert::From<DefaultPeerMinRollupFeeCall> for MystikoV2BridgeCalls {
    ...
    impl ::core::convert::From<IsPeerContractSetCall> for MystikoV2BridgeCalls {
    ...
    impl ::core::convert::From<SettingsCall> for MystikoV2BridgeCalls {
