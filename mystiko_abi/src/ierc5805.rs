...
pub mod ierc5805 {
    ...
    pub static IERC5805_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(__abi);
    pub struct IERC5805<M>(::ethers::contract::Contract<M>);
    ...
    impl<M> ::core::fmt::Debug for IERC5805<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IERC5805))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IERC5805<M> {
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, IERC5805Events> {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for IERC5805<M> {
    ...
    impl ::ethers::contract::EthLogDecode for IERC5805Events {
    ...
    impl ::ethers::core::abi::AbiDecode for IERC5805Calls {
    ...
    impl ::ethers::core::abi::AbiEncode for IERC5805Calls {
