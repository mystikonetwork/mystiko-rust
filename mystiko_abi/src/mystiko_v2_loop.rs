...
pub mod mystiko_v2_loop {
    ...
    impl ::std::fmt::Display for MystikoV2LoopEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2LoopEvents::DepositAmountLimitsFilter(element) => element.fmt(f),
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2LoopCalls {
        fn decode(
            ...
            {
                return Ok(MystikoV2LoopCalls::UpdateDepositAmountLimits(decoded));
            }
            if let Ok(decoded) =
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2LoopCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                MystikoV2LoopCalls::UpdateDepositAmountLimits(element) => element.encode(),
    ...
    impl ::std::fmt::Display for MystikoV2LoopCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                MystikoV2LoopCalls::UpdateDepositAmountLimits(element) => element.fmt(f),
    ...
    impl ::std::convert::From<UpdateDepositAmountLimitsCall> for MystikoV2LoopCalls {
        fn from(var: UpdateDepositAmountLimitsCall) -> Self {
            MystikoV2LoopCalls::UpdateDepositAmountLimits(var)
        }
    }
