...
pub mod mystiko_v2t_bridge {
    ...
    impl ethers::contract::EthLogDecode for MystikoV2TBridgeEvents {
            ...
            Self: Sized,
        {
            ...
            if let Ok(decoded) = DepositAmountLimitsFilter::decode_log(log) {
                return Ok(MystikoV2TBridgeEvents::DepositAmountLimitsFilter(decoded));
            }
    ...
    impl ::std::fmt::Display for MystikoV2TBridgeEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                MystikoV2TBridgeEvents::DepositAmountLimitsFilter(element) => element.fmt(f),
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2TBridgeCalls {
        fn decode(
            ...
            {
                return Ok(MystikoV2TBridgeCalls::UpdateDepositAmountLimits(decoded));
            }
            if let Ok(decoded) =
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2TBridgeCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                MystikoV2TBridgeCalls::UpdateDepositAmountLimits(element) => element.encode(),
    ...
    impl ::std::fmt::Display for MystikoV2TBridgeCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                MystikoV2TBridgeCalls::UpdateDepositAmountLimits(element) => element.fmt(f),
    ...
    impl ::std::convert::From<UpdateDepositAmountLimitsCall> for MystikoV2TBridgeCalls {
        fn from(var: UpdateDepositAmountLimitsCall) -> Self {
            MystikoV2TBridgeCalls::UpdateDepositAmountLimits(var)
        }
    }
