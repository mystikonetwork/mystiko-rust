...
pub mod mystiko_v2t_bridge {
    ...
    impl ::ethers::contract::ContractRevert for MystikoV2TBridgeErrors {
    ...
    impl ::core::convert::From<AssociatedPoolNotSet> for MystikoV2TBridgeErrors {
    ...
    impl ::core::convert::From<CertificateInvalid> for MystikoV2TBridgeErrors {
    ...
    impl ::core::convert::From<NotSupport> for MystikoV2TBridgeErrors {
        fn from(value: NotSupport) -> Self {
            Self::NotSupport(value)
        }
    }
    impl ::core::convert::From<PeerChainIdNotMatched> for MystikoV2TBridgeErrors {
        fn from(value: PeerChainIdNotMatched) -> Self {
            Self::PeerChainIdNotMatched(value)
        }
    }
    impl ::core::convert::From<PeerContractAlreadySet> for MystikoV2TBridgeErrors {
        fn from(value: PeerContractAlreadySet) -> Self {
            Self::PeerContractAlreadySet(value)
        }
    }
    impl ::core::convert::From<PeerContractNotMatched> for MystikoV2TBridgeErrors {
    ...
    impl ::core::convert::From<AssetAddressCall> for MystikoV2TBridgeCalls {
    ...
    impl ::core::convert::From<CertDepositCall> for MystikoV2TBridgeCalls {
    ...
    impl ::core::convert::From<DefaultMaxAmountCall> for MystikoV2TBridgeCalls {
        fn from(value: DefaultMaxAmountCall) -> Self {
            Self::DefaultMaxAmount(value)
        }
    }
    impl ::core::convert::From<DefaultMinAmountCall> for MystikoV2TBridgeCalls {
        fn from(value: DefaultMinAmountCall) -> Self {
            Self::DefaultMinAmount(value)
        }
    }
    impl ::core::convert::From<DefaultMinBridgeFeeCall> for MystikoV2TBridgeCalls {
        fn from(value: DefaultMinBridgeFeeCall) -> Self {
            Self::DefaultMinBridgeFee(value)
        }
    }
    impl ::core::convert::From<DefaultPeerMinExecutorFeeCall> for MystikoV2TBridgeCalls {
        fn from(value: DefaultPeerMinExecutorFeeCall) -> Self {
            Self::DefaultPeerMinExecutorFee(value)
        }
    }
    impl ::core::convert::From<DefaultPeerMinRollupFeeCall> for MystikoV2TBridgeCalls {
    ...
    impl ::core::convert::From<IsCertificateCheckEnabledCall> for MystikoV2TBridgeCalls {
    ...
    impl ::core::convert::From<IsPeerContractSetCall> for MystikoV2TBridgeCalls {
    ...
    impl ::core::convert::From<SettingsCall> for MystikoV2TBridgeCalls {
