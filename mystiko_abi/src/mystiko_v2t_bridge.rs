...
pub mod mystiko_v2t_bridge {
    ...
    #[doc = "MystikoV2TBridge was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    ...
    pub static MYSTIKOV2TBRIDGE_ABI: ethers::contract::Lazy<ethers::core::abi::Abi> =
        ethers::contract::Lazy::new(|| {
            ethers::core::utils::__serde_json::from_str(__ABI).expect("invalid abi")
        });
    pub struct MystikoV2TBridge<M>(ethers::contract::Contract<M>);
    impl<M> Clone for MystikoV2TBridge<M> {
        fn clone(&self) -> Self {
            MystikoV2TBridge(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for MystikoV2TBridge<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> std::fmt::Debug for MystikoV2TBridge<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(MystikoV2TBridge))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ethers::providers::Middleware> MystikoV2TBridge<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), MYSTIKOV2TBRIDGE_ABI.clone(), client)
                .into()
        }
        ...
        pub fn events(&self) -> ethers::contract::builders::Event<M, MystikoV2TBridgeEvents> {
            self.0.event_with_filter(Default::default())
        }
    }
    impl<M: ethers::providers::Middleware> From<ethers::contract::Contract<M>> for MystikoV2TBridge<M> {
    ...
    pub enum MystikoV2TBridgeErrors {
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2TBridgeErrors {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            {
                return Ok(MystikoV2TBridgeErrors::MinAmountGreaterThanMaxAmount(
                    decoded,
                ));
            }
            if let Ok(decoded) = <NotChanged as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeErrors::NotChanged(decoded));
            }
            if let Ok(decoded) =
                <OnlyOperator as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeErrors::OnlyOperator(decoded));
            }
            if let Ok(decoded) =
                <RandomSGreaterThanFieldSize as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeErrors::RandomSGreaterThanFieldSize(decoded));
            }
            if let Ok(decoded) =
                <RollupFeeToFew as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeErrors::RollupFeeToFew(decoded));
            }
            if let Ok(decoded) =
                <SanctionedAddress as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeErrors::SanctionedAddress(decoded));
            }
            if let Ok(decoded) =
                <SenderIsNotBridgeProxy as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeErrors::SenderIsNotBridgeProxy(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ethers::core::abi::AbiEncode for MystikoV2TBridgeErrors {
        fn encode(self) -> Vec<u8> {
            match self {
                MystikoV2TBridgeErrors::AmountLessThanZero(element) => element.encode(),
                MystikoV2TBridgeErrors::AmountTooLarge(element) => element.encode(),
                MystikoV2TBridgeErrors::AmountTooSmall(element) => element.encode(),
                MystikoV2TBridgeErrors::BridgeFeeTooFew(element) => element.encode(),
                MystikoV2TBridgeErrors::CommitmentHashIncorrect(element) => element.encode(),
                MystikoV2TBridgeErrors::DepositsDisabled(element) => element.encode(),
                MystikoV2TBridgeErrors::ExecutorFeeTooFew(element) => element.encode(),
                MystikoV2TBridgeErrors::FromChainIdNotMatched(element) => element.encode(),
                MystikoV2TBridgeErrors::FromProxyAddressNotMatched(element) => element.encode(),
                MystikoV2TBridgeErrors::HashKGreaterThanFieldSize(element) => element.encode(),
                MystikoV2TBridgeErrors::Invalid(element) => element.encode(),
                MystikoV2TBridgeErrors::MaxAmountLessThanMinAmount(element) => element.encode(),
                MystikoV2TBridgeErrors::MinAmountGreaterThanMaxAmount(element) => element.encode(),
                MystikoV2TBridgeErrors::NotChanged(element) => element.encode(),
                MystikoV2TBridgeErrors::OnlyOperator(element) => element.encode(),
                MystikoV2TBridgeErrors::RandomSGreaterThanFieldSize(element) => element.encode(),
                MystikoV2TBridgeErrors::RollupFeeToFew(element) => element.encode(),
                MystikoV2TBridgeErrors::SanctionedAddress(element) => element.encode(),
                MystikoV2TBridgeErrors::SenderIsNotBridgeProxy(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for MystikoV2TBridgeErrors {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2TBridgeErrors::AmountLessThanZero(element) => element.fmt(f),
                MystikoV2TBridgeErrors::AmountTooLarge(element) => element.fmt(f),
                MystikoV2TBridgeErrors::AmountTooSmall(element) => element.fmt(f),
                MystikoV2TBridgeErrors::BridgeFeeTooFew(element) => element.fmt(f),
                MystikoV2TBridgeErrors::CommitmentHashIncorrect(element) => element.fmt(f),
                MystikoV2TBridgeErrors::DepositsDisabled(element) => element.fmt(f),
                MystikoV2TBridgeErrors::ExecutorFeeTooFew(element) => element.fmt(f),
                MystikoV2TBridgeErrors::FromChainIdNotMatched(element) => element.fmt(f),
                MystikoV2TBridgeErrors::FromProxyAddressNotMatched(element) => element.fmt(f),
                MystikoV2TBridgeErrors::HashKGreaterThanFieldSize(element) => element.fmt(f),
                MystikoV2TBridgeErrors::Invalid(element) => element.fmt(f),
                MystikoV2TBridgeErrors::MaxAmountLessThanMinAmount(element) => element.fmt(f),
                MystikoV2TBridgeErrors::MinAmountGreaterThanMaxAmount(element) => element.fmt(f),
                MystikoV2TBridgeErrors::NotChanged(element) => element.fmt(f),
                MystikoV2TBridgeErrors::OnlyOperator(element) => element.fmt(f),
                MystikoV2TBridgeErrors::RandomSGreaterThanFieldSize(element) => element.fmt(f),
                MystikoV2TBridgeErrors::RollupFeeToFew(element) => element.fmt(f),
                MystikoV2TBridgeErrors::SanctionedAddress(element) => element.fmt(f),
                MystikoV2TBridgeErrors::SenderIsNotBridgeProxy(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AmountLessThanZero> for MystikoV2TBridgeErrors {
        fn from(var: AmountLessThanZero) -> Self {
            MystikoV2TBridgeErrors::AmountLessThanZero(var)
        }
    }
    impl ::std::convert::From<AmountTooLarge> for MystikoV2TBridgeErrors {
        fn from(var: AmountTooLarge) -> Self {
            MystikoV2TBridgeErrors::AmountTooLarge(var)
        }
    }
    impl ::std::convert::From<AmountTooSmall> for MystikoV2TBridgeErrors {
        fn from(var: AmountTooSmall) -> Self {
            MystikoV2TBridgeErrors::AmountTooSmall(var)
        }
    }
    impl ::std::convert::From<BridgeFeeTooFew> for MystikoV2TBridgeErrors {
        fn from(var: BridgeFeeTooFew) -> Self {
            MystikoV2TBridgeErrors::BridgeFeeTooFew(var)
        }
    }
    impl ::std::convert::From<CommitmentHashIncorrect> for MystikoV2TBridgeErrors {
        fn from(var: CommitmentHashIncorrect) -> Self {
            MystikoV2TBridgeErrors::CommitmentHashIncorrect(var)
        }
    }
    impl ::std::convert::From<DepositsDisabled> for MystikoV2TBridgeErrors {
        fn from(var: DepositsDisabled) -> Self {
            MystikoV2TBridgeErrors::DepositsDisabled(var)
        }
    }
    impl ::std::convert::From<ExecutorFeeTooFew> for MystikoV2TBridgeErrors {
        fn from(var: ExecutorFeeTooFew) -> Self {
            MystikoV2TBridgeErrors::ExecutorFeeTooFew(var)
        }
    }
    impl ::std::convert::From<FromChainIdNotMatched> for MystikoV2TBridgeErrors {
        fn from(var: FromChainIdNotMatched) -> Self {
            MystikoV2TBridgeErrors::FromChainIdNotMatched(var)
        }
    }
    impl ::std::convert::From<FromProxyAddressNotMatched> for MystikoV2TBridgeErrors {
        fn from(var: FromProxyAddressNotMatched) -> Self {
            MystikoV2TBridgeErrors::FromProxyAddressNotMatched(var)
        }
    }
    impl ::std::convert::From<HashKGreaterThanFieldSize> for MystikoV2TBridgeErrors {
        fn from(var: HashKGreaterThanFieldSize) -> Self {
            MystikoV2TBridgeErrors::HashKGreaterThanFieldSize(var)
        }
    }
    impl ::std::convert::From<Invalid> for MystikoV2TBridgeErrors {
        fn from(var: Invalid) -> Self {
            MystikoV2TBridgeErrors::Invalid(var)
        }
    }
    impl ::std::convert::From<MaxAmountLessThanMinAmount> for MystikoV2TBridgeErrors {
        fn from(var: MaxAmountLessThanMinAmount) -> Self {
            MystikoV2TBridgeErrors::MaxAmountLessThanMinAmount(var)
        }
    }
    impl ::std::convert::From<MinAmountGreaterThanMaxAmount> for MystikoV2TBridgeErrors {
        fn from(var: MinAmountGreaterThanMaxAmount) -> Self {
            MystikoV2TBridgeErrors::MinAmountGreaterThanMaxAmount(var)
        }
    }
    impl ::std::convert::From<NotChanged> for MystikoV2TBridgeErrors {
        fn from(var: NotChanged) -> Self {
            MystikoV2TBridgeErrors::NotChanged(var)
        }
    }
    impl ::std::convert::From<OnlyOperator> for MystikoV2TBridgeErrors {
        fn from(var: OnlyOperator) -> Self {
            MystikoV2TBridgeErrors::OnlyOperator(var)
        }
    }
    impl ::std::convert::From<RandomSGreaterThanFieldSize> for MystikoV2TBridgeErrors {
        fn from(var: RandomSGreaterThanFieldSize) -> Self {
            MystikoV2TBridgeErrors::RandomSGreaterThanFieldSize(var)
        }
    }
    impl ::std::convert::From<RollupFeeToFew> for MystikoV2TBridgeErrors {
        fn from(var: RollupFeeToFew) -> Self {
            MystikoV2TBridgeErrors::RollupFeeToFew(var)
        }
    }
    impl ::std::convert::From<SanctionedAddress> for MystikoV2TBridgeErrors {
        fn from(var: SanctionedAddress) -> Self {
            MystikoV2TBridgeErrors::SanctionedAddress(var)
        }
    }
    impl ::std::convert::From<SenderIsNotBridgeProxy> for MystikoV2TBridgeErrors {
        fn from(var: SenderIsNotBridgeProxy) -> Self {
            MystikoV2TBridgeErrors::SenderIsNotBridgeProxy(var)
        }
    }
    #[derive(
        Clone,
    ...
    #[derive(Debug, Clone, PartialEq, Eq, ethers :: contract :: EthAbiType)]
    pub enum MystikoV2TBridgeEvents {
    ...
    impl ethers::contract::EthLogDecode for MystikoV2TBridgeEvents {
        fn decode_log(
            ...
            Self: Sized,
        {
            if let Ok(decoded) = CommitmentCrossChainFilter::decode_log(log) {
                return Ok(MystikoV2TBridgeEvents::CommitmentCrossChainFilter(decoded));
            }
            if let Ok(decoded) = DepositsDisabledFilter::decode_log(log) {
                return Ok(MystikoV2TBridgeEvents::DepositsDisabledFilter(decoded));
            }
            if let Ok(decoded) = MaxAmountFilter::decode_log(log) {
                return Ok(MystikoV2TBridgeEvents::MaxAmountFilter(decoded));
            }
            if let Ok(decoded) = MinAmountFilter::decode_log(log) {
                return Ok(MystikoV2TBridgeEvents::MinAmountFilter(decoded));
            }
            if let Ok(decoded) = MinBridgeFeeFilter::decode_log(log) {
                return Ok(MystikoV2TBridgeEvents::MinBridgeFeeFilter(decoded));
            }
            if let Ok(decoded) = MinExecutorFeeFilter::decode_log(log) {
                return Ok(MystikoV2TBridgeEvents::MinExecutorFeeFilter(decoded));
            }
            if let Ok(decoded) = OperatorChangedFilter::decode_log(log) {
                return Ok(MystikoV2TBridgeEvents::OperatorChangedFilter(decoded));
            }
            if let Ok(decoded) = PeerMinExecutorFeeFilter::decode_log(log) {
                return Ok(MystikoV2TBridgeEvents::PeerMinExecutorFeeFilter(decoded));
            }
            if let Ok(decoded) = PeerMinRollupFeeFilter::decode_log(log) {
                return Ok(MystikoV2TBridgeEvents::PeerMinRollupFeeFilter(decoded));
            }
            if let Ok(decoded) = SanctionsCheckFilter::decode_log(log) {
                return Ok(MystikoV2TBridgeEvents::SanctionsCheckFilter(decoded));
            }
            if let Ok(decoded) = SanctionsListFilter::decode_log(log) {
                return Ok(MystikoV2TBridgeEvents::SanctionsListFilter(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::std::fmt::Display for MystikoV2TBridgeEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2TBridgeEvents::CommitmentCrossChainFilter(element) => element.fmt(f),
                MystikoV2TBridgeEvents::DepositsDisabledFilter(element) => element.fmt(f),
                MystikoV2TBridgeEvents::MaxAmountFilter(element) => element.fmt(f),
                MystikoV2TBridgeEvents::MinAmountFilter(element) => element.fmt(f),
                MystikoV2TBridgeEvents::MinBridgeFeeFilter(element) => element.fmt(f),
                MystikoV2TBridgeEvents::MinExecutorFeeFilter(element) => element.fmt(f),
                MystikoV2TBridgeEvents::OperatorChangedFilter(element) => element.fmt(f),
                MystikoV2TBridgeEvents::PeerMinExecutorFeeFilter(element) => element.fmt(f),
                MystikoV2TBridgeEvents::PeerMinRollupFeeFilter(element) => element.fmt(f),
                MystikoV2TBridgeEvents::SanctionsCheckFilter(element) => element.fmt(f),
                MystikoV2TBridgeEvents::SanctionsListFilter(element) => element.fmt(f),
            }
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq, Eq, ethers :: contract :: EthAbiType)]
    pub enum MystikoV2TBridgeCalls {
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2TBridgeCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::std::result::Result<Self, ethers::core::abi::AbiError> {
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2TBridgeCalls::AssetType(decoded));
            }
            if let Ok(decoded) =
                <BridgeProxyAddressCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeCalls::BridgeProxyAddress(decoded));
            }
            if let Ok(decoded) =
                <BridgeTypeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeCalls::BridgeType(decoded));
            }
            if let Ok(decoded) =
                <ChangeOperatorCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeCalls::ChangeOperator(decoded));
            }
            if let Ok(decoded) =
                <CrossChainSyncTxCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeCalls::CrossChainSyncTx(decoded));
            }
            if let Ok(decoded) =
                <DepositCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeCalls::Deposit(decoded));
            }
            if let Ok(decoded) =
                <DisableSanctionsCheckCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeCalls::DisableSanctionsCheck(decoded));
            }
            if let Ok(decoded) =
                <EnableSanctionsCheckCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeCalls::EnableSanctionsCheck(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2TBridgeCalls::UpdateSanctionsListAddress(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ethers::core::abi::AbiEncode for MystikoV2TBridgeCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                MystikoV2TBridgeCalls::AssetType(element) => element.encode(),
                MystikoV2TBridgeCalls::BridgeProxyAddress(element) => element.encode(),
                MystikoV2TBridgeCalls::BridgeType(element) => element.encode(),
                MystikoV2TBridgeCalls::ChangeOperator(element) => element.encode(),
                MystikoV2TBridgeCalls::CrossChainSyncTx(element) => element.encode(),
                MystikoV2TBridgeCalls::Deposit(element) => element.encode(),
                MystikoV2TBridgeCalls::DisableSanctionsCheck(element) => element.encode(),
                MystikoV2TBridgeCalls::EnableSanctionsCheck(element) => element.encode(),
                MystikoV2TBridgeCalls::GetAssociatedCommitmentPool(element) => element.encode(),
                MystikoV2TBridgeCalls::GetMaxAmount(element) => element.encode(),
                MystikoV2TBridgeCalls::GetMinAmount(element) => element.encode(),
                MystikoV2TBridgeCalls::GetMinBridgeFee(element) => element.encode(),
                MystikoV2TBridgeCalls::GetMinExecutorFee(element) => element.encode(),
                MystikoV2TBridgeCalls::GetPeerMinExecutorFee(element) => element.encode(),
                MystikoV2TBridgeCalls::GetPeerMinRollupFee(element) => element.encode(),
                MystikoV2TBridgeCalls::IsDepositsDisabled(element) => element.encode(),
                MystikoV2TBridgeCalls::PeerChainId(element) => element.encode(),
                MystikoV2TBridgeCalls::PeerChainName(element) => element.encode(),
                MystikoV2TBridgeCalls::PeerContract(element) => element.encode(),
                MystikoV2TBridgeCalls::SanctionsCheck(element) => element.encode(),
                MystikoV2TBridgeCalls::SanctionsList(element) => element.encode(),
                MystikoV2TBridgeCalls::SetAssociatedCommitmentPool(element) => element.encode(),
                MystikoV2TBridgeCalls::SetBridgeProxyAddress(element) => element.encode(),
                MystikoV2TBridgeCalls::SetDepositsDisabled(element) => element.encode(),
                MystikoV2TBridgeCalls::SetMaxAmount(element) => element.encode(),
                MystikoV2TBridgeCalls::SetMinAmount(element) => element.encode(),
                MystikoV2TBridgeCalls::SetMinBridgeFee(element) => element.encode(),
                MystikoV2TBridgeCalls::SetMinExecutorFee(element) => element.encode(),
                MystikoV2TBridgeCalls::SetPeerContract(element) => element.encode(),
                MystikoV2TBridgeCalls::SetPeerMinExecutorFee(element) => element.encode(),
                MystikoV2TBridgeCalls::SetPeerMinRollupFee(element) => element.encode(),
                MystikoV2TBridgeCalls::UpdateSanctionsListAddress(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for MystikoV2TBridgeCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2TBridgeCalls::AssetType(element) => element.fmt(f),
                MystikoV2TBridgeCalls::BridgeProxyAddress(element) => element.fmt(f),
                MystikoV2TBridgeCalls::BridgeType(element) => element.fmt(f),
                MystikoV2TBridgeCalls::ChangeOperator(element) => element.fmt(f),
                MystikoV2TBridgeCalls::CrossChainSyncTx(element) => element.fmt(f),
                MystikoV2TBridgeCalls::Deposit(element) => element.fmt(f),
                MystikoV2TBridgeCalls::DisableSanctionsCheck(element) => element.fmt(f),
                MystikoV2TBridgeCalls::EnableSanctionsCheck(element) => element.fmt(f),
                MystikoV2TBridgeCalls::GetAssociatedCommitmentPool(element) => element.fmt(f),
                MystikoV2TBridgeCalls::GetMaxAmount(element) => element.fmt(f),
                MystikoV2TBridgeCalls::GetMinAmount(element) => element.fmt(f),
                MystikoV2TBridgeCalls::GetMinBridgeFee(element) => element.fmt(f),
                MystikoV2TBridgeCalls::GetMinExecutorFee(element) => element.fmt(f),
                MystikoV2TBridgeCalls::GetPeerMinExecutorFee(element) => element.fmt(f),
                MystikoV2TBridgeCalls::GetPeerMinRollupFee(element) => element.fmt(f),
                MystikoV2TBridgeCalls::IsDepositsDisabled(element) => element.fmt(f),
                MystikoV2TBridgeCalls::PeerChainId(element) => element.fmt(f),
                MystikoV2TBridgeCalls::PeerChainName(element) => element.fmt(f),
                MystikoV2TBridgeCalls::PeerContract(element) => element.fmt(f),
                MystikoV2TBridgeCalls::SanctionsCheck(element) => element.fmt(f),
                MystikoV2TBridgeCalls::SanctionsList(element) => element.fmt(f),
                MystikoV2TBridgeCalls::SetAssociatedCommitmentPool(element) => element.fmt(f),
                MystikoV2TBridgeCalls::SetBridgeProxyAddress(element) => element.fmt(f),
                MystikoV2TBridgeCalls::SetDepositsDisabled(element) => element.fmt(f),
                MystikoV2TBridgeCalls::SetMaxAmount(element) => element.fmt(f),
                MystikoV2TBridgeCalls::SetMinAmount(element) => element.fmt(f),
                MystikoV2TBridgeCalls::SetMinBridgeFee(element) => element.fmt(f),
                MystikoV2TBridgeCalls::SetMinExecutorFee(element) => element.fmt(f),
                MystikoV2TBridgeCalls::SetPeerContract(element) => element.fmt(f),
                MystikoV2TBridgeCalls::SetPeerMinExecutorFee(element) => element.fmt(f),
                MystikoV2TBridgeCalls::SetPeerMinRollupFee(element) => element.fmt(f),
                MystikoV2TBridgeCalls::UpdateSanctionsListAddress(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AssetTypeCall> for MystikoV2TBridgeCalls {
        fn from(var: AssetTypeCall) -> Self {
            MystikoV2TBridgeCalls::AssetType(var)
        }
    }
    impl ::std::convert::From<BridgeProxyAddressCall> for MystikoV2TBridgeCalls {
        fn from(var: BridgeProxyAddressCall) -> Self {
            MystikoV2TBridgeCalls::BridgeProxyAddress(var)
        }
    }
    impl ::std::convert::From<BridgeTypeCall> for MystikoV2TBridgeCalls {
        fn from(var: BridgeTypeCall) -> Self {
            MystikoV2TBridgeCalls::BridgeType(var)
        }
    }
    impl ::std::convert::From<ChangeOperatorCall> for MystikoV2TBridgeCalls {
        fn from(var: ChangeOperatorCall) -> Self {
            MystikoV2TBridgeCalls::ChangeOperator(var)
        }
    }
    impl ::std::convert::From<CrossChainSyncTxCall> for MystikoV2TBridgeCalls {
        fn from(var: CrossChainSyncTxCall) -> Self {
            MystikoV2TBridgeCalls::CrossChainSyncTx(var)
        }
    }
    impl ::std::convert::From<DepositCall> for MystikoV2TBridgeCalls {
        fn from(var: DepositCall) -> Self {
            MystikoV2TBridgeCalls::Deposit(var)
        }
    }
    impl ::std::convert::From<DisableSanctionsCheckCall> for MystikoV2TBridgeCalls {
        fn from(var: DisableSanctionsCheckCall) -> Self {
            MystikoV2TBridgeCalls::DisableSanctionsCheck(var)
        }
    }
    impl ::std::convert::From<EnableSanctionsCheckCall> for MystikoV2TBridgeCalls {
        fn from(var: EnableSanctionsCheckCall) -> Self {
            MystikoV2TBridgeCalls::EnableSanctionsCheck(var)
        }
    }
    impl ::std::convert::From<GetAssociatedCommitmentPoolCall> for MystikoV2TBridgeCalls {
        fn from(var: GetAssociatedCommitmentPoolCall) -> Self {
            MystikoV2TBridgeCalls::GetAssociatedCommitmentPool(var)
        }
    }
    impl ::std::convert::From<GetMaxAmountCall> for MystikoV2TBridgeCalls {
        fn from(var: GetMaxAmountCall) -> Self {
            MystikoV2TBridgeCalls::GetMaxAmount(var)
        }
    }
    impl ::std::convert::From<GetMinAmountCall> for MystikoV2TBridgeCalls {
        fn from(var: GetMinAmountCall) -> Self {
            MystikoV2TBridgeCalls::GetMinAmount(var)
        }
    }
    impl ::std::convert::From<GetMinBridgeFeeCall> for MystikoV2TBridgeCalls {
        fn from(var: GetMinBridgeFeeCall) -> Self {
            MystikoV2TBridgeCalls::GetMinBridgeFee(var)
        }
    }
    impl ::std::convert::From<GetMinExecutorFeeCall> for MystikoV2TBridgeCalls {
        fn from(var: GetMinExecutorFeeCall) -> Self {
            MystikoV2TBridgeCalls::GetMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<GetPeerMinExecutorFeeCall> for MystikoV2TBridgeCalls {
        fn from(var: GetPeerMinExecutorFeeCall) -> Self {
            MystikoV2TBridgeCalls::GetPeerMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<GetPeerMinRollupFeeCall> for MystikoV2TBridgeCalls {
        fn from(var: GetPeerMinRollupFeeCall) -> Self {
            MystikoV2TBridgeCalls::GetPeerMinRollupFee(var)
        }
    }
    impl ::std::convert::From<IsDepositsDisabledCall> for MystikoV2TBridgeCalls {
        fn from(var: IsDepositsDisabledCall) -> Self {
            MystikoV2TBridgeCalls::IsDepositsDisabled(var)
        }
    }
    impl ::std::convert::From<PeerChainIdCall> for MystikoV2TBridgeCalls {
        fn from(var: PeerChainIdCall) -> Self {
            MystikoV2TBridgeCalls::PeerChainId(var)
        }
    }
    impl ::std::convert::From<PeerChainNameCall> for MystikoV2TBridgeCalls {
        fn from(var: PeerChainNameCall) -> Self {
            MystikoV2TBridgeCalls::PeerChainName(var)
        }
    }
    impl ::std::convert::From<PeerContractCall> for MystikoV2TBridgeCalls {
        fn from(var: PeerContractCall) -> Self {
            MystikoV2TBridgeCalls::PeerContract(var)
        }
    }
    impl ::std::convert::From<SanctionsCheckCall> for MystikoV2TBridgeCalls {
        fn from(var: SanctionsCheckCall) -> Self {
            MystikoV2TBridgeCalls::SanctionsCheck(var)
        }
    }
    impl ::std::convert::From<SanctionsListCall> for MystikoV2TBridgeCalls {
        fn from(var: SanctionsListCall) -> Self {
            MystikoV2TBridgeCalls::SanctionsList(var)
        }
    }
    impl ::std::convert::From<SetAssociatedCommitmentPoolCall> for MystikoV2TBridgeCalls {
        fn from(var: SetAssociatedCommitmentPoolCall) -> Self {
            MystikoV2TBridgeCalls::SetAssociatedCommitmentPool(var)
        }
    }
    impl ::std::convert::From<SetBridgeProxyAddressCall> for MystikoV2TBridgeCalls {
        fn from(var: SetBridgeProxyAddressCall) -> Self {
            MystikoV2TBridgeCalls::SetBridgeProxyAddress(var)
        }
    }
    impl ::std::convert::From<SetDepositsDisabledCall> for MystikoV2TBridgeCalls {
        fn from(var: SetDepositsDisabledCall) -> Self {
            MystikoV2TBridgeCalls::SetDepositsDisabled(var)
        }
    }
    impl ::std::convert::From<SetMaxAmountCall> for MystikoV2TBridgeCalls {
        fn from(var: SetMaxAmountCall) -> Self {
            MystikoV2TBridgeCalls::SetMaxAmount(var)
        }
    }
    impl ::std::convert::From<SetMinAmountCall> for MystikoV2TBridgeCalls {
        fn from(var: SetMinAmountCall) -> Self {
            MystikoV2TBridgeCalls::SetMinAmount(var)
        }
    }
    impl ::std::convert::From<SetMinBridgeFeeCall> for MystikoV2TBridgeCalls {
        fn from(var: SetMinBridgeFeeCall) -> Self {
            MystikoV2TBridgeCalls::SetMinBridgeFee(var)
        }
    }
    impl ::std::convert::From<SetMinExecutorFeeCall> for MystikoV2TBridgeCalls {
        fn from(var: SetMinExecutorFeeCall) -> Self {
            MystikoV2TBridgeCalls::SetMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<SetPeerContractCall> for MystikoV2TBridgeCalls {
        fn from(var: SetPeerContractCall) -> Self {
            MystikoV2TBridgeCalls::SetPeerContract(var)
        }
    }
    impl ::std::convert::From<SetPeerMinExecutorFeeCall> for MystikoV2TBridgeCalls {
        fn from(var: SetPeerMinExecutorFeeCall) -> Self {
            MystikoV2TBridgeCalls::SetPeerMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<SetPeerMinRollupFeeCall> for MystikoV2TBridgeCalls {
        fn from(var: SetPeerMinRollupFeeCall) -> Self {
            MystikoV2TBridgeCalls::SetPeerMinRollupFee(var)
        }
    }
    impl ::std::convert::From<UpdateSanctionsListAddressCall> for MystikoV2TBridgeCalls {
        fn from(var: UpdateSanctionsListAddressCall) -> Self {
            MystikoV2TBridgeCalls::UpdateSanctionsListAddress(var)
        }
    }
