...
pub mod mystiko_v2t_bridge {
    ...
    pub static MYSTIKOV2TBRIDGE_ABI: ::ethers_contract::Lazy<
        ::ethers_core::abi::Abi,
    ...
    impl<M> ::core::fmt::Debug for MystikoV2TBridge<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(MystikoV2TBridge)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers_providers::Middleware> MystikoV2TBridge<M> {
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            MystikoV2TBridgeEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers_providers::Middleware> From<::ethers_contract::Contract<M>>
    for MystikoV2TBridge<M> {
