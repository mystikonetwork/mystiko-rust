...
"../json/AssetPool.json",
    ...
    pub static ASSETPOOL_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(
        __abi,
    );
    pub struct AssetPool<M>(::ethers_contract::Contract<M>);
    impl<M> ::core::clone::Clone for AssetPool<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for AssetPool<M> {
        type Target = ::ethers_contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for AssetPool<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for AssetPool<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(AssetPool)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers_providers::Middleware> AssetPool<M> {
    ...
    pub enum AssetPoolCalls {
        AssetAddress(AssetAddressCall),
        AssetType(AssetTypeCall),
    }
    impl ::ethers_core::abi::AbiDecode for AssetPoolCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for AssetPoolCalls {
    ...
    impl ::core::fmt::Display for AssetPoolCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AssetAddressCall> for AssetPoolCalls {
        fn from(value: AssetAddressCall) -> Self {
            Self::AssetAddress(value)
        }
    }
    impl ::core::convert::From<AssetTypeCall> for AssetPoolCalls {
