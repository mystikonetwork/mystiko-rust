...
pub mod votes {
    ...
    pub static VOTES_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(__abi);
    ...
    impl<M: ::ethers::providers::Middleware> Votes<M> {
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, VotesEvents> {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for Votes<M> {
    ...
    impl ::core::convert::From<CheckpointUnorderedInsertion> for VotesErrors {
        fn from(value: CheckpointUnorderedInsertion) -> Self {
            Self::CheckpointUnorderedInsertion(value)
        }
    }
    impl ::core::convert::From<ECDSAInvalidSignature> for VotesErrors {
        fn from(value: ECDSAInvalidSignature) -> Self {
            Self::ECDSAInvalidSignature(value)
        }
    }
    impl ::core::convert::From<ECDSAInvalidSignatureLength> for VotesErrors {
        fn from(value: ECDSAInvalidSignatureLength) -> Self {
            Self::ECDSAInvalidSignatureLength(value)
        }
    }
    impl ::core::convert::From<ECDSAInvalidSignatureS> for VotesErrors {
        fn from(value: ECDSAInvalidSignatureS) -> Self {
            Self::ECDSAInvalidSignatureS(value)
        }
    }
    impl ::core::convert::From<ERC5805FutureLookup> for VotesErrors {
        fn from(value: ERC5805FutureLookup) -> Self {
            Self::ERC5805FutureLookup(value)
        }
    }
    impl ::core::convert::From<ERC6372InconsistentClock> for VotesErrors {
        fn from(value: ERC6372InconsistentClock) -> Self {
            Self::ERC6372InconsistentClock(value)
        }
    }
    impl ::core::convert::From<InvalidAccountNonce> for VotesErrors {
    ...
    impl ::core::convert::From<SafeCastOverflowedUintDowncast> for VotesErrors {
    ...
    impl ::core::convert::From<VotesExpiredSignature> for VotesErrors {
