...
pub mod erc20_permit {
    ...
    pub static ERC20PERMIT_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> ERC20Permit<M> {
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ERC20PermitEvents> {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for ERC20Permit<M> {
    ...
    impl ::core::convert::From<ECDSAInvalidSignature> for ERC20PermitErrors {
        fn from(value: ECDSAInvalidSignature) -> Self {
            Self::ECDSAInvalidSignature(value)
        }
    }
    impl ::core::convert::From<ECDSAInvalidSignatureLength> for ERC20PermitErrors {
        fn from(value: ECDSAInvalidSignatureLength) -> Self {
            Self::ECDSAInvalidSignatureLength(value)
        }
    }
    impl ::core::convert::From<ECDSAInvalidSignatureS> for ERC20PermitErrors {
        fn from(value: ECDSAInvalidSignatureS) -> Self {
            Self::ECDSAInvalidSignatureS(value)
        }
    }
    impl ::core::convert::From<ERC20InsufficientAllowance> for ERC20PermitErrors {
        fn from(value: ERC20InsufficientAllowance) -> Self {
            Self::ERC20InsufficientAllowance(value)
        }
    }
    impl ::core::convert::From<ERC20InsufficientBalance> for ERC20PermitErrors {
        fn from(value: ERC20InsufficientBalance) -> Self {
            Self::ERC20InsufficientBalance(value)
        }
    }
    impl ::core::convert::From<ERC20InvalidApprover> for ERC20PermitErrors {
        fn from(value: ERC20InvalidApprover) -> Self {
            Self::ERC20InvalidApprover(value)
        }
    }
    impl ::core::convert::From<ERC20InvalidReceiver> for ERC20PermitErrors {
        fn from(value: ERC20InvalidReceiver) -> Self {
            Self::ERC20InvalidReceiver(value)
        }
    }
    impl ::core::convert::From<ERC20InvalidSender> for ERC20PermitErrors {
        fn from(value: ERC20InvalidSender) -> Self {
            Self::ERC20InvalidSender(value)
        }
    }
    impl ::core::convert::From<ERC20InvalidSpender> for ERC20PermitErrors {
        fn from(value: ERC20InvalidSpender) -> Self {
            Self::ERC20InvalidSpender(value)
        }
    }
    impl ::core::convert::From<ERC2612ExpiredSignature> for ERC20PermitErrors {
        fn from(value: ERC2612ExpiredSignature) -> Self {
            Self::ERC2612ExpiredSignature(value)
        }
    }
    impl ::core::convert::From<ERC2612InvalidSigner> for ERC20PermitErrors {
        fn from(value: ERC2612InvalidSigner) -> Self {
            Self::ERC2612InvalidSigner(value)
        }
    }
    impl ::core::convert::From<InvalidAccountNonce> for ERC20PermitErrors {
