...
pub mod mystiko_v2_layer_zero_main {
    ...
    #[doc = "MystikoV2LayerZeroMain was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    ...
    impl<M> Clone for MystikoV2LayerZeroMain<M> {
        fn clone(&self) -> Self {
            MystikoV2LayerZeroMain(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for MystikoV2LayerZeroMain<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> std::fmt::Debug for MystikoV2LayerZeroMain<M> {
    ...
    impl<M: ethers::providers::Middleware> MystikoV2LayerZeroMain<M> {
        ...
        pub fn events(&self) -> ethers::contract::builders::Event<M, MystikoV2LayerZeroMainEvents> {
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2LayerZeroMainErrors {
        fn decode(
            ...
            {
                return Ok(MystikoV2LayerZeroMainErrors::AmountLessThanZero(decoded));
            }
            if let Ok(decoded) =
                <AmountTooLarge as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainErrors::AmountTooLarge(decoded));
            }
            if let Ok(decoded) =
                <AmountTooSmall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainErrors::AmountTooSmall(decoded));
            }
            if let Ok(decoded) =
                <BridgeFeeTooFew as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainErrors::BridgeFeeTooFew(decoded));
            }
            if let Ok(decoded) =
                <CallIsNotLzApp as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainErrors::CallIsNotLzApp(decoded));
            }
            if let Ok(decoded) =
                <CommitmentHashIncorrect as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainErrors::CommitmentHashIncorrect(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroMainErrors::DepositsDisabled(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroMainErrors::DestinationChainIsNotTrusted(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroMainErrors::ExecutorFeeTooFew(decoded));
            }
            if let Ok(decoded) =
                <FromChainIdNotMatched as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainErrors::FromChainIdNotMatched(decoded));
            }
            if let Ok(decoded) =
                <FromProxyAddressNotMatched as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainErrors::FromProxyAddressNotMatched(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroMainErrors::HashKGreaterThanFieldSize(
                    decoded,
                ));
            }
            if let Ok(decoded) = <Invalid as ethers::core::abi::AbiDecode>::decode(data.as_ref()) {
                return Ok(MystikoV2LayerZeroMainErrors::Invalid(decoded));
            }
            if let Ok(decoded) =
                <MaxAmountLessThanMinAmount as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainErrors::MaxAmountLessThanMinAmount(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroMainErrors::MinAmountGreaterThanMaxAmount(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroMainErrors::NoStoredMessage(decoded));
            }
            if let Ok(decoded) = <NotChanged as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainErrors::NotChanged(decoded));
            }
            if let Ok(decoded) =
                <OnlyOperator as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainErrors::OnlyOperator(decoded));
            }
            if let Ok(decoded) =
                <RandomSGreaterThanFieldSize as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainErrors::RandomSGreaterThanFieldSize(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroMainErrors::RollupFeeToFew(decoded));
            }
            if let Ok(decoded) =
                <SanctionedAddress as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainErrors::SanctionedAddress(decoded));
            }
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2LayerZeroMainErrors {
        fn encode(self) -> Vec<u8> {
            match self {
                MystikoV2LayerZeroMainErrors::AmountLessThanZero(element) => element.encode(),
                MystikoV2LayerZeroMainErrors::AmountTooLarge(element) => element.encode(),
                MystikoV2LayerZeroMainErrors::AmountTooSmall(element) => element.encode(),
                MystikoV2LayerZeroMainErrors::BridgeFeeTooFew(element) => element.encode(),
                MystikoV2LayerZeroMainErrors::CallIsNotLzApp(element) => element.encode(),
                MystikoV2LayerZeroMainErrors::CommitmentHashIncorrect(element) => element.encode(),
                MystikoV2LayerZeroMainErrors::DepositsDisabled(element) => element.encode(),
                MystikoV2LayerZeroMainErrors::DestinationChainIsNotTrusted(element) => {
                    element.encode()
                }
                MystikoV2LayerZeroMainErrors::ExecutorFeeTooFew(element) => element.encode(),
                MystikoV2LayerZeroMainErrors::FromChainIdNotMatched(element) => element.encode(),
                MystikoV2LayerZeroMainErrors::FromProxyAddressNotMatched(element) => {
                    element.encode()
                }
                MystikoV2LayerZeroMainErrors::HashKGreaterThanFieldSize(element) => {
                    element.encode()
                }
                MystikoV2LayerZeroMainErrors::Invalid(element) => element.encode(),
                MystikoV2LayerZeroMainErrors::MaxAmountLessThanMinAmount(element) => {
                    element.encode()
                }
                MystikoV2LayerZeroMainErrors::MinAmountGreaterThanMaxAmount(element) => {
                    element.encode()
                }
                MystikoV2LayerZeroMainErrors::NoStoredMessage(element) => element.encode(),
                MystikoV2LayerZeroMainErrors::NotChanged(element) => element.encode(),
                MystikoV2LayerZeroMainErrors::OnlyOperator(element) => element.encode(),
                MystikoV2LayerZeroMainErrors::RandomSGreaterThanFieldSize(element) => {
                    element.encode()
                }
                MystikoV2LayerZeroMainErrors::RollupFeeToFew(element) => element.encode(),
                MystikoV2LayerZeroMainErrors::SanctionedAddress(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for MystikoV2LayerZeroMainErrors {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2LayerZeroMainErrors::AmountLessThanZero(element) => element.fmt(f),
                MystikoV2LayerZeroMainErrors::AmountTooLarge(element) => element.fmt(f),
                MystikoV2LayerZeroMainErrors::AmountTooSmall(element) => element.fmt(f),
                MystikoV2LayerZeroMainErrors::BridgeFeeTooFew(element) => element.fmt(f),
                MystikoV2LayerZeroMainErrors::CallIsNotLzApp(element) => element.fmt(f),
                MystikoV2LayerZeroMainErrors::CommitmentHashIncorrect(element) => element.fmt(f),
                MystikoV2LayerZeroMainErrors::DepositsDisabled(element) => element.fmt(f),
                MystikoV2LayerZeroMainErrors::DestinationChainIsNotTrusted(element) => {
                    element.fmt(f)
                }
                MystikoV2LayerZeroMainErrors::ExecutorFeeTooFew(element) => element.fmt(f),
                MystikoV2LayerZeroMainErrors::FromChainIdNotMatched(element) => element.fmt(f),
                MystikoV2LayerZeroMainErrors::FromProxyAddressNotMatched(element) => element.fmt(f),
                MystikoV2LayerZeroMainErrors::HashKGreaterThanFieldSize(element) => element.fmt(f),
                MystikoV2LayerZeroMainErrors::Invalid(element) => element.fmt(f),
                MystikoV2LayerZeroMainErrors::MaxAmountLessThanMinAmount(element) => element.fmt(f),
                MystikoV2LayerZeroMainErrors::MinAmountGreaterThanMaxAmount(element) => {
                    element.fmt(f)
                }
                MystikoV2LayerZeroMainErrors::NoStoredMessage(element) => element.fmt(f),
                MystikoV2LayerZeroMainErrors::NotChanged(element) => element.fmt(f),
                MystikoV2LayerZeroMainErrors::OnlyOperator(element) => element.fmt(f),
                MystikoV2LayerZeroMainErrors::RandomSGreaterThanFieldSize(element) => {
                    element.fmt(f)
                }
                MystikoV2LayerZeroMainErrors::RollupFeeToFew(element) => element.fmt(f),
                MystikoV2LayerZeroMainErrors::SanctionedAddress(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AmountLessThanZero> for MystikoV2LayerZeroMainErrors {
        fn from(var: AmountLessThanZero) -> Self {
            MystikoV2LayerZeroMainErrors::AmountLessThanZero(var)
        }
    }
    impl ::std::convert::From<AmountTooLarge> for MystikoV2LayerZeroMainErrors {
        fn from(var: AmountTooLarge) -> Self {
            MystikoV2LayerZeroMainErrors::AmountTooLarge(var)
        }
    }
    impl ::std::convert::From<AmountTooSmall> for MystikoV2LayerZeroMainErrors {
        fn from(var: AmountTooSmall) -> Self {
            MystikoV2LayerZeroMainErrors::AmountTooSmall(var)
        }
    }
    impl ::std::convert::From<BridgeFeeTooFew> for MystikoV2LayerZeroMainErrors {
        fn from(var: BridgeFeeTooFew) -> Self {
            MystikoV2LayerZeroMainErrors::BridgeFeeTooFew(var)
        }
    }
    impl ::std::convert::From<CallIsNotLzApp> for MystikoV2LayerZeroMainErrors {
        fn from(var: CallIsNotLzApp) -> Self {
            MystikoV2LayerZeroMainErrors::CallIsNotLzApp(var)
        }
    }
    impl ::std::convert::From<CommitmentHashIncorrect> for MystikoV2LayerZeroMainErrors {
        fn from(var: CommitmentHashIncorrect) -> Self {
            MystikoV2LayerZeroMainErrors::CommitmentHashIncorrect(var)
        }
    }
    impl ::std::convert::From<DepositsDisabled> for MystikoV2LayerZeroMainErrors {
        fn from(var: DepositsDisabled) -> Self {
            MystikoV2LayerZeroMainErrors::DepositsDisabled(var)
        }
    }
    impl ::std::convert::From<DestinationChainIsNotTrusted> for MystikoV2LayerZeroMainErrors {
        fn from(var: DestinationChainIsNotTrusted) -> Self {
            MystikoV2LayerZeroMainErrors::DestinationChainIsNotTrusted(var)
        }
    }
    impl ::std::convert::From<ExecutorFeeTooFew> for MystikoV2LayerZeroMainErrors {
        fn from(var: ExecutorFeeTooFew) -> Self {
            MystikoV2LayerZeroMainErrors::ExecutorFeeTooFew(var)
        }
    }
    impl ::std::convert::From<FromChainIdNotMatched> for MystikoV2LayerZeroMainErrors {
        fn from(var: FromChainIdNotMatched) -> Self {
            MystikoV2LayerZeroMainErrors::FromChainIdNotMatched(var)
        }
    }
    impl ::std::convert::From<FromProxyAddressNotMatched> for MystikoV2LayerZeroMainErrors {
        fn from(var: FromProxyAddressNotMatched) -> Self {
            MystikoV2LayerZeroMainErrors::FromProxyAddressNotMatched(var)
        }
    }
    impl ::std::convert::From<HashKGreaterThanFieldSize> for MystikoV2LayerZeroMainErrors {
        fn from(var: HashKGreaterThanFieldSize) -> Self {
            MystikoV2LayerZeroMainErrors::HashKGreaterThanFieldSize(var)
        }
    }
    impl ::std::convert::From<Invalid> for MystikoV2LayerZeroMainErrors {
        fn from(var: Invalid) -> Self {
            MystikoV2LayerZeroMainErrors::Invalid(var)
        }
    }
    impl ::std::convert::From<MaxAmountLessThanMinAmount> for MystikoV2LayerZeroMainErrors {
        fn from(var: MaxAmountLessThanMinAmount) -> Self {
            MystikoV2LayerZeroMainErrors::MaxAmountLessThanMinAmount(var)
        }
    }
    impl ::std::convert::From<MinAmountGreaterThanMaxAmount> for MystikoV2LayerZeroMainErrors {
        fn from(var: MinAmountGreaterThanMaxAmount) -> Self {
            MystikoV2LayerZeroMainErrors::MinAmountGreaterThanMaxAmount(var)
        }
    }
    impl ::std::convert::From<NoStoredMessage> for MystikoV2LayerZeroMainErrors {
        fn from(var: NoStoredMessage) -> Self {
            MystikoV2LayerZeroMainErrors::NoStoredMessage(var)
        }
    }
    impl ::std::convert::From<NotChanged> for MystikoV2LayerZeroMainErrors {
        fn from(var: NotChanged) -> Self {
            MystikoV2LayerZeroMainErrors::NotChanged(var)
        }
    }
    impl ::std::convert::From<OnlyOperator> for MystikoV2LayerZeroMainErrors {
        fn from(var: OnlyOperator) -> Self {
            MystikoV2LayerZeroMainErrors::OnlyOperator(var)
        }
    }
    impl ::std::convert::From<RandomSGreaterThanFieldSize> for MystikoV2LayerZeroMainErrors {
        fn from(var: RandomSGreaterThanFieldSize) -> Self {
            MystikoV2LayerZeroMainErrors::RandomSGreaterThanFieldSize(var)
        }
    }
    impl ::std::convert::From<RollupFeeToFew> for MystikoV2LayerZeroMainErrors {
        fn from(var: RollupFeeToFew) -> Self {
            MystikoV2LayerZeroMainErrors::RollupFeeToFew(var)
        }
    }
    impl ::std::convert::From<SanctionedAddress> for MystikoV2LayerZeroMainErrors {
        fn from(var: SanctionedAddress) -> Self {
            MystikoV2LayerZeroMainErrors::SanctionedAddress(var)
        }
    }
    #[derive(
        Clone,
    ...
    impl ethers::contract::EthLogDecode for MystikoV2LayerZeroMainEvents {
            ...
            Self: Sized,
        {
            if let Ok(decoded) = CommitmentCrossChainFilter::decode_log(log) {
                return Ok(MystikoV2LayerZeroMainEvents::CommitmentCrossChainFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = DepositsDisabledFilter::decode_log(log) {
                return Ok(MystikoV2LayerZeroMainEvents::DepositsDisabledFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = MaxAmountFilter::decode_log(log) {
                return Ok(MystikoV2LayerZeroMainEvents::MaxAmountFilter(decoded));
            }
            ...
            if let Ok(decoded) = MinAmountFilter::decode_log(log) {
                return Ok(MystikoV2LayerZeroMainEvents::MinAmountFilter(decoded));
            }
            ...
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(MystikoV2LayerZeroMainEvents::OwnershipTransferredFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = PeerMinExecutorFeeFilter::decode_log(log) {
                return Ok(MystikoV2LayerZeroMainEvents::PeerMinExecutorFeeFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = PeerMinRollupFeeFilter::decode_log(log) {
                return Ok(MystikoV2LayerZeroMainEvents::PeerMinRollupFeeFilter(
                    decoded,
                ));
            }
            ...
            if let Ok(decoded) = SetTrustedRemoteFilter::decode_log(log) {
                return Ok(MystikoV2LayerZeroMainEvents::SetTrustedRemoteFilter(
                    decoded,
                ));
            }
    ...
    impl ::std::fmt::Display for MystikoV2LayerZeroMainEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2LayerZeroMainEvents::CommitmentCrossChainFilter(element) => element.fmt(f),
                MystikoV2LayerZeroMainEvents::DepositsDisabledFilter(element) => element.fmt(f),
                MystikoV2LayerZeroMainEvents::MaxAmountFilter(element) => element.fmt(f),
                MystikoV2LayerZeroMainEvents::MessageFailedFilter(element) => element.fmt(f),
                MystikoV2LayerZeroMainEvents::MinAmountFilter(element) => element.fmt(f),
                MystikoV2LayerZeroMainEvents::MinBridgeFeeFilter(element) => element.fmt(f),
                MystikoV2LayerZeroMainEvents::MinExecutorFeeFilter(element) => element.fmt(f),
                MystikoV2LayerZeroMainEvents::OperatorChangedFilter(element) => element.fmt(f),
                MystikoV2LayerZeroMainEvents::OwnershipTransferredFilter(element) => element.fmt(f),
                MystikoV2LayerZeroMainEvents::PeerMinExecutorFeeFilter(element) => element.fmt(f),
                MystikoV2LayerZeroMainEvents::PeerMinRollupFeeFilter(element) => element.fmt(f),
                MystikoV2LayerZeroMainEvents::SanctionsCheckFilter(element) => element.fmt(f),
                MystikoV2LayerZeroMainEvents::SanctionsListFilter(element) => element.fmt(f),
                MystikoV2LayerZeroMainEvents::SetTrustedRemoteFilter(element) => element.fmt(f),
            }
        }
    }
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2LayerZeroMainCalls {
        fn decode(
            ...
            {
                return Ok(MystikoV2LayerZeroMainCalls::AssetType(decoded));
            }
            if let Ok(decoded) =
                <BridgeProxyAddressCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::BridgeProxyAddress(decoded));
            }
            if let Ok(decoded) =
                <BridgeTypeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::BridgeType(decoded));
            }
            if let Ok(decoded) =
                <ChangeOperatorCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::ChangeOperator(decoded));
            }
            if let Ok(decoded) =
                <DepositCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::Deposit(decoded));
            }
            if let Ok(decoded) =
                <DisableSanctionsCheckCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::DisableSanctionsCheck(decoded));
            }
            if let Ok(decoded) =
                <EnableSanctionsCheckCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::EnableSanctionsCheck(decoded));
            }
            if let Ok(decoded) =
                <FailedMessagesCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::FailedMessages(decoded));
            }
            if let Ok(decoded) =
                <ForceResumeReceiveCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::ForceResumeReceive(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroMainCalls::GetAssociatedCommitmentPool(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroMainCalls::GetConfig(decoded));
            }
            if let Ok(decoded) =
                <GetMaxAmountCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::GetMaxAmount(decoded));
            }
            if let Ok(decoded) =
                <GetMinAmountCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::GetMinAmount(decoded));
            }
            if let Ok(decoded) =
                <GetMinBridgeFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::GetMinBridgeFee(decoded));
            }
            if let Ok(decoded) =
                <GetMinExecutorFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::GetMinExecutorFee(decoded));
            }
            if let Ok(decoded) =
                <GetPeerMinExecutorFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::GetPeerMinExecutorFee(decoded));
            }
            if let Ok(decoded) =
                <GetPeerMinRollupFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::GetPeerMinRollupFee(decoded));
            }
            if let Ok(decoded) =
                <IsDepositsDisabledCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::IsDepositsDisabled(decoded));
            }
            if let Ok(decoded) =
                <IsTrustedRemoteCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::IsTrustedRemote(decoded));
            }
            if let Ok(decoded) =
                <LocalLayerZeroChainIdCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::LocalLayerZeroChainId(decoded));
            }
            if let Ok(decoded) =
                <LzEndpointCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::LzEndpoint(decoded));
            }
            if let Ok(decoded) =
                <LzReceiveCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::LzReceive(decoded));
            }
            if let Ok(decoded) =
                <NonblockingLzReceiveCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::NonblockingLzReceive(decoded));
            }
            if let Ok(decoded) = <OwnerCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::Owner(decoded));
            }
            if let Ok(decoded) =
                <PeerChainIdCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::PeerChainId(decoded));
            }
            if let Ok(decoded) =
                <PeerChainNameCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::PeerChainName(decoded));
            }
            if let Ok(decoded) =
                <PeerContractCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::PeerContract(decoded));
            }
            if let Ok(decoded) =
                <PeerLayerZeroChainIdCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::PeerLayerZeroChainId(decoded));
            }
            if let Ok(decoded) =
                <RenounceOwnershipCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::RenounceOwnership(decoded));
            }
            if let Ok(decoded) =
                <RetryMessageCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::RetryMessage(decoded));
            }
            if let Ok(decoded) =
                <SanctionsCheckCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::SanctionsCheck(decoded));
            }
            if let Ok(decoded) =
                <SanctionsListCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::SanctionsList(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroMainCalls::SetAssociatedCommitmentPool(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroMainCalls::SetBridgeProxyAddress(decoded));
            }
            if let Ok(decoded) =
                <SetConfigCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::SetConfig(decoded));
            }
            if let Ok(decoded) =
                <SetDepositsDisabledCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::SetDepositsDisabled(decoded));
            }
            if let Ok(decoded) =
                <SetEndpointCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::SetEndpoint(decoded));
            }
            if let Ok(decoded) =
                <SetMaxAmountCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::SetMaxAmount(decoded));
            }
            if let Ok(decoded) =
                <SetMinAmountCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::SetMinAmount(decoded));
            }
            if let Ok(decoded) =
                <SetMinBridgeFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::SetMinBridgeFee(decoded));
            }
            if let Ok(decoded) =
                <SetMinExecutorFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::SetMinExecutorFee(decoded));
            }
            if let Ok(decoded) =
                <SetPeerContractCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::SetPeerContract(decoded));
            }
            if let Ok(decoded) =
                <SetPeerMinExecutorFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::SetPeerMinExecutorFee(decoded));
            }
            if let Ok(decoded) =
                <SetPeerMinRollupFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::SetPeerMinRollupFee(decoded));
            }
            if let Ok(decoded) =
                <SetReceiveVersionCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::SetReceiveVersion(decoded));
            }
            if let Ok(decoded) =
                <SetSendVersionCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::SetSendVersion(decoded));
            }
            if let Ok(decoded) =
                <SetTrustedRemoteCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::SetTrustedRemote(decoded));
            }
            if let Ok(decoded) =
                <TransferOwnershipCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::TransferOwnership(decoded));
            }
            if let Ok(decoded) =
                <TrustedRemoteLookupCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroMainCalls::TrustedRemoteLookup(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroMainCalls::UpdateSanctionsListAddress(
                    decoded,
                ));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2LayerZeroMainCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                MystikoV2LayerZeroMainCalls::AssetType(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::BridgeProxyAddress(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::BridgeType(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::ChangeOperator(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::Deposit(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::DisableSanctionsCheck(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::EnableSanctionsCheck(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::FailedMessages(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::ForceResumeReceive(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::GetAssociatedCommitmentPool(element) => {
                    element.encode()
                }
                MystikoV2LayerZeroMainCalls::GetConfig(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::GetMaxAmount(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::GetMinAmount(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::GetMinBridgeFee(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::GetMinExecutorFee(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::GetPeerMinExecutorFee(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::GetPeerMinRollupFee(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::IsDepositsDisabled(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::IsTrustedRemote(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::LocalLayerZeroChainId(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::LzEndpoint(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::LzReceive(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::NonblockingLzReceive(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::Owner(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::PeerChainId(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::PeerChainName(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::PeerContract(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::PeerLayerZeroChainId(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::RenounceOwnership(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::RetryMessage(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::SanctionsCheck(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::SanctionsList(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::SetAssociatedCommitmentPool(element) => {
                    element.encode()
                }
                MystikoV2LayerZeroMainCalls::SetBridgeProxyAddress(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::SetConfig(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::SetDepositsDisabled(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::SetEndpoint(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::SetMaxAmount(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::SetMinAmount(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::SetMinBridgeFee(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::SetMinExecutorFee(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::SetPeerContract(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::SetPeerMinExecutorFee(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::SetPeerMinRollupFee(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::SetReceiveVersion(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::SetSendVersion(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::SetTrustedRemote(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::TransferOwnership(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::TrustedRemoteLookup(element) => element.encode(),
                MystikoV2LayerZeroMainCalls::UpdateSanctionsListAddress(element) => {
                    element.encode()
                }
            }
        }
    }
    impl ::std::fmt::Display for MystikoV2LayerZeroMainCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2LayerZeroMainCalls::AssetType(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::BridgeProxyAddress(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::BridgeType(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::ChangeOperator(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::Deposit(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::DisableSanctionsCheck(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::EnableSanctionsCheck(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::FailedMessages(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::ForceResumeReceive(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::GetAssociatedCommitmentPool(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::GetConfig(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::GetMaxAmount(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::GetMinAmount(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::GetMinBridgeFee(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::GetMinExecutorFee(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::GetPeerMinExecutorFee(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::GetPeerMinRollupFee(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::IsDepositsDisabled(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::IsTrustedRemote(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::LocalLayerZeroChainId(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::LzEndpoint(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::LzReceive(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::NonblockingLzReceive(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::Owner(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::PeerChainId(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::PeerChainName(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::PeerContract(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::PeerLayerZeroChainId(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::RenounceOwnership(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::RetryMessage(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::SanctionsCheck(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::SanctionsList(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::SetAssociatedCommitmentPool(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::SetBridgeProxyAddress(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::SetConfig(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::SetDepositsDisabled(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::SetEndpoint(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::SetMaxAmount(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::SetMinAmount(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::SetMinBridgeFee(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::SetMinExecutorFee(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::SetPeerContract(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::SetPeerMinExecutorFee(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::SetPeerMinRollupFee(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::SetReceiveVersion(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::SetSendVersion(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::SetTrustedRemote(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::TransferOwnership(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::TrustedRemoteLookup(element) => element.fmt(f),
                MystikoV2LayerZeroMainCalls::UpdateSanctionsListAddress(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AssetTypeCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: AssetTypeCall) -> Self {
            MystikoV2LayerZeroMainCalls::AssetType(var)
        }
    }
    impl ::std::convert::From<BridgeProxyAddressCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: BridgeProxyAddressCall) -> Self {
            MystikoV2LayerZeroMainCalls::BridgeProxyAddress(var)
        }
    }
    impl ::std::convert::From<BridgeTypeCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: BridgeTypeCall) -> Self {
            MystikoV2LayerZeroMainCalls::BridgeType(var)
        }
    }
    impl ::std::convert::From<ChangeOperatorCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: ChangeOperatorCall) -> Self {
            MystikoV2LayerZeroMainCalls::ChangeOperator(var)
        }
    }
    impl ::std::convert::From<DepositCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: DepositCall) -> Self {
            MystikoV2LayerZeroMainCalls::Deposit(var)
        }
    }
    impl ::std::convert::From<DisableSanctionsCheckCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: DisableSanctionsCheckCall) -> Self {
            MystikoV2LayerZeroMainCalls::DisableSanctionsCheck(var)
        }
    }
    impl ::std::convert::From<EnableSanctionsCheckCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: EnableSanctionsCheckCall) -> Self {
            MystikoV2LayerZeroMainCalls::EnableSanctionsCheck(var)
        }
    }
    impl ::std::convert::From<FailedMessagesCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: FailedMessagesCall) -> Self {
            MystikoV2LayerZeroMainCalls::FailedMessages(var)
        }
    }
    impl ::std::convert::From<ForceResumeReceiveCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: ForceResumeReceiveCall) -> Self {
            MystikoV2LayerZeroMainCalls::ForceResumeReceive(var)
        }
    }
    impl ::std::convert::From<GetAssociatedCommitmentPoolCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: GetAssociatedCommitmentPoolCall) -> Self {
            MystikoV2LayerZeroMainCalls::GetAssociatedCommitmentPool(var)
        }
    }
    impl ::std::convert::From<GetConfigCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: GetConfigCall) -> Self {
            MystikoV2LayerZeroMainCalls::GetConfig(var)
        }
    }
    impl ::std::convert::From<GetMaxAmountCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: GetMaxAmountCall) -> Self {
            MystikoV2LayerZeroMainCalls::GetMaxAmount(var)
        }
    }
    impl ::std::convert::From<GetMinAmountCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: GetMinAmountCall) -> Self {
            MystikoV2LayerZeroMainCalls::GetMinAmount(var)
        }
    }
    impl ::std::convert::From<GetMinBridgeFeeCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: GetMinBridgeFeeCall) -> Self {
            MystikoV2LayerZeroMainCalls::GetMinBridgeFee(var)
        }
    }
    impl ::std::convert::From<GetMinExecutorFeeCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: GetMinExecutorFeeCall) -> Self {
            MystikoV2LayerZeroMainCalls::GetMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<GetPeerMinExecutorFeeCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: GetPeerMinExecutorFeeCall) -> Self {
            MystikoV2LayerZeroMainCalls::GetPeerMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<GetPeerMinRollupFeeCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: GetPeerMinRollupFeeCall) -> Self {
            MystikoV2LayerZeroMainCalls::GetPeerMinRollupFee(var)
        }
    }
    impl ::std::convert::From<IsDepositsDisabledCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: IsDepositsDisabledCall) -> Self {
            MystikoV2LayerZeroMainCalls::IsDepositsDisabled(var)
        }
    }
    impl ::std::convert::From<IsTrustedRemoteCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: IsTrustedRemoteCall) -> Self {
            MystikoV2LayerZeroMainCalls::IsTrustedRemote(var)
        }
    }
    impl ::std::convert::From<LocalLayerZeroChainIdCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: LocalLayerZeroChainIdCall) -> Self {
            MystikoV2LayerZeroMainCalls::LocalLayerZeroChainId(var)
        }
    }
    impl ::std::convert::From<LzEndpointCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: LzEndpointCall) -> Self {
            MystikoV2LayerZeroMainCalls::LzEndpoint(var)
        }
    }
    impl ::std::convert::From<LzReceiveCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: LzReceiveCall) -> Self {
            MystikoV2LayerZeroMainCalls::LzReceive(var)
        }
    }
    impl ::std::convert::From<NonblockingLzReceiveCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: NonblockingLzReceiveCall) -> Self {
            MystikoV2LayerZeroMainCalls::NonblockingLzReceive(var)
        }
    }
    impl ::std::convert::From<OwnerCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: OwnerCall) -> Self {
            MystikoV2LayerZeroMainCalls::Owner(var)
        }
    }
    impl ::std::convert::From<PeerChainIdCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: PeerChainIdCall) -> Self {
            MystikoV2LayerZeroMainCalls::PeerChainId(var)
        }
    }
    impl ::std::convert::From<PeerChainNameCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: PeerChainNameCall) -> Self {
            MystikoV2LayerZeroMainCalls::PeerChainName(var)
        }
    }
    impl ::std::convert::From<PeerContractCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: PeerContractCall) -> Self {
            MystikoV2LayerZeroMainCalls::PeerContract(var)
        }
    }
    impl ::std::convert::From<PeerLayerZeroChainIdCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: PeerLayerZeroChainIdCall) -> Self {
            MystikoV2LayerZeroMainCalls::PeerLayerZeroChainId(var)
        }
    }
    impl ::std::convert::From<RenounceOwnershipCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: RenounceOwnershipCall) -> Self {
            MystikoV2LayerZeroMainCalls::RenounceOwnership(var)
        }
    }
    impl ::std::convert::From<RetryMessageCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: RetryMessageCall) -> Self {
            MystikoV2LayerZeroMainCalls::RetryMessage(var)
        }
    }
    impl ::std::convert::From<SanctionsCheckCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: SanctionsCheckCall) -> Self {
            MystikoV2LayerZeroMainCalls::SanctionsCheck(var)
        }
    }
    impl ::std::convert::From<SanctionsListCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: SanctionsListCall) -> Self {
            MystikoV2LayerZeroMainCalls::SanctionsList(var)
        }
    }
    impl ::std::convert::From<SetAssociatedCommitmentPoolCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: SetAssociatedCommitmentPoolCall) -> Self {
            MystikoV2LayerZeroMainCalls::SetAssociatedCommitmentPool(var)
        }
    }
    impl ::std::convert::From<SetBridgeProxyAddressCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: SetBridgeProxyAddressCall) -> Self {
            MystikoV2LayerZeroMainCalls::SetBridgeProxyAddress(var)
        }
    }
    impl ::std::convert::From<SetConfigCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: SetConfigCall) -> Self {
            MystikoV2LayerZeroMainCalls::SetConfig(var)
        }
    }
    impl ::std::convert::From<SetDepositsDisabledCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: SetDepositsDisabledCall) -> Self {
            MystikoV2LayerZeroMainCalls::SetDepositsDisabled(var)
        }
    }
    impl ::std::convert::From<SetEndpointCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: SetEndpointCall) -> Self {
            MystikoV2LayerZeroMainCalls::SetEndpoint(var)
        }
    }
    impl ::std::convert::From<SetMaxAmountCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: SetMaxAmountCall) -> Self {
            MystikoV2LayerZeroMainCalls::SetMaxAmount(var)
        }
    }
    impl ::std::convert::From<SetMinAmountCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: SetMinAmountCall) -> Self {
            MystikoV2LayerZeroMainCalls::SetMinAmount(var)
        }
    }
    impl ::std::convert::From<SetMinBridgeFeeCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: SetMinBridgeFeeCall) -> Self {
            MystikoV2LayerZeroMainCalls::SetMinBridgeFee(var)
        }
    }
    impl ::std::convert::From<SetMinExecutorFeeCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: SetMinExecutorFeeCall) -> Self {
            MystikoV2LayerZeroMainCalls::SetMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<SetPeerContractCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: SetPeerContractCall) -> Self {
            MystikoV2LayerZeroMainCalls::SetPeerContract(var)
        }
    }
    impl ::std::convert::From<SetPeerMinExecutorFeeCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: SetPeerMinExecutorFeeCall) -> Self {
            MystikoV2LayerZeroMainCalls::SetPeerMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<SetPeerMinRollupFeeCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: SetPeerMinRollupFeeCall) -> Self {
            MystikoV2LayerZeroMainCalls::SetPeerMinRollupFee(var)
        }
    }
    impl ::std::convert::From<SetReceiveVersionCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: SetReceiveVersionCall) -> Self {
            MystikoV2LayerZeroMainCalls::SetReceiveVersion(var)
        }
    }
    impl ::std::convert::From<SetSendVersionCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: SetSendVersionCall) -> Self {
            MystikoV2LayerZeroMainCalls::SetSendVersion(var)
        }
    }
    impl ::std::convert::From<SetTrustedRemoteCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: SetTrustedRemoteCall) -> Self {
            MystikoV2LayerZeroMainCalls::SetTrustedRemote(var)
        }
    }
    impl ::std::convert::From<TransferOwnershipCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: TransferOwnershipCall) -> Self {
            MystikoV2LayerZeroMainCalls::TransferOwnership(var)
        }
    }
    impl ::std::convert::From<TrustedRemoteLookupCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: TrustedRemoteLookupCall) -> Self {
            MystikoV2LayerZeroMainCalls::TrustedRemoteLookup(var)
        }
    }
    impl ::std::convert::From<UpdateSanctionsListAddressCall> for MystikoV2LayerZeroMainCalls {
        fn from(var: UpdateSanctionsListAddressCall) -> Self {
            MystikoV2LayerZeroMainCalls::UpdateSanctionsListAddress(var)
        }
    }
