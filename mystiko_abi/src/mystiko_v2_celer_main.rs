...
pub mod mystiko_v2_celer_main {
    ...
    #[doc = "MystikoV2CelerMain was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    ...
    impl<M> Clone for MystikoV2CelerMain<M> {
        fn clone(&self) -> Self {
            MystikoV2CelerMain(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for MystikoV2CelerMain<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> std::fmt::Debug for MystikoV2CelerMain<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(MystikoV2CelerMain))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ethers::providers::Middleware> MystikoV2CelerMain<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), MYSTIKOV2CELERMAIN_ABI.clone(), client)
                .into()
        }
        ...
        pub fn events(&self) -> ethers::contract::builders::Event<M, MystikoV2CelerMainEvents> {
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2CelerMainErrors {
        fn decode(
            ...
            {
                return Ok(MystikoV2CelerMainErrors::AmountLessThanZero(decoded));
            }
            if let Ok(decoded) =
                <AmountTooLarge as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainErrors::AmountTooLarge(decoded));
            }
            if let Ok(decoded) =
                <AmountTooSmall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainErrors::AmountTooSmall(decoded));
            }
            if let Ok(decoded) =
                <BridgeFeeTooFew as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainErrors::BridgeFeeTooFew(decoded));
            }
            if let Ok(decoded) =
                <CommitmentHashIncorrect as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainErrors::CommitmentHashIncorrect(decoded));
            }
            if let Ok(decoded) =
                <DepositsDisabled as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainErrors::DepositsDisabled(decoded));
            }
            if let Ok(decoded) =
                <ExecutorFeeTooFew as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainErrors::ExecutorFeeTooFew(decoded));
            }
            if let Ok(decoded) =
                <FromChainIdNotMatched as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainErrors::FromChainIdNotMatched(decoded));
            }
            if let Ok(decoded) =
                <FromProxyAddressNotMatched as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainErrors::FromProxyAddressNotMatched(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2CelerMainErrors::HashKGreaterThanFieldSize(decoded));
            }
            if let Ok(decoded) = <Invalid as ethers::core::abi::AbiDecode>::decode(data.as_ref()) {
                return Ok(MystikoV2CelerMainErrors::Invalid(decoded));
            }
            if let Ok(decoded) =
                <MaxAmountLessThanMinAmount as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainErrors::MaxAmountLessThanMinAmount(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2CelerMainErrors::MinAmountGreaterThanMaxAmount(
                    decoded,
                ));
            }
            if let Ok(decoded) = <NotChanged as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainErrors::NotChanged(decoded));
            }
            if let Ok(decoded) =
                <OnlyOperator as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainErrors::OnlyOperator(decoded));
            }
            if let Ok(decoded) =
                <RandomSGreaterThanFieldSize as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainErrors::RandomSGreaterThanFieldSize(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2CelerMainErrors::RollupFeeToFew(decoded));
            }
            if let Ok(decoded) =
                <SanctionedAddress as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainErrors::SanctionedAddress(decoded));
            }
            if let Ok(decoded) =
                <SenderIsNotBridgeProxy as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainErrors::SenderIsNotBridgeProxy(decoded));
            }
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2CelerMainErrors {
        fn encode(self) -> Vec<u8> {
            match self {
                MystikoV2CelerMainErrors::AmountLessThanZero(element) => element.encode(),
                MystikoV2CelerMainErrors::AmountTooLarge(element) => element.encode(),
                MystikoV2CelerMainErrors::AmountTooSmall(element) => element.encode(),
                MystikoV2CelerMainErrors::BridgeFeeTooFew(element) => element.encode(),
                MystikoV2CelerMainErrors::CommitmentHashIncorrect(element) => element.encode(),
                MystikoV2CelerMainErrors::DepositsDisabled(element) => element.encode(),
                MystikoV2CelerMainErrors::ExecutorFeeTooFew(element) => element.encode(),
                MystikoV2CelerMainErrors::FromChainIdNotMatched(element) => element.encode(),
                MystikoV2CelerMainErrors::FromProxyAddressNotMatched(element) => element.encode(),
                MystikoV2CelerMainErrors::HashKGreaterThanFieldSize(element) => element.encode(),
                MystikoV2CelerMainErrors::Invalid(element) => element.encode(),
                MystikoV2CelerMainErrors::MaxAmountLessThanMinAmount(element) => element.encode(),
                MystikoV2CelerMainErrors::MinAmountGreaterThanMaxAmount(element) => {
                    element.encode()
                }
                MystikoV2CelerMainErrors::NotChanged(element) => element.encode(),
                MystikoV2CelerMainErrors::OnlyOperator(element) => element.encode(),
                MystikoV2CelerMainErrors::RandomSGreaterThanFieldSize(element) => element.encode(),
                MystikoV2CelerMainErrors::RollupFeeToFew(element) => element.encode(),
                MystikoV2CelerMainErrors::SanctionedAddress(element) => element.encode(),
                MystikoV2CelerMainErrors::SenderIsNotBridgeProxy(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for MystikoV2CelerMainErrors {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2CelerMainErrors::AmountLessThanZero(element) => element.fmt(f),
                MystikoV2CelerMainErrors::AmountTooLarge(element) => element.fmt(f),
                MystikoV2CelerMainErrors::AmountTooSmall(element) => element.fmt(f),
                MystikoV2CelerMainErrors::BridgeFeeTooFew(element) => element.fmt(f),
                MystikoV2CelerMainErrors::CommitmentHashIncorrect(element) => element.fmt(f),
                MystikoV2CelerMainErrors::DepositsDisabled(element) => element.fmt(f),
                MystikoV2CelerMainErrors::ExecutorFeeTooFew(element) => element.fmt(f),
                MystikoV2CelerMainErrors::FromChainIdNotMatched(element) => element.fmt(f),
                MystikoV2CelerMainErrors::FromProxyAddressNotMatched(element) => element.fmt(f),
                MystikoV2CelerMainErrors::HashKGreaterThanFieldSize(element) => element.fmt(f),
                MystikoV2CelerMainErrors::Invalid(element) => element.fmt(f),
                MystikoV2CelerMainErrors::MaxAmountLessThanMinAmount(element) => element.fmt(f),
                MystikoV2CelerMainErrors::MinAmountGreaterThanMaxAmount(element) => element.fmt(f),
                MystikoV2CelerMainErrors::NotChanged(element) => element.fmt(f),
                MystikoV2CelerMainErrors::OnlyOperator(element) => element.fmt(f),
                MystikoV2CelerMainErrors::RandomSGreaterThanFieldSize(element) => element.fmt(f),
                MystikoV2CelerMainErrors::RollupFeeToFew(element) => element.fmt(f),
                MystikoV2CelerMainErrors::SanctionedAddress(element) => element.fmt(f),
                MystikoV2CelerMainErrors::SenderIsNotBridgeProxy(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AmountLessThanZero> for MystikoV2CelerMainErrors {
        fn from(var: AmountLessThanZero) -> Self {
            MystikoV2CelerMainErrors::AmountLessThanZero(var)
        }
    }
    impl ::std::convert::From<AmountTooLarge> for MystikoV2CelerMainErrors {
        fn from(var: AmountTooLarge) -> Self {
            MystikoV2CelerMainErrors::AmountTooLarge(var)
        }
    }
    impl ::std::convert::From<AmountTooSmall> for MystikoV2CelerMainErrors {
        fn from(var: AmountTooSmall) -> Self {
            MystikoV2CelerMainErrors::AmountTooSmall(var)
        }
    }
    impl ::std::convert::From<BridgeFeeTooFew> for MystikoV2CelerMainErrors {
        fn from(var: BridgeFeeTooFew) -> Self {
            MystikoV2CelerMainErrors::BridgeFeeTooFew(var)
        }
    }
    impl ::std::convert::From<CommitmentHashIncorrect> for MystikoV2CelerMainErrors {
        fn from(var: CommitmentHashIncorrect) -> Self {
            MystikoV2CelerMainErrors::CommitmentHashIncorrect(var)
        }
    }
    impl ::std::convert::From<DepositsDisabled> for MystikoV2CelerMainErrors {
        fn from(var: DepositsDisabled) -> Self {
            MystikoV2CelerMainErrors::DepositsDisabled(var)
        }
    }
    impl ::std::convert::From<ExecutorFeeTooFew> for MystikoV2CelerMainErrors {
        fn from(var: ExecutorFeeTooFew) -> Self {
            MystikoV2CelerMainErrors::ExecutorFeeTooFew(var)
        }
    }
    impl ::std::convert::From<FromChainIdNotMatched> for MystikoV2CelerMainErrors {
        fn from(var: FromChainIdNotMatched) -> Self {
            MystikoV2CelerMainErrors::FromChainIdNotMatched(var)
        }
    }
    impl ::std::convert::From<FromProxyAddressNotMatched> for MystikoV2CelerMainErrors {
        fn from(var: FromProxyAddressNotMatched) -> Self {
            MystikoV2CelerMainErrors::FromProxyAddressNotMatched(var)
        }
    }
    impl ::std::convert::From<HashKGreaterThanFieldSize> for MystikoV2CelerMainErrors {
        fn from(var: HashKGreaterThanFieldSize) -> Self {
            MystikoV2CelerMainErrors::HashKGreaterThanFieldSize(var)
        }
    }
    impl ::std::convert::From<Invalid> for MystikoV2CelerMainErrors {
        fn from(var: Invalid) -> Self {
            MystikoV2CelerMainErrors::Invalid(var)
        }
    }
    impl ::std::convert::From<MaxAmountLessThanMinAmount> for MystikoV2CelerMainErrors {
        fn from(var: MaxAmountLessThanMinAmount) -> Self {
            MystikoV2CelerMainErrors::MaxAmountLessThanMinAmount(var)
        }
    }
    impl ::std::convert::From<MinAmountGreaterThanMaxAmount> for MystikoV2CelerMainErrors {
        fn from(var: MinAmountGreaterThanMaxAmount) -> Self {
            MystikoV2CelerMainErrors::MinAmountGreaterThanMaxAmount(var)
        }
    }
    impl ::std::convert::From<NotChanged> for MystikoV2CelerMainErrors {
        fn from(var: NotChanged) -> Self {
            MystikoV2CelerMainErrors::NotChanged(var)
        }
    }
    impl ::std::convert::From<OnlyOperator> for MystikoV2CelerMainErrors {
        fn from(var: OnlyOperator) -> Self {
            MystikoV2CelerMainErrors::OnlyOperator(var)
        }
    }
    impl ::std::convert::From<RandomSGreaterThanFieldSize> for MystikoV2CelerMainErrors {
        fn from(var: RandomSGreaterThanFieldSize) -> Self {
            MystikoV2CelerMainErrors::RandomSGreaterThanFieldSize(var)
        }
    }
    impl ::std::convert::From<RollupFeeToFew> for MystikoV2CelerMainErrors {
        fn from(var: RollupFeeToFew) -> Self {
            MystikoV2CelerMainErrors::RollupFeeToFew(var)
        }
    }
    impl ::std::convert::From<SanctionedAddress> for MystikoV2CelerMainErrors {
        fn from(var: SanctionedAddress) -> Self {
            MystikoV2CelerMainErrors::SanctionedAddress(var)
        }
    }
    impl ::std::convert::From<SenderIsNotBridgeProxy> for MystikoV2CelerMainErrors {
        fn from(var: SenderIsNotBridgeProxy) -> Self {
            MystikoV2CelerMainErrors::SenderIsNotBridgeProxy(var)
        }
    }
    #[derive(
        Clone,
    ...
    impl ethers::contract::EthLogDecode for MystikoV2CelerMainEvents {
        fn decode_log(
            ...
            Self: Sized,
        {
            if let Ok(decoded) = CommitmentCrossChainFilter::decode_log(log) {
                return Ok(MystikoV2CelerMainEvents::CommitmentCrossChainFilter(
                    decoded,
                ));
            }
            ...
            if let Ok(decoded) = MaxAmountFilter::decode_log(log) {
                return Ok(MystikoV2CelerMainEvents::MaxAmountFilter(decoded));
            }
            if let Ok(decoded) = MinAmountFilter::decode_log(log) {
                return Ok(MystikoV2CelerMainEvents::MinAmountFilter(decoded));
            }
    ...
    impl ::std::fmt::Display for MystikoV2CelerMainEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2CelerMainEvents::CommitmentCrossChainFilter(element) => element.fmt(f),
                MystikoV2CelerMainEvents::DepositsDisabledFilter(element) => element.fmt(f),
                MystikoV2CelerMainEvents::MaxAmountFilter(element) => element.fmt(f),
                MystikoV2CelerMainEvents::MinAmountFilter(element) => element.fmt(f),
                MystikoV2CelerMainEvents::MinBridgeFeeFilter(element) => element.fmt(f),
                MystikoV2CelerMainEvents::MinExecutorFeeFilter(element) => element.fmt(f),
                MystikoV2CelerMainEvents::OperatorChangedFilter(element) => element.fmt(f),
                MystikoV2CelerMainEvents::PeerMinExecutorFeeFilter(element) => element.fmt(f),
                MystikoV2CelerMainEvents::PeerMinRollupFeeFilter(element) => element.fmt(f),
                MystikoV2CelerMainEvents::SanctionsCheckFilter(element) => element.fmt(f),
                MystikoV2CelerMainEvents::SanctionsListFilter(element) => element.fmt(f),
            }
        }
    }
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2CelerMainCalls {
        fn decode(
            ...
            {
                return Ok(MystikoV2CelerMainCalls::AssetType(decoded));
            }
            if let Ok(decoded) =
                <BridgeProxyAddressCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainCalls::BridgeProxyAddress(decoded));
            }
            if let Ok(decoded) =
                <BridgeTypeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainCalls::BridgeType(decoded));
            }
            if let Ok(decoded) =
                <ChangeOperatorCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainCalls::ChangeOperator(decoded));
            }
            if let Ok(decoded) =
                <DepositCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainCalls::Deposit(decoded));
            }
            if let Ok(decoded) =
                <DisableSanctionsCheckCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainCalls::DisableSanctionsCheck(decoded));
            }
            if let Ok(decoded) =
                <EnableSanctionsCheckCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainCalls::EnableSanctionsCheck(decoded));
            }
            if let Ok(decoded) =
                <ExecuteMessageCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerMainCalls::ExecuteMessage(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2CelerMainCalls::GetAssociatedCommitmentPool(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2CelerMainCalls::SetAssociatedCommitmentPool(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2CelerMainCalls::UpdateSanctionsListAddress(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ethers::core::abi::AbiEncode for MystikoV2CelerMainCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                MystikoV2CelerMainCalls::AssetType(element) => element.encode(),
                MystikoV2CelerMainCalls::BridgeProxyAddress(element) => element.encode(),
                MystikoV2CelerMainCalls::BridgeType(element) => element.encode(),
                MystikoV2CelerMainCalls::ChangeOperator(element) => element.encode(),
                MystikoV2CelerMainCalls::Deposit(element) => element.encode(),
                MystikoV2CelerMainCalls::DisableSanctionsCheck(element) => element.encode(),
                MystikoV2CelerMainCalls::EnableSanctionsCheck(element) => element.encode(),
                MystikoV2CelerMainCalls::ExecuteMessage(element) => element.encode(),
                MystikoV2CelerMainCalls::GetAssociatedCommitmentPool(element) => element.encode(),
                MystikoV2CelerMainCalls::GetMaxAmount(element) => element.encode(),
                MystikoV2CelerMainCalls::GetMinAmount(element) => element.encode(),
                MystikoV2CelerMainCalls::GetMinBridgeFee(element) => element.encode(),
                MystikoV2CelerMainCalls::GetMinExecutorFee(element) => element.encode(),
                MystikoV2CelerMainCalls::GetPeerMinExecutorFee(element) => element.encode(),
                MystikoV2CelerMainCalls::GetPeerMinRollupFee(element) => element.encode(),
                MystikoV2CelerMainCalls::IsDepositsDisabled(element) => element.encode(),
                MystikoV2CelerMainCalls::PeerChainId(element) => element.encode(),
                MystikoV2CelerMainCalls::PeerChainName(element) => element.encode(),
                MystikoV2CelerMainCalls::PeerContract(element) => element.encode(),
                MystikoV2CelerMainCalls::SanctionsCheck(element) => element.encode(),
                MystikoV2CelerMainCalls::SanctionsList(element) => element.encode(),
                MystikoV2CelerMainCalls::SetAssociatedCommitmentPool(element) => element.encode(),
                MystikoV2CelerMainCalls::SetBridgeProxyAddress(element) => element.encode(),
                MystikoV2CelerMainCalls::SetDepositsDisabled(element) => element.encode(),
                MystikoV2CelerMainCalls::SetMaxAmount(element) => element.encode(),
                MystikoV2CelerMainCalls::SetMinAmount(element) => element.encode(),
                MystikoV2CelerMainCalls::SetMinBridgeFee(element) => element.encode(),
                MystikoV2CelerMainCalls::SetMinExecutorFee(element) => element.encode(),
                MystikoV2CelerMainCalls::SetPeerContract(element) => element.encode(),
                MystikoV2CelerMainCalls::SetPeerMinExecutorFee(element) => element.encode(),
                MystikoV2CelerMainCalls::SetPeerMinRollupFee(element) => element.encode(),
                MystikoV2CelerMainCalls::UpdateSanctionsListAddress(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for MystikoV2CelerMainCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2CelerMainCalls::AssetType(element) => element.fmt(f),
                MystikoV2CelerMainCalls::BridgeProxyAddress(element) => element.fmt(f),
                MystikoV2CelerMainCalls::BridgeType(element) => element.fmt(f),
                MystikoV2CelerMainCalls::ChangeOperator(element) => element.fmt(f),
                MystikoV2CelerMainCalls::Deposit(element) => element.fmt(f),
                MystikoV2CelerMainCalls::DisableSanctionsCheck(element) => element.fmt(f),
                MystikoV2CelerMainCalls::EnableSanctionsCheck(element) => element.fmt(f),
                MystikoV2CelerMainCalls::ExecuteMessage(element) => element.fmt(f),
                MystikoV2CelerMainCalls::GetAssociatedCommitmentPool(element) => element.fmt(f),
                MystikoV2CelerMainCalls::GetMaxAmount(element) => element.fmt(f),
                MystikoV2CelerMainCalls::GetMinAmount(element) => element.fmt(f),
                MystikoV2CelerMainCalls::GetMinBridgeFee(element) => element.fmt(f),
                MystikoV2CelerMainCalls::GetMinExecutorFee(element) => element.fmt(f),
                MystikoV2CelerMainCalls::GetPeerMinExecutorFee(element) => element.fmt(f),
                MystikoV2CelerMainCalls::GetPeerMinRollupFee(element) => element.fmt(f),
                MystikoV2CelerMainCalls::IsDepositsDisabled(element) => element.fmt(f),
                MystikoV2CelerMainCalls::PeerChainId(element) => element.fmt(f),
                MystikoV2CelerMainCalls::PeerChainName(element) => element.fmt(f),
                MystikoV2CelerMainCalls::PeerContract(element) => element.fmt(f),
                MystikoV2CelerMainCalls::SanctionsCheck(element) => element.fmt(f),
                MystikoV2CelerMainCalls::SanctionsList(element) => element.fmt(f),
                MystikoV2CelerMainCalls::SetAssociatedCommitmentPool(element) => element.fmt(f),
                MystikoV2CelerMainCalls::SetBridgeProxyAddress(element) => element.fmt(f),
                MystikoV2CelerMainCalls::SetDepositsDisabled(element) => element.fmt(f),
                MystikoV2CelerMainCalls::SetMaxAmount(element) => element.fmt(f),
                MystikoV2CelerMainCalls::SetMinAmount(element) => element.fmt(f),
                MystikoV2CelerMainCalls::SetMinBridgeFee(element) => element.fmt(f),
                MystikoV2CelerMainCalls::SetMinExecutorFee(element) => element.fmt(f),
                MystikoV2CelerMainCalls::SetPeerContract(element) => element.fmt(f),
                MystikoV2CelerMainCalls::SetPeerMinExecutorFee(element) => element.fmt(f),
                MystikoV2CelerMainCalls::SetPeerMinRollupFee(element) => element.fmt(f),
                MystikoV2CelerMainCalls::UpdateSanctionsListAddress(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AssetTypeCall> for MystikoV2CelerMainCalls {
        fn from(var: AssetTypeCall) -> Self {
            MystikoV2CelerMainCalls::AssetType(var)
        }
    }
    impl ::std::convert::From<BridgeProxyAddressCall> for MystikoV2CelerMainCalls {
        fn from(var: BridgeProxyAddressCall) -> Self {
            MystikoV2CelerMainCalls::BridgeProxyAddress(var)
        }
    }
    impl ::std::convert::From<BridgeTypeCall> for MystikoV2CelerMainCalls {
        fn from(var: BridgeTypeCall) -> Self {
            MystikoV2CelerMainCalls::BridgeType(var)
        }
    }
    impl ::std::convert::From<ChangeOperatorCall> for MystikoV2CelerMainCalls {
        fn from(var: ChangeOperatorCall) -> Self {
            MystikoV2CelerMainCalls::ChangeOperator(var)
        }
    }
    impl ::std::convert::From<DepositCall> for MystikoV2CelerMainCalls {
        fn from(var: DepositCall) -> Self {
            MystikoV2CelerMainCalls::Deposit(var)
        }
    }
    impl ::std::convert::From<DisableSanctionsCheckCall> for MystikoV2CelerMainCalls {
        fn from(var: DisableSanctionsCheckCall) -> Self {
            MystikoV2CelerMainCalls::DisableSanctionsCheck(var)
        }
    }
    impl ::std::convert::From<EnableSanctionsCheckCall> for MystikoV2CelerMainCalls {
        fn from(var: EnableSanctionsCheckCall) -> Self {
            MystikoV2CelerMainCalls::EnableSanctionsCheck(var)
        }
    }
    impl ::std::convert::From<ExecuteMessageCall> for MystikoV2CelerMainCalls {
        fn from(var: ExecuteMessageCall) -> Self {
            MystikoV2CelerMainCalls::ExecuteMessage(var)
        }
    }
    impl ::std::convert::From<GetAssociatedCommitmentPoolCall> for MystikoV2CelerMainCalls {
        fn from(var: GetAssociatedCommitmentPoolCall) -> Self {
            MystikoV2CelerMainCalls::GetAssociatedCommitmentPool(var)
        }
    }
    impl ::std::convert::From<GetMaxAmountCall> for MystikoV2CelerMainCalls {
        fn from(var: GetMaxAmountCall) -> Self {
            MystikoV2CelerMainCalls::GetMaxAmount(var)
        }
    }
    impl ::std::convert::From<GetMinAmountCall> for MystikoV2CelerMainCalls {
        fn from(var: GetMinAmountCall) -> Self {
            MystikoV2CelerMainCalls::GetMinAmount(var)
        }
    }
    impl ::std::convert::From<GetMinBridgeFeeCall> for MystikoV2CelerMainCalls {
        fn from(var: GetMinBridgeFeeCall) -> Self {
            MystikoV2CelerMainCalls::GetMinBridgeFee(var)
        }
    }
    impl ::std::convert::From<GetMinExecutorFeeCall> for MystikoV2CelerMainCalls {
        fn from(var: GetMinExecutorFeeCall) -> Self {
            MystikoV2CelerMainCalls::GetMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<GetPeerMinExecutorFeeCall> for MystikoV2CelerMainCalls {
        fn from(var: GetPeerMinExecutorFeeCall) -> Self {
            MystikoV2CelerMainCalls::GetPeerMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<GetPeerMinRollupFeeCall> for MystikoV2CelerMainCalls {
        fn from(var: GetPeerMinRollupFeeCall) -> Self {
            MystikoV2CelerMainCalls::GetPeerMinRollupFee(var)
        }
    }
    impl ::std::convert::From<IsDepositsDisabledCall> for MystikoV2CelerMainCalls {
        fn from(var: IsDepositsDisabledCall) -> Self {
            MystikoV2CelerMainCalls::IsDepositsDisabled(var)
        }
    }
    impl ::std::convert::From<PeerChainIdCall> for MystikoV2CelerMainCalls {
        fn from(var: PeerChainIdCall) -> Self {
            MystikoV2CelerMainCalls::PeerChainId(var)
        }
    }
    impl ::std::convert::From<PeerChainNameCall> for MystikoV2CelerMainCalls {
        fn from(var: PeerChainNameCall) -> Self {
            MystikoV2CelerMainCalls::PeerChainName(var)
        }
    }
    impl ::std::convert::From<PeerContractCall> for MystikoV2CelerMainCalls {
        fn from(var: PeerContractCall) -> Self {
            MystikoV2CelerMainCalls::PeerContract(var)
        }
    }
    impl ::std::convert::From<SanctionsCheckCall> for MystikoV2CelerMainCalls {
        fn from(var: SanctionsCheckCall) -> Self {
            MystikoV2CelerMainCalls::SanctionsCheck(var)
        }
    }
    impl ::std::convert::From<SanctionsListCall> for MystikoV2CelerMainCalls {
        fn from(var: SanctionsListCall) -> Self {
            MystikoV2CelerMainCalls::SanctionsList(var)
        }
    }
    impl ::std::convert::From<SetAssociatedCommitmentPoolCall> for MystikoV2CelerMainCalls {
        fn from(var: SetAssociatedCommitmentPoolCall) -> Self {
            MystikoV2CelerMainCalls::SetAssociatedCommitmentPool(var)
        }
    }
    impl ::std::convert::From<SetBridgeProxyAddressCall> for MystikoV2CelerMainCalls {
        fn from(var: SetBridgeProxyAddressCall) -> Self {
            MystikoV2CelerMainCalls::SetBridgeProxyAddress(var)
        }
    }
    impl ::std::convert::From<SetDepositsDisabledCall> for MystikoV2CelerMainCalls {
        fn from(var: SetDepositsDisabledCall) -> Self {
            MystikoV2CelerMainCalls::SetDepositsDisabled(var)
        }
    }
    impl ::std::convert::From<SetMaxAmountCall> for MystikoV2CelerMainCalls {
        fn from(var: SetMaxAmountCall) -> Self {
            MystikoV2CelerMainCalls::SetMaxAmount(var)
        }
    }
    impl ::std::convert::From<SetMinAmountCall> for MystikoV2CelerMainCalls {
        fn from(var: SetMinAmountCall) -> Self {
            MystikoV2CelerMainCalls::SetMinAmount(var)
        }
    }
    impl ::std::convert::From<SetMinBridgeFeeCall> for MystikoV2CelerMainCalls {
        fn from(var: SetMinBridgeFeeCall) -> Self {
            MystikoV2CelerMainCalls::SetMinBridgeFee(var)
        }
    }
    impl ::std::convert::From<SetMinExecutorFeeCall> for MystikoV2CelerMainCalls {
        fn from(var: SetMinExecutorFeeCall) -> Self {
            MystikoV2CelerMainCalls::SetMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<SetPeerContractCall> for MystikoV2CelerMainCalls {
        fn from(var: SetPeerContractCall) -> Self {
            MystikoV2CelerMainCalls::SetPeerContract(var)
        }
    }
    impl ::std::convert::From<SetPeerMinExecutorFeeCall> for MystikoV2CelerMainCalls {
        fn from(var: SetPeerMinExecutorFeeCall) -> Self {
            MystikoV2CelerMainCalls::SetPeerMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<SetPeerMinRollupFeeCall> for MystikoV2CelerMainCalls {
        fn from(var: SetPeerMinRollupFeeCall) -> Self {
            MystikoV2CelerMainCalls::SetPeerMinRollupFee(var)
        }
    }
    impl ::std::convert::From<UpdateSanctionsListAddressCall> for MystikoV2CelerMainCalls {
        fn from(var: UpdateSanctionsListAddressCall) -> Self {
            MystikoV2CelerMainCalls::UpdateSanctionsListAddress(var)
        }
    }
