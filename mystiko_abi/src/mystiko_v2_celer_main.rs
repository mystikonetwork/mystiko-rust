...
pub mod mystiko_v2_celer_main {
    ...
    impl ::std::fmt::Display for MystikoV2CelerMainEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                MystikoV2CelerMainEvents::DepositAmountLimitsFilter(element) => element.fmt(f),
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2CelerMainCalls {
        fn decode(
            ...
            {
                return Ok(MystikoV2CelerMainCalls::UpdateDepositAmountLimits(decoded));
            }
            if let Ok(decoded) =
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2CelerMainCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                MystikoV2CelerMainCalls::UpdateDepositAmountLimits(element) => element.encode(),
    ...
    impl ::std::fmt::Display for MystikoV2CelerMainCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                MystikoV2CelerMainCalls::UpdateDepositAmountLimits(element) => element.fmt(f),
    ...
    impl ::std::convert::From<UpdateDepositAmountLimitsCall> for MystikoV2CelerMainCalls {
        fn from(var: UpdateDepositAmountLimitsCall) -> Self {
            MystikoV2CelerMainCalls::UpdateDepositAmountLimits(var)
        }
    }
