...
pub mod mystiko_v2_layer_zero_erc20 {
    ...
    impl<M> Clone for MystikoV2LayerZeroERC20<M> {
        fn clone(&self) -> Self {
            MystikoV2LayerZeroERC20(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for MystikoV2LayerZeroERC20<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> std::fmt::Debug for MystikoV2LayerZeroERC20<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(MystikoV2LayerZeroERC20))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ethers::providers::Middleware> MystikoV2LayerZeroERC20<M> {
        ...
        pub fn events(
            &self,
        ) -> ethers::contract::builders::Event<M, MystikoV2LayerZeroERC20Events> {
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2LayerZeroERC20Errors {
        fn decode(
            ...
            {
                return Ok(MystikoV2LayerZeroERC20Errors::AmountLessThanZero(decoded));
            }
            if let Ok(decoded) =
                <AmountTooLarge as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Errors::AmountTooLarge(decoded));
            }
            if let Ok(decoded) =
                <AmountTooSmall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Errors::AmountTooSmall(decoded));
            }
            if let Ok(decoded) =
                <BridgeFeeTooFew as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Errors::BridgeFeeTooFew(decoded));
            }
            if let Ok(decoded) =
                <CallIsNotLzApp as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Errors::CallIsNotLzApp(decoded));
            }
            if let Ok(decoded) =
                <CommitmentHashIncorrect as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Errors::CommitmentHashIncorrect(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroERC20Errors::DepositsDisabled(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroERC20Errors::DestinationChainIsNotTrusted(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroERC20Errors::ExecutorFeeTooFew(decoded));
            }
            if let Ok(decoded) =
                <FromChainIdNotMatched as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Errors::FromChainIdNotMatched(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroERC20Errors::FromProxyAddressNotMatched(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroERC20Errors::HashKGreaterThanFieldSize(
                    decoded,
                ));
            }
            ...
            {
                return Ok(MystikoV2LayerZeroERC20Errors::MinAmountGreaterThanMaxAmount(decoded));
            }
            if let Ok(decoded) =
                <NoStoredMessage as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Errors::NoStoredMessage(decoded));
            }
            if let Ok(decoded) = <NotChanged as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Errors::NotChanged(decoded));
            }
            if let Ok(decoded) =
                <OnlyOperator as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Errors::OnlyOperator(decoded));
            }
            if let Ok(decoded) =
                <RandomSGreaterThanFieldSize as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Errors::RandomSGreaterThanFieldSize(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroERC20Errors::RollupFeeToFew(decoded));
            }
            if let Ok(decoded) =
                <SanctionedAddress as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Errors::SanctionedAddress(decoded));
            }
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2LayerZeroERC20Errors {
        fn encode(self) -> Vec<u8> {
            match self {
                MystikoV2LayerZeroERC20Errors::AmountLessThanZero(element) => element.encode(),
                MystikoV2LayerZeroERC20Errors::AmountTooLarge(element) => element.encode(),
                MystikoV2LayerZeroERC20Errors::AmountTooSmall(element) => element.encode(),
                MystikoV2LayerZeroERC20Errors::BridgeFeeTooFew(element) => element.encode(),
                MystikoV2LayerZeroERC20Errors::CallIsNotLzApp(element) => element.encode(),
                MystikoV2LayerZeroERC20Errors::CommitmentHashIncorrect(element) => element.encode(),
                MystikoV2LayerZeroERC20Errors::DepositsDisabled(element) => element.encode(),
                MystikoV2LayerZeroERC20Errors::DestinationChainIsNotTrusted(element) => {
                    element.encode()
                }
                MystikoV2LayerZeroERC20Errors::ExecutorFeeTooFew(element) => element.encode(),
                MystikoV2LayerZeroERC20Errors::FromChainIdNotMatched(element) => element.encode(),
                MystikoV2LayerZeroERC20Errors::FromProxyAddressNotMatched(element) => {
                    element.encode()
                }
                MystikoV2LayerZeroERC20Errors::HashKGreaterThanFieldSize(element) => {
                    element.encode()
                }
                ...
                MystikoV2LayerZeroERC20Errors::NoStoredMessage(element) => element.encode(),
                MystikoV2LayerZeroERC20Errors::NotChanged(element) => element.encode(),
                MystikoV2LayerZeroERC20Errors::OnlyOperator(element) => element.encode(),
                MystikoV2LayerZeroERC20Errors::RandomSGreaterThanFieldSize(element) => {
                    element.encode()
                }
                MystikoV2LayerZeroERC20Errors::RollupFeeToFew(element) => element.encode(),
                MystikoV2LayerZeroERC20Errors::SanctionedAddress(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for MystikoV2LayerZeroERC20Errors {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2LayerZeroERC20Errors::AmountLessThanZero(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Errors::AmountTooLarge(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Errors::AmountTooSmall(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Errors::BridgeFeeTooFew(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Errors::CallIsNotLzApp(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Errors::CommitmentHashIncorrect(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Errors::DepositsDisabled(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Errors::DestinationChainIsNotTrusted(element) => {
                    element.fmt(f)
                }
                MystikoV2LayerZeroERC20Errors::ExecutorFeeTooFew(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Errors::FromChainIdNotMatched(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Errors::FromProxyAddressNotMatched(element) => {
                    element.fmt(f)
                }
                ...
                MystikoV2LayerZeroERC20Errors::NoStoredMessage(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Errors::NotChanged(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Errors::OnlyOperator(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Errors::RandomSGreaterThanFieldSize(element) => {
                    element.fmt(f)
                }
                MystikoV2LayerZeroERC20Errors::RollupFeeToFew(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Errors::SanctionedAddress(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AmountLessThanZero> for MystikoV2LayerZeroERC20Errors {
        fn from(var: AmountLessThanZero) -> Self {
            MystikoV2LayerZeroERC20Errors::AmountLessThanZero(var)
        }
    }
    impl ::std::convert::From<AmountTooLarge> for MystikoV2LayerZeroERC20Errors {
        fn from(var: AmountTooLarge) -> Self {
            MystikoV2LayerZeroERC20Errors::AmountTooLarge(var)
        }
    }
    impl ::std::convert::From<AmountTooSmall> for MystikoV2LayerZeroERC20Errors {
        fn from(var: AmountTooSmall) -> Self {
            MystikoV2LayerZeroERC20Errors::AmountTooSmall(var)
        }
    }
    impl ::std::convert::From<BridgeFeeTooFew> for MystikoV2LayerZeroERC20Errors {
        fn from(var: BridgeFeeTooFew) -> Self {
            MystikoV2LayerZeroERC20Errors::BridgeFeeTooFew(var)
        }
    }
    impl ::std::convert::From<CallIsNotLzApp> for MystikoV2LayerZeroERC20Errors {
        fn from(var: CallIsNotLzApp) -> Self {
            MystikoV2LayerZeroERC20Errors::CallIsNotLzApp(var)
        }
    }
    impl ::std::convert::From<CommitmentHashIncorrect> for MystikoV2LayerZeroERC20Errors {
        fn from(var: CommitmentHashIncorrect) -> Self {
            MystikoV2LayerZeroERC20Errors::CommitmentHashIncorrect(var)
        }
    }
    impl ::std::convert::From<DepositsDisabled> for MystikoV2LayerZeroERC20Errors {
        fn from(var: DepositsDisabled) -> Self {
            MystikoV2LayerZeroERC20Errors::DepositsDisabled(var)
        }
    }
    impl ::std::convert::From<DestinationChainIsNotTrusted> for MystikoV2LayerZeroERC20Errors {
        fn from(var: DestinationChainIsNotTrusted) -> Self {
            MystikoV2LayerZeroERC20Errors::DestinationChainIsNotTrusted(var)
        }
    }
    impl ::std::convert::From<ExecutorFeeTooFew> for MystikoV2LayerZeroERC20Errors {
        fn from(var: ExecutorFeeTooFew) -> Self {
            MystikoV2LayerZeroERC20Errors::ExecutorFeeTooFew(var)
        }
    }
    impl ::std::convert::From<FromChainIdNotMatched> for MystikoV2LayerZeroERC20Errors {
        fn from(var: FromChainIdNotMatched) -> Self {
            MystikoV2LayerZeroERC20Errors::FromChainIdNotMatched(var)
        }
    }
    impl ::std::convert::From<FromProxyAddressNotMatched> for MystikoV2LayerZeroERC20Errors {
        fn from(var: FromProxyAddressNotMatched) -> Self {
            MystikoV2LayerZeroERC20Errors::FromProxyAddressNotMatched(var)
        }
    }
    impl ::std::convert::From<HashKGreaterThanFieldSize> for MystikoV2LayerZeroERC20Errors {
        fn from(var: HashKGreaterThanFieldSize) -> Self {
            MystikoV2LayerZeroERC20Errors::HashKGreaterThanFieldSize(var)
        }
    }
    impl ::std::convert::From<Invalid> for MystikoV2LayerZeroERC20Errors {
    ...
    impl ::std::convert::From<NoStoredMessage> for MystikoV2LayerZeroERC20Errors {
        fn from(var: NoStoredMessage) -> Self {
            MystikoV2LayerZeroERC20Errors::NoStoredMessage(var)
        }
    }
    impl ::std::convert::From<NotChanged> for MystikoV2LayerZeroERC20Errors {
        fn from(var: NotChanged) -> Self {
            MystikoV2LayerZeroERC20Errors::NotChanged(var)
        }
    }
    impl ::std::convert::From<OnlyOperator> for MystikoV2LayerZeroERC20Errors {
        fn from(var: OnlyOperator) -> Self {
            MystikoV2LayerZeroERC20Errors::OnlyOperator(var)
        }
    }
    impl ::std::convert::From<RandomSGreaterThanFieldSize> for MystikoV2LayerZeroERC20Errors {
        fn from(var: RandomSGreaterThanFieldSize) -> Self {
            MystikoV2LayerZeroERC20Errors::RandomSGreaterThanFieldSize(var)
        }
    }
    impl ::std::convert::From<RollupFeeToFew> for MystikoV2LayerZeroERC20Errors {
        fn from(var: RollupFeeToFew) -> Self {
            MystikoV2LayerZeroERC20Errors::RollupFeeToFew(var)
        }
    }
    impl ::std::convert::From<SanctionedAddress> for MystikoV2LayerZeroERC20Errors {
        fn from(var: SanctionedAddress) -> Self {
            MystikoV2LayerZeroERC20Errors::SanctionedAddress(var)
        }
    }
    #[derive(
        Clone,
    ...
    impl ethers::contract::EthLogDecode for MystikoV2LayerZeroERC20Events {
            ...
            Self: Sized,
        {
            if let Ok(decoded) = CommitmentCrossChainFilter::decode_log(log) {
                return Ok(MystikoV2LayerZeroERC20Events::CommitmentCrossChainFilter(
                    decoded,
                ));
            }
            ...
            if let Ok(decoded) = OperatorChangedFilter::decode_log(log) {
                return Ok(MystikoV2LayerZeroERC20Events::OperatorChangedFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(MystikoV2LayerZeroERC20Events::OwnershipTransferredFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = PeerMinExecutorFeeFilter::decode_log(log) {
                return Ok(MystikoV2LayerZeroERC20Events::PeerMinExecutorFeeFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = PeerMinRollupFeeFilter::decode_log(log) {
                return Ok(MystikoV2LayerZeroERC20Events::PeerMinRollupFeeFilter(
                    decoded,
                ));
            }
            ...
            if let Ok(decoded) = SetTrustedRemoteFilter::decode_log(log) {
                return Ok(MystikoV2LayerZeroERC20Events::SetTrustedRemoteFilter(
                    decoded,
                ));
            }
    ...
    impl ::std::fmt::Display for MystikoV2LayerZeroERC20Events {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                MystikoV2LayerZeroERC20Events::OwnershipTransferredFilter(element) => {
                    element.fmt(f)
                }
                MystikoV2LayerZeroERC20Events::PeerMinExecutorFeeFilter(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Events::PeerMinRollupFeeFilter(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Events::SanctionsCheckFilter(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Events::SanctionsListFilter(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Events::SetTrustedRemoteFilter(element) => element.fmt(f),
            }
        }
    }
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2LayerZeroERC20Calls {
        fn decode(
            ...
            {
                return Ok(MystikoV2LayerZeroERC20Calls::AssetDecimals(decoded));
            }
            if let Ok(decoded) =
                <AssetNameCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::AssetName(decoded));
            }
            if let Ok(decoded) =
                <AssetSymbolCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::AssetSymbol(decoded));
            }
            if let Ok(decoded) =
                <AssetTypeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::AssetType(decoded));
            }
            if let Ok(decoded) =
                <BridgeProxyAddressCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::BridgeProxyAddress(decoded));
            }
            if let Ok(decoded) =
                <BridgeTypeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::BridgeType(decoded));
            }
            if let Ok(decoded) =
                <ChangeOperatorCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::ChangeOperator(decoded));
            }
            if let Ok(decoded) =
                <DepositCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::Deposit(decoded));
            }
            if let Ok(decoded) =
                <DisableSanctionsCheckCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::DisableSanctionsCheck(decoded));
            }
            if let Ok(decoded) =
                <EnableSanctionsCheckCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::EnableSanctionsCheck(decoded));
            }
            if let Ok(decoded) =
                <FailedMessagesCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::FailedMessages(decoded));
            }
            if let Ok(decoded) =
                <ForceResumeReceiveCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::ForceResumeReceive(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroERC20Calls::GetAssociatedCommitmentPool(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroERC20Calls::GetConfig(decoded));
            }
            if let Ok(decoded) =
                <GetMaxAmountCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::GetMaxAmount(decoded));
            }
            if let Ok(decoded) =
                <GetMinAmountCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::GetMinAmount(decoded));
            }
            if let Ok(decoded) =
                <GetMinBridgeFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::GetMinBridgeFee(decoded));
            }
            if let Ok(decoded) =
                <GetMinExecutorFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::GetMinExecutorFee(decoded));
            }
            if let Ok(decoded) =
                <GetPeerMinExecutorFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::GetPeerMinExecutorFee(decoded));
            }
            if let Ok(decoded) =
                <GetPeerMinRollupFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::GetPeerMinRollupFee(decoded));
            }
            if let Ok(decoded) =
                <IsDepositsDisabledCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::IsDepositsDisabled(decoded));
            }
            if let Ok(decoded) =
                <IsTrustedRemoteCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::IsTrustedRemote(decoded));
            }
            if let Ok(decoded) =
                <LocalLayerZeroChainIdCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::LocalLayerZeroChainId(decoded));
            }
            if let Ok(decoded) =
                <LzEndpointCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::LzEndpoint(decoded));
            }
            if let Ok(decoded) =
                <LzReceiveCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::LzReceive(decoded));
            }
            if let Ok(decoded) =
                <NonblockingLzReceiveCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::NonblockingLzReceive(decoded));
            }
            if let Ok(decoded) = <OwnerCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::Owner(decoded));
            }
            if let Ok(decoded) =
                <PeerChainIdCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::PeerChainId(decoded));
            }
            if let Ok(decoded) =
                <PeerChainNameCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::PeerChainName(decoded));
            }
            if let Ok(decoded) =
                <PeerContractCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::PeerContract(decoded));
            }
            if let Ok(decoded) =
                <PeerLayerZeroChainIdCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::PeerLayerZeroChainId(decoded));
            }
            if let Ok(decoded) =
                <RenounceOwnershipCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::RenounceOwnership(decoded));
            }
            if let Ok(decoded) =
                <RetryMessageCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::RetryMessage(decoded));
            }
            if let Ok(decoded) =
                <SanctionsCheckCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::SanctionsCheck(decoded));
            }
            if let Ok(decoded) =
                <SanctionsListCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::SanctionsList(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroERC20Calls::SetAssociatedCommitmentPool(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroERC20Calls::SetBridgeProxyAddress(decoded));
            }
            if let Ok(decoded) =
                <SetConfigCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::SetConfig(decoded));
            }
            if let Ok(decoded) =
                <SetDepositsDisabledCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::SetDepositsDisabled(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroERC20Calls::SetMinExecutorFee(decoded));
            }
            if let Ok(decoded) =
                <SetPeerContractCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::SetPeerContract(decoded));
            }
            if let Ok(decoded) =
                <SetPeerMinExecutorFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::SetPeerMinExecutorFee(decoded));
            }
            if let Ok(decoded) =
                <SetPeerMinRollupFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::SetPeerMinRollupFee(decoded));
            }
            if let Ok(decoded) =
                <SetReceiveVersionCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::SetReceiveVersion(decoded));
            }
            if let Ok(decoded) =
                <SetSendVersionCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::SetSendVersion(decoded));
            }
            if let Ok(decoded) =
                <SetTrustedRemoteCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::SetTrustedRemote(decoded));
            }
            if let Ok(decoded) =
                <TransferOwnershipCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2LayerZeroERC20Calls::TransferOwnership(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2LayerZeroERC20Calls::UpdateSanctionsListAddress(
                    decoded,
                ));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2LayerZeroERC20Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                MystikoV2LayerZeroERC20Calls::AssetDecimals(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::AssetName(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::AssetSymbol(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::AssetType(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::BridgeProxyAddress(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::BridgeType(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::ChangeOperator(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::Deposit(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::DisableSanctionsCheck(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::EnableSanctionsCheck(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::FailedMessages(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::ForceResumeReceive(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::GetAssociatedCommitmentPool(element) => {
                    element.encode()
                }
                MystikoV2LayerZeroERC20Calls::GetConfig(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::GetMaxAmount(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::GetMinAmount(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::GetMinBridgeFee(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::GetMinExecutorFee(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::GetPeerMinExecutorFee(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::GetPeerMinRollupFee(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::IsDepositsDisabled(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::IsTrustedRemote(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::LocalLayerZeroChainId(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::LzEndpoint(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::LzReceive(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::NonblockingLzReceive(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::Owner(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::PeerChainId(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::PeerChainName(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::PeerContract(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::PeerLayerZeroChainId(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::RenounceOwnership(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::RetryMessage(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::SanctionsCheck(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::SanctionsList(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::SetAssociatedCommitmentPool(element) => {
                    element.encode()
                }
                MystikoV2LayerZeroERC20Calls::SetBridgeProxyAddress(element) => element.encode(),
                ...
                MystikoV2LayerZeroERC20Calls::SetPeerMinExecutorFee(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::SetPeerMinRollupFee(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::SetReceiveVersion(element) => element.encode(),
                MystikoV2LayerZeroERC20Calls::SetSendVersion(element) => element.encode(),
    ...
    impl ::std::fmt::Display for MystikoV2LayerZeroERC20Calls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2LayerZeroERC20Calls::AssetDecimals(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::AssetName(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::AssetSymbol(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::AssetType(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::BridgeProxyAddress(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::BridgeType(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::ChangeOperator(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::Deposit(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::DisableSanctionsCheck(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::EnableSanctionsCheck(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::FailedMessages(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::ForceResumeReceive(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::GetAssociatedCommitmentPool(element) => {
                    element.fmt(f)
                }
                MystikoV2LayerZeroERC20Calls::GetConfig(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::GetMaxAmount(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::GetMinAmount(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::GetMinBridgeFee(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::GetMinExecutorFee(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::GetPeerMinExecutorFee(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::GetPeerMinRollupFee(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::IsDepositsDisabled(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::IsTrustedRemote(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::LocalLayerZeroChainId(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::LzEndpoint(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::LzReceive(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::NonblockingLzReceive(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::Owner(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::PeerChainId(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::PeerChainName(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::PeerContract(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::PeerLayerZeroChainId(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::RenounceOwnership(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::RetryMessage(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::SanctionsCheck(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::SanctionsList(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::SetAssociatedCommitmentPool(element) => {
                    element.fmt(f)
                }
                MystikoV2LayerZeroERC20Calls::SetBridgeProxyAddress(element) => element.fmt(f),
                ...
                MystikoV2LayerZeroERC20Calls::SetPeerMinExecutorFee(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::SetPeerMinRollupFee(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::SetReceiveVersion(element) => element.fmt(f),
                MystikoV2LayerZeroERC20Calls::SetSendVersion(element) => element.fmt(f),
    ...
    impl ::std::convert::From<AssetDecimalsCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: AssetDecimalsCall) -> Self {
            MystikoV2LayerZeroERC20Calls::AssetDecimals(var)
        }
    }
    impl ::std::convert::From<AssetNameCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: AssetNameCall) -> Self {
            MystikoV2LayerZeroERC20Calls::AssetName(var)
        }
    }
    impl ::std::convert::From<AssetSymbolCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: AssetSymbolCall) -> Self {
            MystikoV2LayerZeroERC20Calls::AssetSymbol(var)
        }
    }
    impl ::std::convert::From<AssetTypeCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: AssetTypeCall) -> Self {
            MystikoV2LayerZeroERC20Calls::AssetType(var)
        }
    }
    impl ::std::convert::From<BridgeProxyAddressCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: BridgeProxyAddressCall) -> Self {
            MystikoV2LayerZeroERC20Calls::BridgeProxyAddress(var)
        }
    }
    impl ::std::convert::From<BridgeTypeCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: BridgeTypeCall) -> Self {
            MystikoV2LayerZeroERC20Calls::BridgeType(var)
        }
    }
    impl ::std::convert::From<ChangeOperatorCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: ChangeOperatorCall) -> Self {
            MystikoV2LayerZeroERC20Calls::ChangeOperator(var)
        }
    }
    impl ::std::convert::From<DepositCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: DepositCall) -> Self {
            MystikoV2LayerZeroERC20Calls::Deposit(var)
        }
    }
    impl ::std::convert::From<DisableSanctionsCheckCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: DisableSanctionsCheckCall) -> Self {
            MystikoV2LayerZeroERC20Calls::DisableSanctionsCheck(var)
        }
    }
    impl ::std::convert::From<EnableSanctionsCheckCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: EnableSanctionsCheckCall) -> Self {
            MystikoV2LayerZeroERC20Calls::EnableSanctionsCheck(var)
        }
    }
    impl ::std::convert::From<FailedMessagesCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: FailedMessagesCall) -> Self {
            MystikoV2LayerZeroERC20Calls::FailedMessages(var)
        }
    }
    impl ::std::convert::From<ForceResumeReceiveCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: ForceResumeReceiveCall) -> Self {
            MystikoV2LayerZeroERC20Calls::ForceResumeReceive(var)
        }
    }
    impl ::std::convert::From<GetAssociatedCommitmentPoolCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: GetAssociatedCommitmentPoolCall) -> Self {
            MystikoV2LayerZeroERC20Calls::GetAssociatedCommitmentPool(var)
        }
    }
    impl ::std::convert::From<GetConfigCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: GetConfigCall) -> Self {
            MystikoV2LayerZeroERC20Calls::GetConfig(var)
        }
    }
    impl ::std::convert::From<GetMaxAmountCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: GetMaxAmountCall) -> Self {
            MystikoV2LayerZeroERC20Calls::GetMaxAmount(var)
        }
    }
    impl ::std::convert::From<GetMinAmountCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: GetMinAmountCall) -> Self {
            MystikoV2LayerZeroERC20Calls::GetMinAmount(var)
        }
    }
    impl ::std::convert::From<GetMinBridgeFeeCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: GetMinBridgeFeeCall) -> Self {
            MystikoV2LayerZeroERC20Calls::GetMinBridgeFee(var)
        }
    }
    impl ::std::convert::From<GetMinExecutorFeeCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: GetMinExecutorFeeCall) -> Self {
            MystikoV2LayerZeroERC20Calls::GetMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<GetPeerMinExecutorFeeCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: GetPeerMinExecutorFeeCall) -> Self {
            MystikoV2LayerZeroERC20Calls::GetPeerMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<GetPeerMinRollupFeeCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: GetPeerMinRollupFeeCall) -> Self {
            MystikoV2LayerZeroERC20Calls::GetPeerMinRollupFee(var)
        }
    }
    impl ::std::convert::From<IsDepositsDisabledCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: IsDepositsDisabledCall) -> Self {
            MystikoV2LayerZeroERC20Calls::IsDepositsDisabled(var)
        }
    }
    impl ::std::convert::From<IsTrustedRemoteCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: IsTrustedRemoteCall) -> Self {
            MystikoV2LayerZeroERC20Calls::IsTrustedRemote(var)
        }
    }
    impl ::std::convert::From<LocalLayerZeroChainIdCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: LocalLayerZeroChainIdCall) -> Self {
            MystikoV2LayerZeroERC20Calls::LocalLayerZeroChainId(var)
        }
    }
    impl ::std::convert::From<LzEndpointCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: LzEndpointCall) -> Self {
            MystikoV2LayerZeroERC20Calls::LzEndpoint(var)
        }
    }
    impl ::std::convert::From<LzReceiveCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: LzReceiveCall) -> Self {
            MystikoV2LayerZeroERC20Calls::LzReceive(var)
        }
    }
    impl ::std::convert::From<NonblockingLzReceiveCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: NonblockingLzReceiveCall) -> Self {
            MystikoV2LayerZeroERC20Calls::NonblockingLzReceive(var)
        }
    }
    impl ::std::convert::From<OwnerCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: OwnerCall) -> Self {
            MystikoV2LayerZeroERC20Calls::Owner(var)
        }
    }
    impl ::std::convert::From<PeerChainIdCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: PeerChainIdCall) -> Self {
            MystikoV2LayerZeroERC20Calls::PeerChainId(var)
        }
    }
    impl ::std::convert::From<PeerChainNameCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: PeerChainNameCall) -> Self {
            MystikoV2LayerZeroERC20Calls::PeerChainName(var)
        }
    }
    impl ::std::convert::From<PeerContractCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: PeerContractCall) -> Self {
            MystikoV2LayerZeroERC20Calls::PeerContract(var)
        }
    }
    impl ::std::convert::From<PeerLayerZeroChainIdCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: PeerLayerZeroChainIdCall) -> Self {
            MystikoV2LayerZeroERC20Calls::PeerLayerZeroChainId(var)
        }
    }
    impl ::std::convert::From<RenounceOwnershipCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: RenounceOwnershipCall) -> Self {
            MystikoV2LayerZeroERC20Calls::RenounceOwnership(var)
        }
    }
    impl ::std::convert::From<RetryMessageCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: RetryMessageCall) -> Self {
            MystikoV2LayerZeroERC20Calls::RetryMessage(var)
        }
    }
    impl ::std::convert::From<SanctionsCheckCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: SanctionsCheckCall) -> Self {
            MystikoV2LayerZeroERC20Calls::SanctionsCheck(var)
        }
    }
    impl ::std::convert::From<SanctionsListCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: SanctionsListCall) -> Self {
            MystikoV2LayerZeroERC20Calls::SanctionsList(var)
        }
    }
    impl ::std::convert::From<SetAssociatedCommitmentPoolCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: SetAssociatedCommitmentPoolCall) -> Self {
            MystikoV2LayerZeroERC20Calls::SetAssociatedCommitmentPool(var)
        }
    }
    impl ::std::convert::From<SetBridgeProxyAddressCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: SetBridgeProxyAddressCall) -> Self {
            MystikoV2LayerZeroERC20Calls::SetBridgeProxyAddress(var)
        }
    }
    impl ::std::convert::From<SetConfigCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: SetConfigCall) -> Self {
            MystikoV2LayerZeroERC20Calls::SetConfig(var)
        }
    }
    impl ::std::convert::From<SetDepositsDisabledCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: SetDepositsDisabledCall) -> Self {
            MystikoV2LayerZeroERC20Calls::SetDepositsDisabled(var)
        }
    }
    impl ::std::convert::From<SetEndpointCall> for MystikoV2LayerZeroERC20Calls {
    ...
    impl ::std::convert::From<SetMinExecutorFeeCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: SetMinExecutorFeeCall) -> Self {
            MystikoV2LayerZeroERC20Calls::SetMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<SetPeerContractCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: SetPeerContractCall) -> Self {
            MystikoV2LayerZeroERC20Calls::SetPeerContract(var)
        }
    }
    impl ::std::convert::From<SetPeerMinExecutorFeeCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: SetPeerMinExecutorFeeCall) -> Self {
            MystikoV2LayerZeroERC20Calls::SetPeerMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<SetPeerMinRollupFeeCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: SetPeerMinRollupFeeCall) -> Self {
            MystikoV2LayerZeroERC20Calls::SetPeerMinRollupFee(var)
        }
    }
    impl ::std::convert::From<SetReceiveVersionCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: SetReceiveVersionCall) -> Self {
            MystikoV2LayerZeroERC20Calls::SetReceiveVersion(var)
        }
    }
    impl ::std::convert::From<SetSendVersionCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: SetSendVersionCall) -> Self {
            MystikoV2LayerZeroERC20Calls::SetSendVersion(var)
        }
    }
    impl ::std::convert::From<SetTrustedRemoteCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: SetTrustedRemoteCall) -> Self {
            MystikoV2LayerZeroERC20Calls::SetTrustedRemote(var)
        }
    }
    impl ::std::convert::From<TransferOwnershipCall> for MystikoV2LayerZeroERC20Calls {
        fn from(var: TransferOwnershipCall) -> Self {
            MystikoV2LayerZeroERC20Calls::TransferOwnership(var)
        }
    }
    impl ::std::convert::From<TrustedRemoteLookupCall> for MystikoV2LayerZeroERC20Calls {
