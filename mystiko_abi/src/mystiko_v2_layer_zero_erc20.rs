...
pub mod mystiko_v2_layer_zero_erc20 {
    ...
    impl ::ethers_contract::EthLogDecode for MystikoV2LayerZeroERC20Events {
        fn decode_log(
            ...
            if let Ok(decoded) = DepositAmountLimitsFilter::decode_log(log) {
                return Ok(
                    MystikoV2LayerZeroERC20Events::DepositAmountLimitsFilter(decoded),
                );
            }
            if let Ok(decoded) = DepositsDisabledFilter::decode_log(log) {
                return Ok(
                    MystikoV2LayerZeroERC20Events::DepositsDisabledFilter(decoded),
                );
            }
            ...
            if let Ok(decoded) = PeerMinExecutorFeeFilter::decode_log(log) {
                return Ok(
                    MystikoV2LayerZeroERC20Events::PeerMinExecutorFeeFilter(decoded),
                );
            }
            if let Ok(decoded) = PeerMinRollupFeeFilter::decode_log(log) {
                return Ok(
                    MystikoV2LayerZeroERC20Events::PeerMinRollupFeeFilter(decoded),
                );
            }
    ...
    impl ::core::convert::From<DepositsDisabledFilter>
    for MystikoV2LayerZeroERC20Events {
    ...
    impl ::core::convert::From<PeerMinRollupFeeFilter>
    for MystikoV2LayerZeroERC20Events {
    ...
    impl ::core::convert::From<SetDepositsDisabledCall>
    for MystikoV2LayerZeroERC20Calls {
    ...
    impl ::core::convert::From<SetPeerMinRollupFeeCall>
    for MystikoV2LayerZeroERC20Calls {
