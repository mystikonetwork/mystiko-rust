...
pub mod ierc20_metadata {
    ...
    pub static IERC20METADATA_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct IERC20Metadata<M>(::ethers_contract::Contract<M>);
    ...
    impl<M> ::core::fmt::Debug for IERC20Metadata<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(IERC20Metadata)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers_providers::Middleware> IERC20Metadata<M> {
    ...
    impl ::ethers_contract::EthLogDecode for IERC20MetadataEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for IERC20MetadataCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for IERC20MetadataCalls {
