...
pub mod erc20_asset_pool {
    ...
    pub static ERC20ASSETPOOL_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(__abi);
    pub struct ERC20AssetPool<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> ERC20AssetPool<M> {
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for ERC20AssetPool<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for ERC20AssetPoolCalls {
    ...
    impl ::ethers::core::abi::AbiEncode for ERC20AssetPoolCalls {
