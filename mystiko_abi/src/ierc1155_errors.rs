...
pub mod ierc1155_errors {
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for IERC1155Errors<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for IERC1155ErrorsErrors {
        fn decode(data: impl AsRef<[u8]>) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            ...
            if let Ok(decoded) = <ERC1155InsufficientBalance as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ERC1155InsufficientBalance(decoded));
            }
            if let Ok(decoded) = <ERC1155InvalidApprover as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ERC1155InvalidApprover(decoded));
            }
            if let Ok(decoded) = <ERC1155InvalidArrayLength as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ERC1155InvalidArrayLength(decoded));
            }
            if let Ok(decoded) = <ERC1155InvalidOperator as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ERC1155InvalidOperator(decoded));
            }
            if let Ok(decoded) = <ERC1155InvalidReceiver as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ERC1155InvalidReceiver(decoded));
            }
            if let Ok(decoded) = <ERC1155InvalidSender as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ERC1155InvalidSender(decoded));
            }
            if let Ok(decoded) = <ERC1155MissingApprovalForAll as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for IERC1155ErrorsErrors {
        fn encode(self) -> ::std::vec::Vec<u8> {
            match self {
                Self::ERC1155InsufficientBalance(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ERC1155InvalidApprover(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ERC1155InvalidArrayLength(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ERC1155InvalidOperator(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ERC1155InvalidReceiver(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ERC1155InvalidSender(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ERC1155MissingApprovalForAll(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    impl ::ethers::contract::ContractRevert for IERC1155ErrorsErrors {
        fn valid_selector(selector: [u8; 4]) -> bool {
            match selector {
                ...
                _ if selector == <ERC1155InsufficientBalance as ::ethers::contract::EthError>::selector() => true,
                _ if selector == <ERC1155InvalidApprover as ::ethers::contract::EthError>::selector() => true,
                _ if selector == <ERC1155InvalidArrayLength as ::ethers::contract::EthError>::selector() => true,
                _ if selector == <ERC1155InvalidOperator as ::ethers::contract::EthError>::selector() => true,
                _ if selector == <ERC1155InvalidReceiver as ::ethers::contract::EthError>::selector() => true,
                _ if selector == <ERC1155InvalidSender as ::ethers::contract::EthError>::selector() => true,
                _ if selector == <ERC1155MissingApprovalForAll as ::ethers::contract::EthError>::selector() => true,
                _ => false,
            }
        }
    }
    impl ::core::fmt::Display for IERC1155ErrorsErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::ERC1155MissingApprovalForAll(element) => ::core::fmt::Display::fmt(element, f),
