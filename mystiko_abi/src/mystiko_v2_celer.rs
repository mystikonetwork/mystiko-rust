...
pub mod mystiko_v2_celer {
    ...
    impl ethers::contract::EthLogDecode for MystikoV2CelerEvents {
            ...
            Self: Sized,
        {
            ...
            if let Ok(decoded) = DepositAmountLimitsFilter::decode_log(log) {
                return Ok(MystikoV2CelerEvents::DepositAmountLimitsFilter(decoded));
            }
    ...
    impl ::std::fmt::Display for MystikoV2CelerEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                MystikoV2CelerEvents::DepositAmountLimitsFilter(element) => element.fmt(f),
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2CelerCalls {
        fn decode(
            ...
            {
                return Ok(MystikoV2CelerCalls::UpdateDepositAmountLimits(decoded));
            }
            if let Ok(decoded) =
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2CelerCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                MystikoV2CelerCalls::UpdateDepositAmountLimits(element) => element.encode(),
    ...
    impl ::std::fmt::Display for MystikoV2CelerCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                MystikoV2CelerCalls::UpdateDepositAmountLimits(element) => element.fmt(f),
    ...
    impl ::std::convert::From<UpdateDepositAmountLimitsCall> for MystikoV2CelerCalls {
        fn from(var: UpdateDepositAmountLimitsCall) -> Self {
            MystikoV2CelerCalls::UpdateDepositAmountLimits(var)
        }
    }
