...
pub mod mystiko_v2_celer {
    ...
    #[doc = "MystikoV2Celer was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    ...
    pub static MYSTIKOV2CELER_ABI: ethers::contract::Lazy<ethers::core::abi::Abi> =
        ethers::contract::Lazy::new(|| {
            ethers::core::utils::__serde_json::from_str(__ABI).expect("invalid abi")
        });
    pub struct MystikoV2Celer<M>(ethers::contract::Contract<M>);
    impl<M> Clone for MystikoV2Celer<M> {
        fn clone(&self) -> Self {
            MystikoV2Celer(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for MystikoV2Celer<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> std::fmt::Debug for MystikoV2Celer<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(MystikoV2Celer))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ethers::providers::Middleware> MystikoV2Celer<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), MYSTIKOV2CELER_ABI.clone(), client)
                .into()
        }
        ...
        pub fn events(&self) -> ethers::contract::builders::Event<M, MystikoV2CelerEvents> {
            self.0.event_with_filter(Default::default())
        }
    }
    impl<M: ethers::providers::Middleware> From<ethers::contract::Contract<M>> for MystikoV2Celer<M> {
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2CelerErrors {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            {
                return Ok(MystikoV2CelerErrors::MinAmountGreaterThanMaxAmount(decoded));
            }
            if let Ok(decoded) = <NotChanged as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerErrors::NotChanged(decoded));
            }
            if let Ok(decoded) =
                <OnlyOperator as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerErrors::OnlyOperator(decoded));
            }
            if let Ok(decoded) =
                <RandomSGreaterThanFieldSize as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerErrors::RandomSGreaterThanFieldSize(decoded));
            }
            if let Ok(decoded) =
                <RollupFeeToFew as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerErrors::RollupFeeToFew(decoded));
            }
            if let Ok(decoded) =
                <SanctionedAddress as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerErrors::SanctionedAddress(decoded));
            }
            if let Ok(decoded) =
                <SenderIsNotBridgeProxy as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2CelerErrors::SenderIsNotBridgeProxy(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ethers::core::abi::AbiEncode for MystikoV2CelerErrors {
        fn encode(self) -> Vec<u8> {
            match self {
                MystikoV2CelerErrors::AmountLessThanZero(element) => element.encode(),
                MystikoV2CelerErrors::AmountTooLarge(element) => element.encode(),
                MystikoV2CelerErrors::AmountTooSmall(element) => element.encode(),
                MystikoV2CelerErrors::BridgeFeeTooFew(element) => element.encode(),
                MystikoV2CelerErrors::CommitmentHashIncorrect(element) => element.encode(),
                MystikoV2CelerErrors::DepositsDisabled(element) => element.encode(),
                MystikoV2CelerErrors::ExecutorFeeTooFew(element) => element.encode(),
                MystikoV2CelerErrors::FromChainIdNotMatched(element) => element.encode(),
                MystikoV2CelerErrors::FromProxyAddressNotMatched(element) => element.encode(),
                MystikoV2CelerErrors::HashKGreaterThanFieldSize(element) => element.encode(),
                MystikoV2CelerErrors::Invalid(element) => element.encode(),
                MystikoV2CelerErrors::MaxAmountLessThanMinAmount(element) => element.encode(),
                MystikoV2CelerErrors::MinAmountGreaterThanMaxAmount(element) => element.encode(),
                MystikoV2CelerErrors::NotChanged(element) => element.encode(),
                MystikoV2CelerErrors::OnlyOperator(element) => element.encode(),
                MystikoV2CelerErrors::RandomSGreaterThanFieldSize(element) => element.encode(),
                MystikoV2CelerErrors::RollupFeeToFew(element) => element.encode(),
                MystikoV2CelerErrors::SanctionedAddress(element) => element.encode(),
                MystikoV2CelerErrors::SenderIsNotBridgeProxy(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for MystikoV2CelerErrors {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2CelerErrors::AmountLessThanZero(element) => element.fmt(f),
                MystikoV2CelerErrors::AmountTooLarge(element) => element.fmt(f),
                MystikoV2CelerErrors::AmountTooSmall(element) => element.fmt(f),
                MystikoV2CelerErrors::BridgeFeeTooFew(element) => element.fmt(f),
                MystikoV2CelerErrors::CommitmentHashIncorrect(element) => element.fmt(f),
                MystikoV2CelerErrors::DepositsDisabled(element) => element.fmt(f),
                MystikoV2CelerErrors::ExecutorFeeTooFew(element) => element.fmt(f),
                MystikoV2CelerErrors::FromChainIdNotMatched(element) => element.fmt(f),
                MystikoV2CelerErrors::FromProxyAddressNotMatched(element) => element.fmt(f),
                MystikoV2CelerErrors::HashKGreaterThanFieldSize(element) => element.fmt(f),
                MystikoV2CelerErrors::Invalid(element) => element.fmt(f),
                MystikoV2CelerErrors::MaxAmountLessThanMinAmount(element) => element.fmt(f),
                MystikoV2CelerErrors::MinAmountGreaterThanMaxAmount(element) => element.fmt(f),
                MystikoV2CelerErrors::NotChanged(element) => element.fmt(f),
                MystikoV2CelerErrors::OnlyOperator(element) => element.fmt(f),
                MystikoV2CelerErrors::RandomSGreaterThanFieldSize(element) => element.fmt(f),
                MystikoV2CelerErrors::RollupFeeToFew(element) => element.fmt(f),
                MystikoV2CelerErrors::SanctionedAddress(element) => element.fmt(f),
                MystikoV2CelerErrors::SenderIsNotBridgeProxy(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AmountLessThanZero> for MystikoV2CelerErrors {
        fn from(var: AmountLessThanZero) -> Self {
            MystikoV2CelerErrors::AmountLessThanZero(var)
        }
    }
    impl ::std::convert::From<AmountTooLarge> for MystikoV2CelerErrors {
        fn from(var: AmountTooLarge) -> Self {
            MystikoV2CelerErrors::AmountTooLarge(var)
        }
    }
    impl ::std::convert::From<AmountTooSmall> for MystikoV2CelerErrors {
        fn from(var: AmountTooSmall) -> Self {
            MystikoV2CelerErrors::AmountTooSmall(var)
        }
    }
    impl ::std::convert::From<BridgeFeeTooFew> for MystikoV2CelerErrors {
        fn from(var: BridgeFeeTooFew) -> Self {
            MystikoV2CelerErrors::BridgeFeeTooFew(var)
        }
    }
    impl ::std::convert::From<CommitmentHashIncorrect> for MystikoV2CelerErrors {
        fn from(var: CommitmentHashIncorrect) -> Self {
            MystikoV2CelerErrors::CommitmentHashIncorrect(var)
        }
    }
    impl ::std::convert::From<DepositsDisabled> for MystikoV2CelerErrors {
        fn from(var: DepositsDisabled) -> Self {
            MystikoV2CelerErrors::DepositsDisabled(var)
        }
    }
    impl ::std::convert::From<ExecutorFeeTooFew> for MystikoV2CelerErrors {
        fn from(var: ExecutorFeeTooFew) -> Self {
            MystikoV2CelerErrors::ExecutorFeeTooFew(var)
        }
    }
    impl ::std::convert::From<FromChainIdNotMatched> for MystikoV2CelerErrors {
        fn from(var: FromChainIdNotMatched) -> Self {
            MystikoV2CelerErrors::FromChainIdNotMatched(var)
        }
    }
    impl ::std::convert::From<FromProxyAddressNotMatched> for MystikoV2CelerErrors {
        fn from(var: FromProxyAddressNotMatched) -> Self {
            MystikoV2CelerErrors::FromProxyAddressNotMatched(var)
        }
    }
    impl ::std::convert::From<HashKGreaterThanFieldSize> for MystikoV2CelerErrors {
        fn from(var: HashKGreaterThanFieldSize) -> Self {
            MystikoV2CelerErrors::HashKGreaterThanFieldSize(var)
        }
    }
    impl ::std::convert::From<Invalid> for MystikoV2CelerErrors {
        fn from(var: Invalid) -> Self {
            MystikoV2CelerErrors::Invalid(var)
        }
    }
    impl ::std::convert::From<MaxAmountLessThanMinAmount> for MystikoV2CelerErrors {
        fn from(var: MaxAmountLessThanMinAmount) -> Self {
            MystikoV2CelerErrors::MaxAmountLessThanMinAmount(var)
        }
    }
    impl ::std::convert::From<MinAmountGreaterThanMaxAmount> for MystikoV2CelerErrors {
        fn from(var: MinAmountGreaterThanMaxAmount) -> Self {
            MystikoV2CelerErrors::MinAmountGreaterThanMaxAmount(var)
        }
    }
    impl ::std::convert::From<NotChanged> for MystikoV2CelerErrors {
        fn from(var: NotChanged) -> Self {
            MystikoV2CelerErrors::NotChanged(var)
        }
    }
    impl ::std::convert::From<OnlyOperator> for MystikoV2CelerErrors {
        fn from(var: OnlyOperator) -> Self {
            MystikoV2CelerErrors::OnlyOperator(var)
        }
    }
    impl ::std::convert::From<RandomSGreaterThanFieldSize> for MystikoV2CelerErrors {
        fn from(var: RandomSGreaterThanFieldSize) -> Self {
            MystikoV2CelerErrors::RandomSGreaterThanFieldSize(var)
        }
    }
    impl ::std::convert::From<RollupFeeToFew> for MystikoV2CelerErrors {
        fn from(var: RollupFeeToFew) -> Self {
            MystikoV2CelerErrors::RollupFeeToFew(var)
        }
    }
    impl ::std::convert::From<SanctionedAddress> for MystikoV2CelerErrors {
        fn from(var: SanctionedAddress) -> Self {
            MystikoV2CelerErrors::SanctionedAddress(var)
        }
    }
    impl ::std::convert::From<SenderIsNotBridgeProxy> for MystikoV2CelerErrors {
        fn from(var: SenderIsNotBridgeProxy) -> Self {
            MystikoV2CelerErrors::SenderIsNotBridgeProxy(var)
        }
    }
    #[derive(
        Clone,
    ...
    impl ethers::contract::EthLogDecode for MystikoV2CelerEvents {
        fn decode_log(
            ...
            Self: Sized,
        {
            ...
            if let Ok(decoded) = DepositsDisabledFilter::decode_log(log) {
                return Ok(MystikoV2CelerEvents::DepositsDisabledFilter(decoded));
            }
            if let Ok(decoded) = MaxAmountFilter::decode_log(log) {
                return Ok(MystikoV2CelerEvents::MaxAmountFilter(decoded));
            }
            if let Ok(decoded) = MinAmountFilter::decode_log(log) {
                return Ok(MystikoV2CelerEvents::MinAmountFilter(decoded));
            }
            if let Ok(decoded) = MinBridgeFeeFilter::decode_log(log) {
                return Ok(MystikoV2CelerEvents::MinBridgeFeeFilter(decoded));
            }
            if let Ok(decoded) = MinExecutorFeeFilter::decode_log(log) {
                return Ok(MystikoV2CelerEvents::MinExecutorFeeFilter(decoded));
            }
            if let Ok(decoded) = OperatorChangedFilter::decode_log(log) {
                return Ok(MystikoV2CelerEvents::OperatorChangedFilter(decoded));
            }
            if let Ok(decoded) = PeerMinExecutorFeeFilter::decode_log(log) {
                return Ok(MystikoV2CelerEvents::PeerMinExecutorFeeFilter(decoded));
            }
            if let Ok(decoded) = PeerMinRollupFeeFilter::decode_log(log) {
                return Ok(MystikoV2CelerEvents::PeerMinRollupFeeFilter(decoded));
            }
            if let Ok(decoded) = SanctionsCheckFilter::decode_log(log) {
                return Ok(MystikoV2CelerEvents::SanctionsCheckFilter(decoded));
            }
            if let Ok(decoded) = SanctionsListFilter::decode_log(log) {
                return Ok(MystikoV2CelerEvents::SanctionsListFilter(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::std::fmt::Display for MystikoV2CelerEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2CelerEvents::CommitmentCrossChainFilter(element) => element.fmt(f),
                MystikoV2CelerEvents::DepositsDisabledFilter(element) => element.fmt(f),
                MystikoV2CelerEvents::MaxAmountFilter(element) => element.fmt(f),
                MystikoV2CelerEvents::MinAmountFilter(element) => element.fmt(f),
                MystikoV2CelerEvents::MinBridgeFeeFilter(element) => element.fmt(f),
                MystikoV2CelerEvents::MinExecutorFeeFilter(element) => element.fmt(f),
                MystikoV2CelerEvents::OperatorChangedFilter(element) => element.fmt(f),
                MystikoV2CelerEvents::PeerMinExecutorFeeFilter(element) => element.fmt(f),
                MystikoV2CelerEvents::PeerMinRollupFeeFilter(element) => element.fmt(f),
                MystikoV2CelerEvents::SanctionsCheckFilter(element) => element.fmt(f),
                MystikoV2CelerEvents::SanctionsListFilter(element) => element.fmt(f),
            }
        }
    }
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2CelerCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::std::result::Result<Self, ethers::core::abi::AbiError> {
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2CelerCalls::UpdateSanctionsListAddress(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ethers::core::abi::AbiEncode for MystikoV2CelerCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                MystikoV2CelerCalls::AssetType(element) => element.encode(),
                MystikoV2CelerCalls::BridgeProxyAddress(element) => element.encode(),
                MystikoV2CelerCalls::BridgeType(element) => element.encode(),
                MystikoV2CelerCalls::ChangeOperator(element) => element.encode(),
                MystikoV2CelerCalls::Deposit(element) => element.encode(),
                MystikoV2CelerCalls::DisableSanctionsCheck(element) => element.encode(),
                MystikoV2CelerCalls::EnableSanctionsCheck(element) => element.encode(),
                MystikoV2CelerCalls::ExecuteMessage(element) => element.encode(),
                MystikoV2CelerCalls::GetAssociatedCommitmentPool(element) => element.encode(),
                MystikoV2CelerCalls::GetMaxAmount(element) => element.encode(),
                MystikoV2CelerCalls::GetMinAmount(element) => element.encode(),
                MystikoV2CelerCalls::GetMinBridgeFee(element) => element.encode(),
                MystikoV2CelerCalls::GetMinExecutorFee(element) => element.encode(),
                MystikoV2CelerCalls::GetPeerMinExecutorFee(element) => element.encode(),
                MystikoV2CelerCalls::GetPeerMinRollupFee(element) => element.encode(),
                MystikoV2CelerCalls::IsDepositsDisabled(element) => element.encode(),
                MystikoV2CelerCalls::PeerChainId(element) => element.encode(),
                MystikoV2CelerCalls::PeerChainName(element) => element.encode(),
                MystikoV2CelerCalls::PeerContract(element) => element.encode(),
                MystikoV2CelerCalls::SanctionsCheck(element) => element.encode(),
                MystikoV2CelerCalls::SanctionsList(element) => element.encode(),
                MystikoV2CelerCalls::SetAssociatedCommitmentPool(element) => element.encode(),
                MystikoV2CelerCalls::SetBridgeProxyAddress(element) => element.encode(),
                MystikoV2CelerCalls::SetDepositsDisabled(element) => element.encode(),
                MystikoV2CelerCalls::SetMaxAmount(element) => element.encode(),
                MystikoV2CelerCalls::SetMinAmount(element) => element.encode(),
                MystikoV2CelerCalls::SetMinBridgeFee(element) => element.encode(),
                MystikoV2CelerCalls::SetMinExecutorFee(element) => element.encode(),
                MystikoV2CelerCalls::SetPeerContract(element) => element.encode(),
                MystikoV2CelerCalls::SetPeerMinExecutorFee(element) => element.encode(),
                MystikoV2CelerCalls::SetPeerMinRollupFee(element) => element.encode(),
                MystikoV2CelerCalls::UpdateSanctionsListAddress(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for MystikoV2CelerCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2CelerCalls::AssetType(element) => element.fmt(f),
                MystikoV2CelerCalls::BridgeProxyAddress(element) => element.fmt(f),
                MystikoV2CelerCalls::BridgeType(element) => element.fmt(f),
                MystikoV2CelerCalls::ChangeOperator(element) => element.fmt(f),
                MystikoV2CelerCalls::Deposit(element) => element.fmt(f),
                MystikoV2CelerCalls::DisableSanctionsCheck(element) => element.fmt(f),
                MystikoV2CelerCalls::EnableSanctionsCheck(element) => element.fmt(f),
                MystikoV2CelerCalls::ExecuteMessage(element) => element.fmt(f),
                MystikoV2CelerCalls::GetAssociatedCommitmentPool(element) => element.fmt(f),
                MystikoV2CelerCalls::GetMaxAmount(element) => element.fmt(f),
                MystikoV2CelerCalls::GetMinAmount(element) => element.fmt(f),
                MystikoV2CelerCalls::GetMinBridgeFee(element) => element.fmt(f),
                MystikoV2CelerCalls::GetMinExecutorFee(element) => element.fmt(f),
                MystikoV2CelerCalls::GetPeerMinExecutorFee(element) => element.fmt(f),
                MystikoV2CelerCalls::GetPeerMinRollupFee(element) => element.fmt(f),
                MystikoV2CelerCalls::IsDepositsDisabled(element) => element.fmt(f),
                MystikoV2CelerCalls::PeerChainId(element) => element.fmt(f),
                MystikoV2CelerCalls::PeerChainName(element) => element.fmt(f),
                MystikoV2CelerCalls::PeerContract(element) => element.fmt(f),
                MystikoV2CelerCalls::SanctionsCheck(element) => element.fmt(f),
                MystikoV2CelerCalls::SanctionsList(element) => element.fmt(f),
                MystikoV2CelerCalls::SetAssociatedCommitmentPool(element) => element.fmt(f),
                MystikoV2CelerCalls::SetBridgeProxyAddress(element) => element.fmt(f),
                MystikoV2CelerCalls::SetDepositsDisabled(element) => element.fmt(f),
                MystikoV2CelerCalls::SetMaxAmount(element) => element.fmt(f),
                MystikoV2CelerCalls::SetMinAmount(element) => element.fmt(f),
                MystikoV2CelerCalls::SetMinBridgeFee(element) => element.fmt(f),
                MystikoV2CelerCalls::SetMinExecutorFee(element) => element.fmt(f),
                MystikoV2CelerCalls::SetPeerContract(element) => element.fmt(f),
                MystikoV2CelerCalls::SetPeerMinExecutorFee(element) => element.fmt(f),
                MystikoV2CelerCalls::SetPeerMinRollupFee(element) => element.fmt(f),
                MystikoV2CelerCalls::UpdateSanctionsListAddress(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AssetTypeCall> for MystikoV2CelerCalls {
        fn from(var: AssetTypeCall) -> Self {
            MystikoV2CelerCalls::AssetType(var)
        }
    }
    impl ::std::convert::From<BridgeProxyAddressCall> for MystikoV2CelerCalls {
        fn from(var: BridgeProxyAddressCall) -> Self {
            MystikoV2CelerCalls::BridgeProxyAddress(var)
        }
    }
    impl ::std::convert::From<BridgeTypeCall> for MystikoV2CelerCalls {
        fn from(var: BridgeTypeCall) -> Self {
            MystikoV2CelerCalls::BridgeType(var)
        }
    }
    impl ::std::convert::From<ChangeOperatorCall> for MystikoV2CelerCalls {
        fn from(var: ChangeOperatorCall) -> Self {
            MystikoV2CelerCalls::ChangeOperator(var)
        }
    }
    impl ::std::convert::From<DepositCall> for MystikoV2CelerCalls {
        fn from(var: DepositCall) -> Self {
            MystikoV2CelerCalls::Deposit(var)
        }
    }
    impl ::std::convert::From<DisableSanctionsCheckCall> for MystikoV2CelerCalls {
        fn from(var: DisableSanctionsCheckCall) -> Self {
            MystikoV2CelerCalls::DisableSanctionsCheck(var)
        }
    }
    impl ::std::convert::From<EnableSanctionsCheckCall> for MystikoV2CelerCalls {
        fn from(var: EnableSanctionsCheckCall) -> Self {
            MystikoV2CelerCalls::EnableSanctionsCheck(var)
        }
    }
    impl ::std::convert::From<ExecuteMessageCall> for MystikoV2CelerCalls {
        fn from(var: ExecuteMessageCall) -> Self {
            MystikoV2CelerCalls::ExecuteMessage(var)
        }
    }
    impl ::std::convert::From<GetAssociatedCommitmentPoolCall> for MystikoV2CelerCalls {
        fn from(var: GetAssociatedCommitmentPoolCall) -> Self {
            MystikoV2CelerCalls::GetAssociatedCommitmentPool(var)
        }
    }
    impl ::std::convert::From<GetMaxAmountCall> for MystikoV2CelerCalls {
        fn from(var: GetMaxAmountCall) -> Self {
            MystikoV2CelerCalls::GetMaxAmount(var)
        }
    }
    impl ::std::convert::From<GetMinAmountCall> for MystikoV2CelerCalls {
        fn from(var: GetMinAmountCall) -> Self {
            MystikoV2CelerCalls::GetMinAmount(var)
        }
    }
    impl ::std::convert::From<GetMinBridgeFeeCall> for MystikoV2CelerCalls {
        fn from(var: GetMinBridgeFeeCall) -> Self {
            MystikoV2CelerCalls::GetMinBridgeFee(var)
        }
    }
    impl ::std::convert::From<GetMinExecutorFeeCall> for MystikoV2CelerCalls {
        fn from(var: GetMinExecutorFeeCall) -> Self {
            MystikoV2CelerCalls::GetMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<GetPeerMinExecutorFeeCall> for MystikoV2CelerCalls {
        fn from(var: GetPeerMinExecutorFeeCall) -> Self {
            MystikoV2CelerCalls::GetPeerMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<GetPeerMinRollupFeeCall> for MystikoV2CelerCalls {
        fn from(var: GetPeerMinRollupFeeCall) -> Self {
            MystikoV2CelerCalls::GetPeerMinRollupFee(var)
        }
    }
    impl ::std::convert::From<IsDepositsDisabledCall> for MystikoV2CelerCalls {
        fn from(var: IsDepositsDisabledCall) -> Self {
            MystikoV2CelerCalls::IsDepositsDisabled(var)
        }
    }
    impl ::std::convert::From<PeerChainIdCall> for MystikoV2CelerCalls {
        fn from(var: PeerChainIdCall) -> Self {
            MystikoV2CelerCalls::PeerChainId(var)
        }
    }
    impl ::std::convert::From<PeerChainNameCall> for MystikoV2CelerCalls {
        fn from(var: PeerChainNameCall) -> Self {
            MystikoV2CelerCalls::PeerChainName(var)
        }
    }
    impl ::std::convert::From<PeerContractCall> for MystikoV2CelerCalls {
        fn from(var: PeerContractCall) -> Self {
            MystikoV2CelerCalls::PeerContract(var)
        }
    }
    impl ::std::convert::From<SanctionsCheckCall> for MystikoV2CelerCalls {
        fn from(var: SanctionsCheckCall) -> Self {
            MystikoV2CelerCalls::SanctionsCheck(var)
        }
    }
    impl ::std::convert::From<SanctionsListCall> for MystikoV2CelerCalls {
        fn from(var: SanctionsListCall) -> Self {
            MystikoV2CelerCalls::SanctionsList(var)
        }
    }
    impl ::std::convert::From<SetAssociatedCommitmentPoolCall> for MystikoV2CelerCalls {
        fn from(var: SetAssociatedCommitmentPoolCall) -> Self {
            MystikoV2CelerCalls::SetAssociatedCommitmentPool(var)
        }
    }
    impl ::std::convert::From<SetBridgeProxyAddressCall> for MystikoV2CelerCalls {
        fn from(var: SetBridgeProxyAddressCall) -> Self {
            MystikoV2CelerCalls::SetBridgeProxyAddress(var)
        }
    }
    impl ::std::convert::From<SetDepositsDisabledCall> for MystikoV2CelerCalls {
        fn from(var: SetDepositsDisabledCall) -> Self {
            MystikoV2CelerCalls::SetDepositsDisabled(var)
        }
    }
    impl ::std::convert::From<SetMaxAmountCall> for MystikoV2CelerCalls {
        fn from(var: SetMaxAmountCall) -> Self {
            MystikoV2CelerCalls::SetMaxAmount(var)
        }
    }
    impl ::std::convert::From<SetMinAmountCall> for MystikoV2CelerCalls {
        fn from(var: SetMinAmountCall) -> Self {
            MystikoV2CelerCalls::SetMinAmount(var)
        }
    }
    impl ::std::convert::From<SetMinBridgeFeeCall> for MystikoV2CelerCalls {
        fn from(var: SetMinBridgeFeeCall) -> Self {
            MystikoV2CelerCalls::SetMinBridgeFee(var)
        }
    }
    impl ::std::convert::From<SetMinExecutorFeeCall> for MystikoV2CelerCalls {
        fn from(var: SetMinExecutorFeeCall) -> Self {
            MystikoV2CelerCalls::SetMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<SetPeerContractCall> for MystikoV2CelerCalls {
        fn from(var: SetPeerContractCall) -> Self {
            MystikoV2CelerCalls::SetPeerContract(var)
        }
    }
    impl ::std::convert::From<SetPeerMinExecutorFeeCall> for MystikoV2CelerCalls {
        fn from(var: SetPeerMinExecutorFeeCall) -> Self {
            MystikoV2CelerCalls::SetPeerMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<SetPeerMinRollupFeeCall> for MystikoV2CelerCalls {
        fn from(var: SetPeerMinRollupFeeCall) -> Self {
            MystikoV2CelerCalls::SetPeerMinRollupFee(var)
        }
    }
    impl ::std::convert::From<UpdateSanctionsListAddressCall> for MystikoV2CelerCalls {
        fn from(var: UpdateSanctionsListAddressCall) -> Self {
            MystikoV2CelerCalls::UpdateSanctionsListAddress(var)
        }
    }
