...
pub mod erc20 {
    ...
    pub static ERC20_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(__abi);
    ...
    impl<M: ::ethers::providers::Middleware> ERC20<M> {
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ERC20Events> {
