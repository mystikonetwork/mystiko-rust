...
pub mod nonblocking_lz_app {
    const _: () = {
        ::core::include_bytes!("../json/NonblockingLzApp.json",);
    };
    #[allow(deprecated)]
    ...
    pub static NONBLOCKINGLZAPP_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> =
    ...
    impl<M: ::ethers_providers::Middleware> NonblockingLzApp<M> {
        ...
        pub fn events(&self) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, NonblockingLzAppEvents> {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers_providers::Middleware> From<::ethers_contract::Contract<M>> for NonblockingLzApp<M> {
