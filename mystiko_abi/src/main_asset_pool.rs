...
pub mod main_asset_pool {
    ...
    pub static MAINASSETPOOL_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(__abi);
    pub struct MainAssetPool<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> MainAssetPool<M> {
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for MainAssetPool<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for MainAssetPoolCalls {
    ...
    impl ::ethers::core::abi::AbiEncode for MainAssetPoolCalls {
