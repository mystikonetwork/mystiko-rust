...
pub mod i_access_control {
    ...
    impl<M: ::ethers::providers::Middleware> IAccessControl<M> {
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, IAccessControlEvents> {
    ...
    impl ::core::convert::From<AccessControlUnauthorizedAccount> for IAccessControlErrors {
