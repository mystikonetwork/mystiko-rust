...
pub mod ierc721_errors {
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for IERC721Errors<M> {
    ...
    #[etherror(name = "ERC721IncorrectOwner", abi = "ERC721IncorrectOwner(address,uint256,address)")]
    ...
    impl ::ethers::core::abi::AbiDecode for IERC721ErrorsErrors {
        fn decode(data: impl AsRef<[u8]>) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            ...
            if let Ok(decoded) = <ERC721IncorrectOwner as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ERC721IncorrectOwner(decoded));
            }
            if let Ok(decoded) = <ERC721InsufficientApproval as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ERC721InsufficientApproval(decoded));
            }
            if let Ok(decoded) = <ERC721InvalidApprover as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ERC721InvalidApprover(decoded));
            }
            if let Ok(decoded) = <ERC721InvalidOperator as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ERC721InvalidOperator(decoded));
            }
            if let Ok(decoded) = <ERC721InvalidOwner as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ERC721InvalidOwner(decoded));
            }
            if let Ok(decoded) = <ERC721InvalidReceiver as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ERC721InvalidReceiver(decoded));
            }
            if let Ok(decoded) = <ERC721InvalidSender as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ERC721InvalidSender(decoded));
            }
            if let Ok(decoded) = <ERC721NonexistentToken as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for IERC721ErrorsErrors {
        fn encode(self) -> ::std::vec::Vec<u8> {
            match self {
                Self::ERC721IncorrectOwner(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ERC721InsufficientApproval(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ERC721InvalidApprover(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ERC721InvalidOperator(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ERC721InvalidOwner(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ERC721InvalidReceiver(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ERC721InvalidSender(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ERC721NonexistentToken(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    impl ::ethers::contract::ContractRevert for IERC721ErrorsErrors {
        fn valid_selector(selector: [u8; 4]) -> bool {
            match selector {
                ...
                _ if selector == <ERC721IncorrectOwner as ::ethers::contract::EthError>::selector() => true,
                _ if selector == <ERC721InsufficientApproval as ::ethers::contract::EthError>::selector() => true,
                _ if selector == <ERC721InvalidApprover as ::ethers::contract::EthError>::selector() => true,
                _ if selector == <ERC721InvalidOperator as ::ethers::contract::EthError>::selector() => true,
                _ if selector == <ERC721InvalidOwner as ::ethers::contract::EthError>::selector() => true,
                _ if selector == <ERC721InvalidReceiver as ::ethers::contract::EthError>::selector() => true,
                _ if selector == <ERC721InvalidSender as ::ethers::contract::EthError>::selector() => true,
                _ if selector == <ERC721NonexistentToken as ::ethers::contract::EthError>::selector() => true,
                _ => false,
            }
        }
    }
