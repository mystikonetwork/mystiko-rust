...
pub mod access_control {
    ...
    impl<M: ::ethers::providers::Middleware> AccessControl<M> {
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, AccessControlEvents> {
    ...
    impl ::core::convert::From<AccessControlBadConfirmation> for AccessControlErrors {
        fn from(value: AccessControlBadConfirmation) -> Self {
            Self::AccessControlBadConfirmation(value)
        }
    }
    impl ::core::convert::From<AccessControlUnauthorizedAccount> for AccessControlErrors {
