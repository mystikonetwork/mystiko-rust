...
pub mod ownable {
    ...
    pub static OWNABLE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(__abi);
    ...
    impl<M> ::core::fmt::Debug for Ownable<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Ownable))
                .field(&self.address())
                .finish()
        }
    }
    ...
    impl ::core::convert::From<OwnableInvalidOwner> for OwnableErrors {
        fn from(value: OwnableInvalidOwner) -> Self {
            Self::OwnableInvalidOwner(value)
        }
    }
    impl ::core::convert::From<OwnableUnauthorizedAccount> for OwnableErrors {
