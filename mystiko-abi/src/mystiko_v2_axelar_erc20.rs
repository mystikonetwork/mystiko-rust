...
pub mod mystiko_v2_axelar_erc20 {
    ...
    impl<M> Clone for MystikoV2AxelarERC20<M> {
        fn clone(&self) -> Self {
            MystikoV2AxelarERC20(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for MystikoV2AxelarERC20<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> std::fmt::Debug for MystikoV2AxelarERC20<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(MystikoV2AxelarERC20))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ethers::providers::Middleware> MystikoV2AxelarERC20<M> {
        ...
        pub fn events(&self) -> ethers::contract::builders::Event<M, MystikoV2AxelarERC20Events> {
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2AxelarERC20Errors {
        fn decode(
            ...
            {
                return Ok(MystikoV2AxelarERC20Errors::AmountLessThanZero(decoded));
            }
            if let Ok(decoded) =
                <AmountTooLarge as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Errors::AmountTooLarge(decoded));
            }
            if let Ok(decoded) =
                <AmountTooSmall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Errors::AmountTooSmall(decoded));
            }
            if let Ok(decoded) =
                <BridgeFeeTooFew as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Errors::BridgeFeeTooFew(decoded));
            }
            if let Ok(decoded) =
                <CommitmentHashIncorrect as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Errors::CommitmentHashIncorrect(decoded));
            }
            if let Ok(decoded) =
                <DepositsDisabled as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Errors::DepositsDisabled(decoded));
            }
            if let Ok(decoded) =
                <ExecutorFeeTooFew as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Errors::ExecutorFeeTooFew(decoded));
            }
            if let Ok(decoded) =
                <FromChainIdNotMatched as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Errors::FromChainIdNotMatched(decoded));
            }
            if let Ok(decoded) =
                <FromProxyAddressNotMatched as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Errors::FromProxyAddressNotMatched(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2AxelarERC20Errors::HashKGreaterThanFieldSize(
                    decoded,
                ));
            }
            if let Ok(decoded) = <Invalid as ethers::core::abi::AbiDecode>::decode(data.as_ref()) {
                return Ok(MystikoV2AxelarERC20Errors::Invalid(decoded));
            }
            if let Ok(decoded) =
                <MaxAmountLessThanMinAmount as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Errors::MaxAmountLessThanMinAmount(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2AxelarERC20Errors::MinAmountGreaterThanMaxAmount(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2AxelarERC20Errors::NotApprovedByGateway(decoded));
            }
            if let Ok(decoded) = <NotChanged as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Errors::NotChanged(decoded));
            }
            if let Ok(decoded) =
                <OnlyOperator as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Errors::OnlyOperator(decoded));
            }
            if let Ok(decoded) =
                <RandomSGreaterThanFieldSize as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Errors::RandomSGreaterThanFieldSize(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2AxelarERC20Errors::RollupFeeToFew(decoded));
            }
            if let Ok(decoded) =
                <SanctionedAddress as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Errors::SanctionedAddress(decoded));
            }
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2AxelarERC20Errors {
        fn encode(self) -> Vec<u8> {
            match self {
                MystikoV2AxelarERC20Errors::AmountLessThanZero(element) => element.encode(),
                MystikoV2AxelarERC20Errors::AmountTooLarge(element) => element.encode(),
                MystikoV2AxelarERC20Errors::AmountTooSmall(element) => element.encode(),
                MystikoV2AxelarERC20Errors::BridgeFeeTooFew(element) => element.encode(),
                MystikoV2AxelarERC20Errors::CommitmentHashIncorrect(element) => element.encode(),
                MystikoV2AxelarERC20Errors::DepositsDisabled(element) => element.encode(),
                MystikoV2AxelarERC20Errors::ExecutorFeeTooFew(element) => element.encode(),
                MystikoV2AxelarERC20Errors::FromChainIdNotMatched(element) => element.encode(),
                MystikoV2AxelarERC20Errors::FromProxyAddressNotMatched(element) => element.encode(),
                MystikoV2AxelarERC20Errors::HashKGreaterThanFieldSize(element) => element.encode(),
                MystikoV2AxelarERC20Errors::Invalid(element) => element.encode(),
                MystikoV2AxelarERC20Errors::MaxAmountLessThanMinAmount(element) => element.encode(),
                MystikoV2AxelarERC20Errors::MinAmountGreaterThanMaxAmount(element) => {
                    element.encode()
                }
                MystikoV2AxelarERC20Errors::NotApprovedByGateway(element) => element.encode(),
                MystikoV2AxelarERC20Errors::NotChanged(element) => element.encode(),
                MystikoV2AxelarERC20Errors::OnlyOperator(element) => element.encode(),
                MystikoV2AxelarERC20Errors::RandomSGreaterThanFieldSize(element) => {
                    element.encode()
                }
                MystikoV2AxelarERC20Errors::RollupFeeToFew(element) => element.encode(),
                MystikoV2AxelarERC20Errors::SanctionedAddress(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for MystikoV2AxelarERC20Errors {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2AxelarERC20Errors::AmountLessThanZero(element) => element.fmt(f),
                MystikoV2AxelarERC20Errors::AmountTooLarge(element) => element.fmt(f),
                MystikoV2AxelarERC20Errors::AmountTooSmall(element) => element.fmt(f),
                MystikoV2AxelarERC20Errors::BridgeFeeTooFew(element) => element.fmt(f),
                MystikoV2AxelarERC20Errors::CommitmentHashIncorrect(element) => element.fmt(f),
                MystikoV2AxelarERC20Errors::DepositsDisabled(element) => element.fmt(f),
                MystikoV2AxelarERC20Errors::ExecutorFeeTooFew(element) => element.fmt(f),
                MystikoV2AxelarERC20Errors::FromChainIdNotMatched(element) => element.fmt(f),
                MystikoV2AxelarERC20Errors::FromProxyAddressNotMatched(element) => element.fmt(f),
                MystikoV2AxelarERC20Errors::HashKGreaterThanFieldSize(element) => element.fmt(f),
                MystikoV2AxelarERC20Errors::Invalid(element) => element.fmt(f),
                MystikoV2AxelarERC20Errors::MaxAmountLessThanMinAmount(element) => element.fmt(f),
                MystikoV2AxelarERC20Errors::MinAmountGreaterThanMaxAmount(element) => {
                    element.fmt(f)
                }
                MystikoV2AxelarERC20Errors::NotApprovedByGateway(element) => element.fmt(f),
                MystikoV2AxelarERC20Errors::NotChanged(element) => element.fmt(f),
                MystikoV2AxelarERC20Errors::OnlyOperator(element) => element.fmt(f),
                MystikoV2AxelarERC20Errors::RandomSGreaterThanFieldSize(element) => element.fmt(f),
                MystikoV2AxelarERC20Errors::RollupFeeToFew(element) => element.fmt(f),
                MystikoV2AxelarERC20Errors::SanctionedAddress(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AmountLessThanZero> for MystikoV2AxelarERC20Errors {
        fn from(var: AmountLessThanZero) -> Self {
            MystikoV2AxelarERC20Errors::AmountLessThanZero(var)
        }
    }
    impl ::std::convert::From<AmountTooLarge> for MystikoV2AxelarERC20Errors {
        fn from(var: AmountTooLarge) -> Self {
            MystikoV2AxelarERC20Errors::AmountTooLarge(var)
        }
    }
    impl ::std::convert::From<AmountTooSmall> for MystikoV2AxelarERC20Errors {
        fn from(var: AmountTooSmall) -> Self {
            MystikoV2AxelarERC20Errors::AmountTooSmall(var)
        }
    }
    impl ::std::convert::From<BridgeFeeTooFew> for MystikoV2AxelarERC20Errors {
        fn from(var: BridgeFeeTooFew) -> Self {
            MystikoV2AxelarERC20Errors::BridgeFeeTooFew(var)
        }
    }
    impl ::std::convert::From<CommitmentHashIncorrect> for MystikoV2AxelarERC20Errors {
        fn from(var: CommitmentHashIncorrect) -> Self {
            MystikoV2AxelarERC20Errors::CommitmentHashIncorrect(var)
        }
    }
    impl ::std::convert::From<DepositsDisabled> for MystikoV2AxelarERC20Errors {
        fn from(var: DepositsDisabled) -> Self {
            MystikoV2AxelarERC20Errors::DepositsDisabled(var)
        }
    }
    impl ::std::convert::From<ExecutorFeeTooFew> for MystikoV2AxelarERC20Errors {
        fn from(var: ExecutorFeeTooFew) -> Self {
            MystikoV2AxelarERC20Errors::ExecutorFeeTooFew(var)
        }
    }
    impl ::std::convert::From<FromChainIdNotMatched> for MystikoV2AxelarERC20Errors {
        fn from(var: FromChainIdNotMatched) -> Self {
            MystikoV2AxelarERC20Errors::FromChainIdNotMatched(var)
        }
    }
    impl ::std::convert::From<FromProxyAddressNotMatched> for MystikoV2AxelarERC20Errors {
        fn from(var: FromProxyAddressNotMatched) -> Self {
            MystikoV2AxelarERC20Errors::FromProxyAddressNotMatched(var)
        }
    }
    impl ::std::convert::From<HashKGreaterThanFieldSize> for MystikoV2AxelarERC20Errors {
        fn from(var: HashKGreaterThanFieldSize) -> Self {
            MystikoV2AxelarERC20Errors::HashKGreaterThanFieldSize(var)
        }
    }
    impl ::std::convert::From<Invalid> for MystikoV2AxelarERC20Errors {
        fn from(var: Invalid) -> Self {
            MystikoV2AxelarERC20Errors::Invalid(var)
        }
    }
    impl ::std::convert::From<MaxAmountLessThanMinAmount> for MystikoV2AxelarERC20Errors {
        fn from(var: MaxAmountLessThanMinAmount) -> Self {
            MystikoV2AxelarERC20Errors::MaxAmountLessThanMinAmount(var)
        }
    }
    impl ::std::convert::From<MinAmountGreaterThanMaxAmount> for MystikoV2AxelarERC20Errors {
        fn from(var: MinAmountGreaterThanMaxAmount) -> Self {
            MystikoV2AxelarERC20Errors::MinAmountGreaterThanMaxAmount(var)
        }
    }
    impl ::std::convert::From<NotApprovedByGateway> for MystikoV2AxelarERC20Errors {
        fn from(var: NotApprovedByGateway) -> Self {
            MystikoV2AxelarERC20Errors::NotApprovedByGateway(var)
        }
    }
    impl ::std::convert::From<NotChanged> for MystikoV2AxelarERC20Errors {
        fn from(var: NotChanged) -> Self {
            MystikoV2AxelarERC20Errors::NotChanged(var)
        }
    }
    impl ::std::convert::From<OnlyOperator> for MystikoV2AxelarERC20Errors {
        fn from(var: OnlyOperator) -> Self {
            MystikoV2AxelarERC20Errors::OnlyOperator(var)
        }
    }
    impl ::std::convert::From<RandomSGreaterThanFieldSize> for MystikoV2AxelarERC20Errors {
        fn from(var: RandomSGreaterThanFieldSize) -> Self {
            MystikoV2AxelarERC20Errors::RandomSGreaterThanFieldSize(var)
        }
    }
    impl ::std::convert::From<RollupFeeToFew> for MystikoV2AxelarERC20Errors {
        fn from(var: RollupFeeToFew) -> Self {
            MystikoV2AxelarERC20Errors::RollupFeeToFew(var)
        }
    }
    impl ::std::convert::From<SanctionedAddress> for MystikoV2AxelarERC20Errors {
        fn from(var: SanctionedAddress) -> Self {
            MystikoV2AxelarERC20Errors::SanctionedAddress(var)
        }
    }
    #[derive(
        Clone,
    ...
    impl ethers::contract::EthLogDecode for MystikoV2AxelarERC20Events {
            ...
            Self: Sized,
        {
            if let Ok(decoded) = CallContractMessageFilter::decode_log(log) {
                return Ok(MystikoV2AxelarERC20Events::CallContractMessageFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = CommitmentCrossChainFilter::decode_log(log) {
                return Ok(MystikoV2AxelarERC20Events::CommitmentCrossChainFilter(
                    decoded,
                ));
            }
            ...
            if let Ok(decoded) = MaxAmountFilter::decode_log(log) {
                return Ok(MystikoV2AxelarERC20Events::MaxAmountFilter(decoded));
            }
            if let Ok(decoded) = MinAmountFilter::decode_log(log) {
                return Ok(MystikoV2AxelarERC20Events::MinAmountFilter(decoded));
            }
            ...
            if let Ok(decoded) = PeerMinExecutorFeeFilter::decode_log(log) {
                return Ok(MystikoV2AxelarERC20Events::PeerMinExecutorFeeFilter(
                    decoded,
                ));
            }
    ...
    impl ::std::fmt::Display for MystikoV2AxelarERC20Events {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2AxelarERC20Events::CallContractMessageFilter(element) => element.fmt(f),
                MystikoV2AxelarERC20Events::CommitmentCrossChainFilter(element) => element.fmt(f),
                MystikoV2AxelarERC20Events::DepositsDisabledFilter(element) => element.fmt(f),
                MystikoV2AxelarERC20Events::MaxAmountFilter(element) => element.fmt(f),
                MystikoV2AxelarERC20Events::MinAmountFilter(element) => element.fmt(f),
                MystikoV2AxelarERC20Events::MinBridgeFeeFilter(element) => element.fmt(f),
                MystikoV2AxelarERC20Events::MinExecutorFeeFilter(element) => element.fmt(f),
                MystikoV2AxelarERC20Events::OperatorChangedFilter(element) => element.fmt(f),
                MystikoV2AxelarERC20Events::PeerMinExecutorFeeFilter(element) => element.fmt(f),
                MystikoV2AxelarERC20Events::PeerMinRollupFeeFilter(element) => element.fmt(f),
                MystikoV2AxelarERC20Events::SanctionsCheckFilter(element) => element.fmt(f),
                MystikoV2AxelarERC20Events::SanctionsListFilter(element) => element.fmt(f),
            }
        }
    }
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2AxelarERC20Calls {
        fn decode(
            ...
            {
                return Ok(MystikoV2AxelarERC20Calls::AssetDecimals(decoded));
            }
            if let Ok(decoded) =
                <AssetNameCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Calls::AssetName(decoded));
            }
            if let Ok(decoded) =
                <AssetSymbolCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Calls::AssetSymbol(decoded));
            }
            if let Ok(decoded) =
                <AssetTypeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Calls::AssetType(decoded));
            }
            if let Ok(decoded) =
                <BridgeProxyAddressCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Calls::BridgeProxyAddress(decoded));
            }
            if let Ok(decoded) =
                <BridgeTypeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Calls::BridgeType(decoded));
            }
            if let Ok(decoded) =
                <ChangeOperatorCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Calls::ChangeOperator(decoded));
            }
            if let Ok(decoded) =
                <DepositCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Calls::Deposit(decoded));
            }
            if let Ok(decoded) =
                <DisableSanctionsCheckCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Calls::DisableSanctionsCheck(decoded));
            }
            if let Ok(decoded) =
                <EnableSanctionsCheckCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Calls::EnableSanctionsCheck(decoded));
            }
            if let Ok(decoded) =
                <ExecuteCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Calls::Execute(decoded));
            }
            if let Ok(decoded) =
                <ExecuteWithTokenCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Calls::ExecuteWithToken(decoded));
            }
            if let Ok(decoded) =
                <GatewayCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2AxelarERC20Calls::Gateway(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2AxelarERC20Calls::GetAssociatedCommitmentPool(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2AxelarERC20Calls::SetAssociatedCommitmentPool(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2AxelarERC20Calls::UpdateSanctionsListAddress(
                    decoded,
                ));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2AxelarERC20Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                MystikoV2AxelarERC20Calls::AssetDecimals(element) => element.encode(),
                MystikoV2AxelarERC20Calls::AssetName(element) => element.encode(),
                MystikoV2AxelarERC20Calls::AssetSymbol(element) => element.encode(),
                MystikoV2AxelarERC20Calls::AssetType(element) => element.encode(),
                MystikoV2AxelarERC20Calls::BridgeProxyAddress(element) => element.encode(),
                MystikoV2AxelarERC20Calls::BridgeType(element) => element.encode(),
                MystikoV2AxelarERC20Calls::ChangeOperator(element) => element.encode(),
                MystikoV2AxelarERC20Calls::Deposit(element) => element.encode(),
                MystikoV2AxelarERC20Calls::DisableSanctionsCheck(element) => element.encode(),
                MystikoV2AxelarERC20Calls::EnableSanctionsCheck(element) => element.encode(),
                MystikoV2AxelarERC20Calls::Execute(element) => element.encode(),
                MystikoV2AxelarERC20Calls::ExecuteWithToken(element) => element.encode(),
                MystikoV2AxelarERC20Calls::Gateway(element) => element.encode(),
                MystikoV2AxelarERC20Calls::GetAssociatedCommitmentPool(element) => element.encode(),
                MystikoV2AxelarERC20Calls::GetMaxAmount(element) => element.encode(),
                MystikoV2AxelarERC20Calls::GetMinAmount(element) => element.encode(),
                MystikoV2AxelarERC20Calls::GetMinBridgeFee(element) => element.encode(),
                MystikoV2AxelarERC20Calls::GetMinExecutorFee(element) => element.encode(),
                MystikoV2AxelarERC20Calls::GetPeerMinExecutorFee(element) => element.encode(),
                MystikoV2AxelarERC20Calls::GetPeerMinRollupFee(element) => element.encode(),
                MystikoV2AxelarERC20Calls::IsDepositsDisabled(element) => element.encode(),
                MystikoV2AxelarERC20Calls::PeerChainId(element) => element.encode(),
                MystikoV2AxelarERC20Calls::PeerChainName(element) => element.encode(),
                MystikoV2AxelarERC20Calls::PeerContract(element) => element.encode(),
                MystikoV2AxelarERC20Calls::SanctionsCheck(element) => element.encode(),
                MystikoV2AxelarERC20Calls::SanctionsList(element) => element.encode(),
                MystikoV2AxelarERC20Calls::SetAssociatedCommitmentPool(element) => element.encode(),
                MystikoV2AxelarERC20Calls::SetAxelarGasReceiver(element) => element.encode(),
                MystikoV2AxelarERC20Calls::SetBridgeProxyAddress(element) => element.encode(),
                MystikoV2AxelarERC20Calls::SetDepositsDisabled(element) => element.encode(),
                MystikoV2AxelarERC20Calls::SetMaxAmount(element) => element.encode(),
                MystikoV2AxelarERC20Calls::SetMinAmount(element) => element.encode(),
                MystikoV2AxelarERC20Calls::SetMinBridgeFee(element) => element.encode(),
                MystikoV2AxelarERC20Calls::SetMinExecutorFee(element) => element.encode(),
                MystikoV2AxelarERC20Calls::SetPeerContract(element) => element.encode(),
                MystikoV2AxelarERC20Calls::SetPeerMinExecutorFee(element) => element.encode(),
                MystikoV2AxelarERC20Calls::SetPeerMinRollupFee(element) => element.encode(),
                MystikoV2AxelarERC20Calls::UpdateSanctionsListAddress(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for MystikoV2AxelarERC20Calls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2AxelarERC20Calls::AssetDecimals(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::AssetName(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::AssetSymbol(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::AssetType(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::BridgeProxyAddress(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::BridgeType(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::ChangeOperator(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::Deposit(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::DisableSanctionsCheck(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::EnableSanctionsCheck(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::Execute(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::ExecuteWithToken(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::Gateway(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::GetAssociatedCommitmentPool(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::GetMaxAmount(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::GetMinAmount(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::GetMinBridgeFee(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::GetMinExecutorFee(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::GetPeerMinExecutorFee(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::GetPeerMinRollupFee(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::IsDepositsDisabled(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::PeerChainId(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::PeerChainName(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::PeerContract(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::SanctionsCheck(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::SanctionsList(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::SetAssociatedCommitmentPool(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::SetAxelarGasReceiver(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::SetBridgeProxyAddress(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::SetDepositsDisabled(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::SetMaxAmount(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::SetMinAmount(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::SetMinBridgeFee(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::SetMinExecutorFee(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::SetPeerContract(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::SetPeerMinExecutorFee(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::SetPeerMinRollupFee(element) => element.fmt(f),
                MystikoV2AxelarERC20Calls::UpdateSanctionsListAddress(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AssetDecimalsCall> for MystikoV2AxelarERC20Calls {
        fn from(var: AssetDecimalsCall) -> Self {
            MystikoV2AxelarERC20Calls::AssetDecimals(var)
        }
    }
    impl ::std::convert::From<AssetNameCall> for MystikoV2AxelarERC20Calls {
        fn from(var: AssetNameCall) -> Self {
            MystikoV2AxelarERC20Calls::AssetName(var)
        }
    }
    impl ::std::convert::From<AssetSymbolCall> for MystikoV2AxelarERC20Calls {
        fn from(var: AssetSymbolCall) -> Self {
            MystikoV2AxelarERC20Calls::AssetSymbol(var)
        }
    }
    impl ::std::convert::From<AssetTypeCall> for MystikoV2AxelarERC20Calls {
        fn from(var: AssetTypeCall) -> Self {
            MystikoV2AxelarERC20Calls::AssetType(var)
        }
    }
    impl ::std::convert::From<BridgeProxyAddressCall> for MystikoV2AxelarERC20Calls {
        fn from(var: BridgeProxyAddressCall) -> Self {
            MystikoV2AxelarERC20Calls::BridgeProxyAddress(var)
        }
    }
    impl ::std::convert::From<BridgeTypeCall> for MystikoV2AxelarERC20Calls {
        fn from(var: BridgeTypeCall) -> Self {
            MystikoV2AxelarERC20Calls::BridgeType(var)
        }
    }
    impl ::std::convert::From<ChangeOperatorCall> for MystikoV2AxelarERC20Calls {
        fn from(var: ChangeOperatorCall) -> Self {
            MystikoV2AxelarERC20Calls::ChangeOperator(var)
        }
    }
    impl ::std::convert::From<DepositCall> for MystikoV2AxelarERC20Calls {
        fn from(var: DepositCall) -> Self {
            MystikoV2AxelarERC20Calls::Deposit(var)
        }
    }
    impl ::std::convert::From<DisableSanctionsCheckCall> for MystikoV2AxelarERC20Calls {
        fn from(var: DisableSanctionsCheckCall) -> Self {
            MystikoV2AxelarERC20Calls::DisableSanctionsCheck(var)
        }
    }
    impl ::std::convert::From<EnableSanctionsCheckCall> for MystikoV2AxelarERC20Calls {
        fn from(var: EnableSanctionsCheckCall) -> Self {
            MystikoV2AxelarERC20Calls::EnableSanctionsCheck(var)
        }
    }
    impl ::std::convert::From<ExecuteCall> for MystikoV2AxelarERC20Calls {
        fn from(var: ExecuteCall) -> Self {
            MystikoV2AxelarERC20Calls::Execute(var)
        }
    }
    impl ::std::convert::From<ExecuteWithTokenCall> for MystikoV2AxelarERC20Calls {
        fn from(var: ExecuteWithTokenCall) -> Self {
            MystikoV2AxelarERC20Calls::ExecuteWithToken(var)
        }
    }
    impl ::std::convert::From<GatewayCall> for MystikoV2AxelarERC20Calls {
        fn from(var: GatewayCall) -> Self {
            MystikoV2AxelarERC20Calls::Gateway(var)
        }
    }
    impl ::std::convert::From<GetAssociatedCommitmentPoolCall> for MystikoV2AxelarERC20Calls {
        fn from(var: GetAssociatedCommitmentPoolCall) -> Self {
            MystikoV2AxelarERC20Calls::GetAssociatedCommitmentPool(var)
        }
    }
    impl ::std::convert::From<GetMaxAmountCall> for MystikoV2AxelarERC20Calls {
        fn from(var: GetMaxAmountCall) -> Self {
            MystikoV2AxelarERC20Calls::GetMaxAmount(var)
        }
    }
    impl ::std::convert::From<GetMinAmountCall> for MystikoV2AxelarERC20Calls {
        fn from(var: GetMinAmountCall) -> Self {
            MystikoV2AxelarERC20Calls::GetMinAmount(var)
        }
    }
    impl ::std::convert::From<GetMinBridgeFeeCall> for MystikoV2AxelarERC20Calls {
        fn from(var: GetMinBridgeFeeCall) -> Self {
            MystikoV2AxelarERC20Calls::GetMinBridgeFee(var)
        }
    }
    impl ::std::convert::From<GetMinExecutorFeeCall> for MystikoV2AxelarERC20Calls {
        fn from(var: GetMinExecutorFeeCall) -> Self {
            MystikoV2AxelarERC20Calls::GetMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<GetPeerMinExecutorFeeCall> for MystikoV2AxelarERC20Calls {
        fn from(var: GetPeerMinExecutorFeeCall) -> Self {
            MystikoV2AxelarERC20Calls::GetPeerMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<GetPeerMinRollupFeeCall> for MystikoV2AxelarERC20Calls {
        fn from(var: GetPeerMinRollupFeeCall) -> Self {
            MystikoV2AxelarERC20Calls::GetPeerMinRollupFee(var)
        }
    }
    impl ::std::convert::From<IsDepositsDisabledCall> for MystikoV2AxelarERC20Calls {
        fn from(var: IsDepositsDisabledCall) -> Self {
            MystikoV2AxelarERC20Calls::IsDepositsDisabled(var)
        }
    }
    impl ::std::convert::From<PeerChainIdCall> for MystikoV2AxelarERC20Calls {
        fn from(var: PeerChainIdCall) -> Self {
            MystikoV2AxelarERC20Calls::PeerChainId(var)
        }
    }
    impl ::std::convert::From<PeerChainNameCall> for MystikoV2AxelarERC20Calls {
        fn from(var: PeerChainNameCall) -> Self {
            MystikoV2AxelarERC20Calls::PeerChainName(var)
        }
    }
    impl ::std::convert::From<PeerContractCall> for MystikoV2AxelarERC20Calls {
        fn from(var: PeerContractCall) -> Self {
            MystikoV2AxelarERC20Calls::PeerContract(var)
        }
    }
    impl ::std::convert::From<SanctionsCheckCall> for MystikoV2AxelarERC20Calls {
        fn from(var: SanctionsCheckCall) -> Self {
            MystikoV2AxelarERC20Calls::SanctionsCheck(var)
        }
    }
    impl ::std::convert::From<SanctionsListCall> for MystikoV2AxelarERC20Calls {
        fn from(var: SanctionsListCall) -> Self {
            MystikoV2AxelarERC20Calls::SanctionsList(var)
        }
    }
    impl ::std::convert::From<SetAssociatedCommitmentPoolCall> for MystikoV2AxelarERC20Calls {
        fn from(var: SetAssociatedCommitmentPoolCall) -> Self {
            MystikoV2AxelarERC20Calls::SetAssociatedCommitmentPool(var)
        }
    }
    impl ::std::convert::From<SetAxelarGasReceiverCall> for MystikoV2AxelarERC20Calls {
        fn from(var: SetAxelarGasReceiverCall) -> Self {
            MystikoV2AxelarERC20Calls::SetAxelarGasReceiver(var)
        }
    }
    impl ::std::convert::From<SetBridgeProxyAddressCall> for MystikoV2AxelarERC20Calls {
        fn from(var: SetBridgeProxyAddressCall) -> Self {
            MystikoV2AxelarERC20Calls::SetBridgeProxyAddress(var)
        }
    }
    impl ::std::convert::From<SetDepositsDisabledCall> for MystikoV2AxelarERC20Calls {
        fn from(var: SetDepositsDisabledCall) -> Self {
            MystikoV2AxelarERC20Calls::SetDepositsDisabled(var)
        }
    }
    impl ::std::convert::From<SetMaxAmountCall> for MystikoV2AxelarERC20Calls {
        fn from(var: SetMaxAmountCall) -> Self {
            MystikoV2AxelarERC20Calls::SetMaxAmount(var)
        }
    }
    impl ::std::convert::From<SetMinAmountCall> for MystikoV2AxelarERC20Calls {
        fn from(var: SetMinAmountCall) -> Self {
            MystikoV2AxelarERC20Calls::SetMinAmount(var)
        }
    }
    impl ::std::convert::From<SetMinBridgeFeeCall> for MystikoV2AxelarERC20Calls {
        fn from(var: SetMinBridgeFeeCall) -> Self {
            MystikoV2AxelarERC20Calls::SetMinBridgeFee(var)
        }
    }
    impl ::std::convert::From<SetMinExecutorFeeCall> for MystikoV2AxelarERC20Calls {
        fn from(var: SetMinExecutorFeeCall) -> Self {
            MystikoV2AxelarERC20Calls::SetMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<SetPeerContractCall> for MystikoV2AxelarERC20Calls {
        fn from(var: SetPeerContractCall) -> Self {
            MystikoV2AxelarERC20Calls::SetPeerContract(var)
        }
    }
    impl ::std::convert::From<SetPeerMinExecutorFeeCall> for MystikoV2AxelarERC20Calls {
        fn from(var: SetPeerMinExecutorFeeCall) -> Self {
            MystikoV2AxelarERC20Calls::SetPeerMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<SetPeerMinRollupFeeCall> for MystikoV2AxelarERC20Calls {
        fn from(var: SetPeerMinRollupFeeCall) -> Self {
            MystikoV2AxelarERC20Calls::SetPeerMinRollupFee(var)
        }
    }
    impl ::std::convert::From<UpdateSanctionsListAddressCall> for MystikoV2AxelarERC20Calls {
        fn from(var: UpdateSanctionsListAddressCall) -> Self {
            MystikoV2AxelarERC20Calls::UpdateSanctionsListAddress(var)
        }
    }
