...
pub mod mystiko_v2t_bridge_erc20 {
    ...
    #[doc = "MystikoV2TBridgeERC20 was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    ...
    impl<M> Clone for MystikoV2TBridgeERC20<M> {
        fn clone(&self) -> Self {
            MystikoV2TBridgeERC20(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for MystikoV2TBridgeERC20<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> std::fmt::Debug for MystikoV2TBridgeERC20<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(MystikoV2TBridgeERC20))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ethers::providers::Middleware> MystikoV2TBridgeERC20<M> {
        ...
        pub fn events(&self) -> ethers::contract::builders::Event<M, MystikoV2TBridgeERC20Events> {
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2TBridgeERC20Errors {
        fn decode(
            ...
            {
                return Ok(MystikoV2TBridgeERC20Errors::AmountLessThanZero(decoded));
            }
            if let Ok(decoded) =
                <AmountTooLarge as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Errors::AmountTooLarge(decoded));
            }
            if let Ok(decoded) =
                <AmountTooSmall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Errors::AmountTooSmall(decoded));
            }
            if let Ok(decoded) =
                <BridgeFeeTooFew as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Errors::BridgeFeeTooFew(decoded));
            }
            if let Ok(decoded) =
                <CommitmentHashIncorrect as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Errors::CommitmentHashIncorrect(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2TBridgeERC20Errors::DepositsDisabled(decoded));
            }
            if let Ok(decoded) =
                <ExecutorFeeTooFew as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Errors::ExecutorFeeTooFew(decoded));
            }
            if let Ok(decoded) =
                <FromChainIdNotMatched as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Errors::FromChainIdNotMatched(decoded));
            }
            if let Ok(decoded) =
                <FromProxyAddressNotMatched as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Errors::FromProxyAddressNotMatched(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2TBridgeERC20Errors::HashKGreaterThanFieldSize(
                    decoded,
                ));
            }
            if let Ok(decoded) = <Invalid as ethers::core::abi::AbiDecode>::decode(data.as_ref()) {
                return Ok(MystikoV2TBridgeERC20Errors::Invalid(decoded));
            }
            if let Ok(decoded) =
                <MaxAmountLessThanMinAmount as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Errors::MaxAmountLessThanMinAmount(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2TBridgeERC20Errors::MinAmountGreaterThanMaxAmount(
                    decoded,
                ));
            }
            if let Ok(decoded) = <NotChanged as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Errors::NotChanged(decoded));
            }
            if let Ok(decoded) =
                <OnlyOperator as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Errors::OnlyOperator(decoded));
            }
            if let Ok(decoded) =
                <RandomSGreaterThanFieldSize as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Errors::RandomSGreaterThanFieldSize(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2TBridgeERC20Errors::RollupFeeToFew(decoded));
            }
            if let Ok(decoded) =
                <SanctionedAddress as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Errors::SanctionedAddress(decoded));
            }
            if let Ok(decoded) =
                <SenderIsNotBridgeProxy as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Errors::SenderIsNotBridgeProxy(decoded));
            }
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2TBridgeERC20Errors {
        fn encode(self) -> Vec<u8> {
            match self {
                MystikoV2TBridgeERC20Errors::AmountLessThanZero(element) => element.encode(),
                MystikoV2TBridgeERC20Errors::AmountTooLarge(element) => element.encode(),
                MystikoV2TBridgeERC20Errors::AmountTooSmall(element) => element.encode(),
                MystikoV2TBridgeERC20Errors::BridgeFeeTooFew(element) => element.encode(),
                MystikoV2TBridgeERC20Errors::CommitmentHashIncorrect(element) => element.encode(),
                MystikoV2TBridgeERC20Errors::DepositsDisabled(element) => element.encode(),
                MystikoV2TBridgeERC20Errors::ExecutorFeeTooFew(element) => element.encode(),
                MystikoV2TBridgeERC20Errors::FromChainIdNotMatched(element) => element.encode(),
                MystikoV2TBridgeERC20Errors::FromProxyAddressNotMatched(element) => {
                    element.encode()
                }
                MystikoV2TBridgeERC20Errors::HashKGreaterThanFieldSize(element) => element.encode(),
                MystikoV2TBridgeERC20Errors::Invalid(element) => element.encode(),
                MystikoV2TBridgeERC20Errors::MaxAmountLessThanMinAmount(element) => {
                    element.encode()
                }
                MystikoV2TBridgeERC20Errors::MinAmountGreaterThanMaxAmount(element) => {
                    element.encode()
                }
                MystikoV2TBridgeERC20Errors::NotChanged(element) => element.encode(),
                MystikoV2TBridgeERC20Errors::OnlyOperator(element) => element.encode(),
                MystikoV2TBridgeERC20Errors::RandomSGreaterThanFieldSize(element) => {
                    element.encode()
                }
                MystikoV2TBridgeERC20Errors::RollupFeeToFew(element) => element.encode(),
                MystikoV2TBridgeERC20Errors::SanctionedAddress(element) => element.encode(),
                MystikoV2TBridgeERC20Errors::SenderIsNotBridgeProxy(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for MystikoV2TBridgeERC20Errors {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2TBridgeERC20Errors::AmountLessThanZero(element) => element.fmt(f),
                MystikoV2TBridgeERC20Errors::AmountTooLarge(element) => element.fmt(f),
                MystikoV2TBridgeERC20Errors::AmountTooSmall(element) => element.fmt(f),
                MystikoV2TBridgeERC20Errors::BridgeFeeTooFew(element) => element.fmt(f),
                MystikoV2TBridgeERC20Errors::CommitmentHashIncorrect(element) => element.fmt(f),
                MystikoV2TBridgeERC20Errors::DepositsDisabled(element) => element.fmt(f),
                MystikoV2TBridgeERC20Errors::ExecutorFeeTooFew(element) => element.fmt(f),
                MystikoV2TBridgeERC20Errors::FromChainIdNotMatched(element) => element.fmt(f),
                MystikoV2TBridgeERC20Errors::FromProxyAddressNotMatched(element) => element.fmt(f),
                MystikoV2TBridgeERC20Errors::HashKGreaterThanFieldSize(element) => element.fmt(f),
                MystikoV2TBridgeERC20Errors::Invalid(element) => element.fmt(f),
                MystikoV2TBridgeERC20Errors::MaxAmountLessThanMinAmount(element) => element.fmt(f),
                MystikoV2TBridgeERC20Errors::MinAmountGreaterThanMaxAmount(element) => {
                    element.fmt(f)
                }
                MystikoV2TBridgeERC20Errors::NotChanged(element) => element.fmt(f),
                MystikoV2TBridgeERC20Errors::OnlyOperator(element) => element.fmt(f),
                MystikoV2TBridgeERC20Errors::RandomSGreaterThanFieldSize(element) => element.fmt(f),
                MystikoV2TBridgeERC20Errors::RollupFeeToFew(element) => element.fmt(f),
                MystikoV2TBridgeERC20Errors::SanctionedAddress(element) => element.fmt(f),
                MystikoV2TBridgeERC20Errors::SenderIsNotBridgeProxy(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AmountLessThanZero> for MystikoV2TBridgeERC20Errors {
        fn from(var: AmountLessThanZero) -> Self {
            MystikoV2TBridgeERC20Errors::AmountLessThanZero(var)
        }
    }
    impl ::std::convert::From<AmountTooLarge> for MystikoV2TBridgeERC20Errors {
        fn from(var: AmountTooLarge) -> Self {
            MystikoV2TBridgeERC20Errors::AmountTooLarge(var)
        }
    }
    impl ::std::convert::From<AmountTooSmall> for MystikoV2TBridgeERC20Errors {
        fn from(var: AmountTooSmall) -> Self {
            MystikoV2TBridgeERC20Errors::AmountTooSmall(var)
        }
    }
    impl ::std::convert::From<BridgeFeeTooFew> for MystikoV2TBridgeERC20Errors {
        fn from(var: BridgeFeeTooFew) -> Self {
            MystikoV2TBridgeERC20Errors::BridgeFeeTooFew(var)
        }
    }
    impl ::std::convert::From<CommitmentHashIncorrect> for MystikoV2TBridgeERC20Errors {
        fn from(var: CommitmentHashIncorrect) -> Self {
            MystikoV2TBridgeERC20Errors::CommitmentHashIncorrect(var)
        }
    }
    impl ::std::convert::From<DepositsDisabled> for MystikoV2TBridgeERC20Errors {
        fn from(var: DepositsDisabled) -> Self {
            MystikoV2TBridgeERC20Errors::DepositsDisabled(var)
        }
    }
    impl ::std::convert::From<ExecutorFeeTooFew> for MystikoV2TBridgeERC20Errors {
        fn from(var: ExecutorFeeTooFew) -> Self {
            MystikoV2TBridgeERC20Errors::ExecutorFeeTooFew(var)
        }
    }
    impl ::std::convert::From<FromChainIdNotMatched> for MystikoV2TBridgeERC20Errors {
        fn from(var: FromChainIdNotMatched) -> Self {
            MystikoV2TBridgeERC20Errors::FromChainIdNotMatched(var)
        }
    }
    impl ::std::convert::From<FromProxyAddressNotMatched> for MystikoV2TBridgeERC20Errors {
        fn from(var: FromProxyAddressNotMatched) -> Self {
            MystikoV2TBridgeERC20Errors::FromProxyAddressNotMatched(var)
        }
    }
    impl ::std::convert::From<HashKGreaterThanFieldSize> for MystikoV2TBridgeERC20Errors {
        fn from(var: HashKGreaterThanFieldSize) -> Self {
            MystikoV2TBridgeERC20Errors::HashKGreaterThanFieldSize(var)
        }
    }
    impl ::std::convert::From<Invalid> for MystikoV2TBridgeERC20Errors {
        fn from(var: Invalid) -> Self {
            MystikoV2TBridgeERC20Errors::Invalid(var)
        }
    }
    impl ::std::convert::From<MaxAmountLessThanMinAmount> for MystikoV2TBridgeERC20Errors {
        fn from(var: MaxAmountLessThanMinAmount) -> Self {
            MystikoV2TBridgeERC20Errors::MaxAmountLessThanMinAmount(var)
        }
    }
    impl ::std::convert::From<MinAmountGreaterThanMaxAmount> for MystikoV2TBridgeERC20Errors {
        fn from(var: MinAmountGreaterThanMaxAmount) -> Self {
            MystikoV2TBridgeERC20Errors::MinAmountGreaterThanMaxAmount(var)
        }
    }
    impl ::std::convert::From<NotChanged> for MystikoV2TBridgeERC20Errors {
        fn from(var: NotChanged) -> Self {
            MystikoV2TBridgeERC20Errors::NotChanged(var)
        }
    }
    impl ::std::convert::From<OnlyOperator> for MystikoV2TBridgeERC20Errors {
        fn from(var: OnlyOperator) -> Self {
            MystikoV2TBridgeERC20Errors::OnlyOperator(var)
        }
    }
    impl ::std::convert::From<RandomSGreaterThanFieldSize> for MystikoV2TBridgeERC20Errors {
        fn from(var: RandomSGreaterThanFieldSize) -> Self {
            MystikoV2TBridgeERC20Errors::RandomSGreaterThanFieldSize(var)
        }
    }
    impl ::std::convert::From<RollupFeeToFew> for MystikoV2TBridgeERC20Errors {
        fn from(var: RollupFeeToFew) -> Self {
            MystikoV2TBridgeERC20Errors::RollupFeeToFew(var)
        }
    }
    impl ::std::convert::From<SanctionedAddress> for MystikoV2TBridgeERC20Errors {
        fn from(var: SanctionedAddress) -> Self {
            MystikoV2TBridgeERC20Errors::SanctionedAddress(var)
        }
    }
    impl ::std::convert::From<SenderIsNotBridgeProxy> for MystikoV2TBridgeERC20Errors {
        fn from(var: SenderIsNotBridgeProxy) -> Self {
            MystikoV2TBridgeERC20Errors::SenderIsNotBridgeProxy(var)
        }
    }
    #[derive(
        Clone,
    ...
    impl ethers::contract::EthLogDecode for MystikoV2TBridgeERC20Events {
        fn decode_log(
            ...
            Self: Sized,
        {
            ...
            if let Ok(decoded) = MaxAmountFilter::decode_log(log) {
                return Ok(MystikoV2TBridgeERC20Events::MaxAmountFilter(decoded));
            }
            if let Ok(decoded) = MinAmountFilter::decode_log(log) {
                return Ok(MystikoV2TBridgeERC20Events::MinAmountFilter(decoded));
            }
    ...
    impl ::std::fmt::Display for MystikoV2TBridgeERC20Events {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2TBridgeERC20Events::CommitmentCrossChainFilter(element) => element.fmt(f),
                MystikoV2TBridgeERC20Events::DepositsDisabledFilter(element) => element.fmt(f),
                MystikoV2TBridgeERC20Events::MaxAmountFilter(element) => element.fmt(f),
                MystikoV2TBridgeERC20Events::MinAmountFilter(element) => element.fmt(f),
                MystikoV2TBridgeERC20Events::MinBridgeFeeFilter(element) => element.fmt(f),
                MystikoV2TBridgeERC20Events::MinExecutorFeeFilter(element) => element.fmt(f),
                MystikoV2TBridgeERC20Events::OperatorChangedFilter(element) => element.fmt(f),
                MystikoV2TBridgeERC20Events::PeerMinExecutorFeeFilter(element) => element.fmt(f),
                MystikoV2TBridgeERC20Events::PeerMinRollupFeeFilter(element) => element.fmt(f),
                MystikoV2TBridgeERC20Events::SanctionsCheckFilter(element) => element.fmt(f),
                MystikoV2TBridgeERC20Events::SanctionsListFilter(element) => element.fmt(f),
            }
        }
    }
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2TBridgeERC20Calls {
        fn decode(
            ...
            {
                return Ok(MystikoV2TBridgeERC20Calls::AssetDecimals(decoded));
            }
            if let Ok(decoded) =
                <AssetNameCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::AssetName(decoded));
            }
            if let Ok(decoded) =
                <AssetSymbolCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::AssetSymbol(decoded));
            }
            if let Ok(decoded) =
                <AssetTypeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::AssetType(decoded));
            }
            if let Ok(decoded) =
                <BridgeProxyAddressCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::BridgeProxyAddress(decoded));
            }
            if let Ok(decoded) =
                <BridgeTypeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::BridgeType(decoded));
            }
            if let Ok(decoded) =
                <ChangeOperatorCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::ChangeOperator(decoded));
            }
            if let Ok(decoded) =
                <CrossChainSyncTxCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::CrossChainSyncTx(decoded));
            }
            if let Ok(decoded) =
                <DepositCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::Deposit(decoded));
            }
            if let Ok(decoded) =
                <DisableSanctionsCheckCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::DisableSanctionsCheck(decoded));
            }
            if let Ok(decoded) =
                <EnableSanctionsCheckCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::EnableSanctionsCheck(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2TBridgeERC20Calls::GetAssociatedCommitmentPool(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2TBridgeERC20Calls::SetAssociatedCommitmentPool(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2TBridgeERC20Calls::SetBridgeProxyAddress(decoded));
            }
            if let Ok(decoded) =
                <SetDepositsDisabledCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::SetDepositsDisabled(decoded));
            }
            if let Ok(decoded) =
                <SetMaxAmountCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::SetMaxAmount(decoded));
            }
            if let Ok(decoded) =
                <SetMinAmountCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::SetMinAmount(decoded));
            }
            if let Ok(decoded) =
                <SetMinBridgeFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::SetMinBridgeFee(decoded));
            }
            if let Ok(decoded) =
                <SetMinExecutorFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::SetMinExecutorFee(decoded));
            }
            if let Ok(decoded) =
                <SetPeerContractCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::SetPeerContract(decoded));
            }
            if let Ok(decoded) =
                <SetPeerMinExecutorFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::SetPeerMinExecutorFee(decoded));
            }
            if let Ok(decoded) =
                <SetPeerMinRollupFeeCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeERC20Calls::SetPeerMinRollupFee(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(MystikoV2TBridgeERC20Calls::UpdateSanctionsListAddress(
                    decoded,
                ));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2TBridgeERC20Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                MystikoV2TBridgeERC20Calls::AssetDecimals(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::AssetName(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::AssetSymbol(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::AssetType(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::BridgeProxyAddress(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::BridgeType(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::ChangeOperator(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::CrossChainSyncTx(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::Deposit(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::DisableSanctionsCheck(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::EnableSanctionsCheck(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::GetAssociatedCommitmentPool(element) => {
                    element.encode()
                }
                MystikoV2TBridgeERC20Calls::GetMaxAmount(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::GetMinAmount(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::GetMinBridgeFee(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::GetMinExecutorFee(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::GetPeerMinExecutorFee(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::GetPeerMinRollupFee(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::IsDepositsDisabled(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::PeerChainId(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::PeerChainName(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::PeerContract(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::SanctionsCheck(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::SanctionsList(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::SetAssociatedCommitmentPool(element) => {
                    element.encode()
                }
                MystikoV2TBridgeERC20Calls::SetBridgeProxyAddress(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::SetDepositsDisabled(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::SetMaxAmount(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::SetMinAmount(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::SetMinBridgeFee(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::SetMinExecutorFee(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::SetPeerContract(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::SetPeerMinExecutorFee(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::SetPeerMinRollupFee(element) => element.encode(),
                MystikoV2TBridgeERC20Calls::UpdateSanctionsListAddress(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for MystikoV2TBridgeERC20Calls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                MystikoV2TBridgeERC20Calls::AssetDecimals(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::AssetName(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::AssetSymbol(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::AssetType(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::BridgeProxyAddress(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::BridgeType(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::ChangeOperator(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::CrossChainSyncTx(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::Deposit(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::DisableSanctionsCheck(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::EnableSanctionsCheck(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::GetAssociatedCommitmentPool(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::GetMaxAmount(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::GetMinAmount(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::GetMinBridgeFee(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::GetMinExecutorFee(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::GetPeerMinExecutorFee(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::GetPeerMinRollupFee(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::IsDepositsDisabled(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::PeerChainId(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::PeerChainName(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::PeerContract(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::SanctionsCheck(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::SanctionsList(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::SetAssociatedCommitmentPool(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::SetBridgeProxyAddress(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::SetDepositsDisabled(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::SetMaxAmount(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::SetMinAmount(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::SetMinBridgeFee(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::SetMinExecutorFee(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::SetPeerContract(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::SetPeerMinExecutorFee(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::SetPeerMinRollupFee(element) => element.fmt(f),
                MystikoV2TBridgeERC20Calls::UpdateSanctionsListAddress(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AssetDecimalsCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: AssetDecimalsCall) -> Self {
            MystikoV2TBridgeERC20Calls::AssetDecimals(var)
        }
    }
    impl ::std::convert::From<AssetNameCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: AssetNameCall) -> Self {
            MystikoV2TBridgeERC20Calls::AssetName(var)
        }
    }
    impl ::std::convert::From<AssetSymbolCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: AssetSymbolCall) -> Self {
            MystikoV2TBridgeERC20Calls::AssetSymbol(var)
        }
    }
    impl ::std::convert::From<AssetTypeCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: AssetTypeCall) -> Self {
            MystikoV2TBridgeERC20Calls::AssetType(var)
        }
    }
    impl ::std::convert::From<BridgeProxyAddressCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: BridgeProxyAddressCall) -> Self {
            MystikoV2TBridgeERC20Calls::BridgeProxyAddress(var)
        }
    }
    impl ::std::convert::From<BridgeTypeCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: BridgeTypeCall) -> Self {
            MystikoV2TBridgeERC20Calls::BridgeType(var)
        }
    }
    impl ::std::convert::From<ChangeOperatorCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: ChangeOperatorCall) -> Self {
            MystikoV2TBridgeERC20Calls::ChangeOperator(var)
        }
    }
    impl ::std::convert::From<CrossChainSyncTxCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: CrossChainSyncTxCall) -> Self {
            MystikoV2TBridgeERC20Calls::CrossChainSyncTx(var)
        }
    }
    impl ::std::convert::From<DepositCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: DepositCall) -> Self {
            MystikoV2TBridgeERC20Calls::Deposit(var)
        }
    }
    impl ::std::convert::From<DisableSanctionsCheckCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: DisableSanctionsCheckCall) -> Self {
            MystikoV2TBridgeERC20Calls::DisableSanctionsCheck(var)
        }
    }
    impl ::std::convert::From<EnableSanctionsCheckCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: EnableSanctionsCheckCall) -> Self {
            MystikoV2TBridgeERC20Calls::EnableSanctionsCheck(var)
        }
    }
    impl ::std::convert::From<GetAssociatedCommitmentPoolCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: GetAssociatedCommitmentPoolCall) -> Self {
            MystikoV2TBridgeERC20Calls::GetAssociatedCommitmentPool(var)
        }
    }
    impl ::std::convert::From<GetMaxAmountCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: GetMaxAmountCall) -> Self {
            MystikoV2TBridgeERC20Calls::GetMaxAmount(var)
        }
    }
    impl ::std::convert::From<GetMinAmountCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: GetMinAmountCall) -> Self {
            MystikoV2TBridgeERC20Calls::GetMinAmount(var)
        }
    }
    impl ::std::convert::From<GetMinBridgeFeeCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: GetMinBridgeFeeCall) -> Self {
            MystikoV2TBridgeERC20Calls::GetMinBridgeFee(var)
        }
    }
    impl ::std::convert::From<GetMinExecutorFeeCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: GetMinExecutorFeeCall) -> Self {
            MystikoV2TBridgeERC20Calls::GetMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<GetPeerMinExecutorFeeCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: GetPeerMinExecutorFeeCall) -> Self {
            MystikoV2TBridgeERC20Calls::GetPeerMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<GetPeerMinRollupFeeCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: GetPeerMinRollupFeeCall) -> Self {
            MystikoV2TBridgeERC20Calls::GetPeerMinRollupFee(var)
        }
    }
    impl ::std::convert::From<IsDepositsDisabledCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: IsDepositsDisabledCall) -> Self {
            MystikoV2TBridgeERC20Calls::IsDepositsDisabled(var)
        }
    }
    impl ::std::convert::From<PeerChainIdCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: PeerChainIdCall) -> Self {
            MystikoV2TBridgeERC20Calls::PeerChainId(var)
        }
    }
    impl ::std::convert::From<PeerChainNameCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: PeerChainNameCall) -> Self {
            MystikoV2TBridgeERC20Calls::PeerChainName(var)
        }
    }
    impl ::std::convert::From<PeerContractCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: PeerContractCall) -> Self {
            MystikoV2TBridgeERC20Calls::PeerContract(var)
        }
    }
    impl ::std::convert::From<SanctionsCheckCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: SanctionsCheckCall) -> Self {
            MystikoV2TBridgeERC20Calls::SanctionsCheck(var)
        }
    }
    impl ::std::convert::From<SanctionsListCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: SanctionsListCall) -> Self {
            MystikoV2TBridgeERC20Calls::SanctionsList(var)
        }
    }
    impl ::std::convert::From<SetAssociatedCommitmentPoolCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: SetAssociatedCommitmentPoolCall) -> Self {
            MystikoV2TBridgeERC20Calls::SetAssociatedCommitmentPool(var)
        }
    }
    impl ::std::convert::From<SetBridgeProxyAddressCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: SetBridgeProxyAddressCall) -> Self {
            MystikoV2TBridgeERC20Calls::SetBridgeProxyAddress(var)
        }
    }
    impl ::std::convert::From<SetDepositsDisabledCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: SetDepositsDisabledCall) -> Self {
            MystikoV2TBridgeERC20Calls::SetDepositsDisabled(var)
        }
    }
    impl ::std::convert::From<SetMaxAmountCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: SetMaxAmountCall) -> Self {
            MystikoV2TBridgeERC20Calls::SetMaxAmount(var)
        }
    }
    impl ::std::convert::From<SetMinAmountCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: SetMinAmountCall) -> Self {
            MystikoV2TBridgeERC20Calls::SetMinAmount(var)
        }
    }
    impl ::std::convert::From<SetMinBridgeFeeCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: SetMinBridgeFeeCall) -> Self {
            MystikoV2TBridgeERC20Calls::SetMinBridgeFee(var)
        }
    }
    impl ::std::convert::From<SetMinExecutorFeeCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: SetMinExecutorFeeCall) -> Self {
            MystikoV2TBridgeERC20Calls::SetMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<SetPeerContractCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: SetPeerContractCall) -> Self {
            MystikoV2TBridgeERC20Calls::SetPeerContract(var)
        }
    }
    impl ::std::convert::From<SetPeerMinExecutorFeeCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: SetPeerMinExecutorFeeCall) -> Self {
            MystikoV2TBridgeERC20Calls::SetPeerMinExecutorFee(var)
        }
    }
    impl ::std::convert::From<SetPeerMinRollupFeeCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: SetPeerMinRollupFeeCall) -> Self {
            MystikoV2TBridgeERC20Calls::SetPeerMinRollupFee(var)
        }
    }
    impl ::std::convert::From<UpdateSanctionsListAddressCall> for MystikoV2TBridgeERC20Calls {
        fn from(var: UpdateSanctionsListAddressCall) -> Self {
            MystikoV2TBridgeERC20Calls::UpdateSanctionsListAddress(var)
        }
    }
