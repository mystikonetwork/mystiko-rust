...
pub mod mystiko_v2t_bridge_main {
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2TBridgeMainErrors {
        fn decode(
            ...
            {
                return Ok(MystikoV2TBridgeMainErrors::MaxAmountLessThanMinAmount(
                    decoded,
                ));
            }
            if let Ok(decoded) =
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2TBridgeMainErrors {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                MystikoV2TBridgeMainErrors::MaxAmountLessThanMinAmount(element) => element.encode(),
    ...
    impl ::std::fmt::Display for MystikoV2TBridgeMainErrors {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                MystikoV2TBridgeMainErrors::MaxAmountLessThanMinAmount(element) => element.fmt(f),
                MystikoV2TBridgeMainErrors::MinAmountGreaterThanMaxAmount(element) => {
                    element.fmt(f)
                }
    ...
    impl ::std::convert::From<MaxAmountLessThanMinAmount> for MystikoV2TBridgeMainErrors {
        fn from(var: MaxAmountLessThanMinAmount) -> Self {
            MystikoV2TBridgeMainErrors::MaxAmountLessThanMinAmount(var)
        }
    }
    ...
    impl ethers::contract::EthLogDecode for MystikoV2TBridgeMainEvents {
            ...
            Self: Sized,
        {
            ...
            if let Ok(decoded) = MaxAmountFilter::decode_log(log) {
                return Ok(MystikoV2TBridgeMainEvents::MaxAmountFilter(decoded));
            }
            if let Ok(decoded) = MinAmountFilter::decode_log(log) {
                return Ok(MystikoV2TBridgeMainEvents::MinAmountFilter(decoded));
            }
    ...
    impl ::std::fmt::Display for MystikoV2TBridgeMainEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                MystikoV2TBridgeMainEvents::MaxAmountFilter(element) => element.fmt(f),
                MystikoV2TBridgeMainEvents::MinAmountFilter(element) => element.fmt(f),
    ...
    impl ethers::core::abi::AbiDecode for MystikoV2TBridgeMainCalls {
        fn decode(
            ...
            {
                return Ok(MystikoV2TBridgeMainCalls::SetMaxAmount(decoded));
            }
            if let Ok(decoded) =
                <SetMinAmountCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(MystikoV2TBridgeMainCalls::SetMinAmount(decoded));
            }
            if let Ok(decoded) =
    ...
    impl ethers::core::abi::AbiEncode for MystikoV2TBridgeMainCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                MystikoV2TBridgeMainCalls::SetMaxAmount(element) => element.encode(),
                MystikoV2TBridgeMainCalls::SetMinAmount(element) => element.encode(),
    ...
    impl ::std::fmt::Display for MystikoV2TBridgeMainCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                MystikoV2TBridgeMainCalls::SetMaxAmount(element) => element.fmt(f),
                MystikoV2TBridgeMainCalls::SetMinAmount(element) => element.fmt(f),
    ...
    impl ::std::convert::From<SetMaxAmountCall> for MystikoV2TBridgeMainCalls {
        fn from(var: SetMaxAmountCall) -> Self {
            MystikoV2TBridgeMainCalls::SetMaxAmount(var)
        }
    }
    impl ::std::convert::From<SetMinAmountCall> for MystikoV2TBridgeMainCalls {
        fn from(var: SetMinAmountCall) -> Self {
            MystikoV2TBridgeMainCalls::SetMinAmount(var)
        }
    }
