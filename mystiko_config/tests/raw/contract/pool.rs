...
async fn test_import_valid_json_file() {
    let file_config =
        RawConfig::from_file::<RawPoolContractConfig>("tests/files/contract/pool.valid.json")
            .await
            .unwrap();
...
async fn test_import_invalid_json_file() {
    let file_config =
        RawConfig::from_file::<RawPoolContractConfig>("tests/files/contract/pool.invalid.json")
            .await;
...
async fn test_import_valid_json_str() {
    let json_str = r#"
        ...
        "#;
    let str_config = RawConfig::from_json_string::<RawPoolContractConfig>(json_str).unwrap();
