...
async fn default_config() -> RawTBridgeConfig {
    RawConfig::from_object::<RawTBridgeConfig>(RawTBridgeConfig::new(String::from(
...
async fn test_import_valid_json_file() {
    let file_config =
        RawConfig::from_file::<RawTBridgeConfig>("tests/files/bridge/tbridge.valid.json")
            .await
            .unwrap();
...
async fn test_import_invalid_json_file() {
    let file_config =
        RawConfig::from_file::<RawTBridgeConfig>("tests/files/bridge/tbridge.invalid.json").await;
...
async fn test_import_valid_json_str() {
    ...
    let str_config = RawConfig::from_json_string::<RawTBridgeConfig>(json_str).unwrap();
