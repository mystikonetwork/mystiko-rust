...
async fn default_config() -> RawPolyBridgeConfig {
    RawConfig::from_object::<RawPolyBridgeConfig>(RawPolyBridgeConfig::new(
...
async fn test_import_valid_json_file() {
    let file_config =
        RawConfig::from_file::<RawPolyBridgeConfig>("tests/files/bridge/poly.valid.json")
            .await
            .unwrap();
...
async fn test_import_invalid_json_file() {
    let file_config =
        RawConfig::from_file::<RawPolyBridgeConfig>("tests/files/bridge/poly.invalid.json").await;
...
async fn test_import_valid_json_str() {
    ...
    let str_config = RawConfig::from_json_string::<RawPolyBridgeConfig>(json_str).unwrap();
